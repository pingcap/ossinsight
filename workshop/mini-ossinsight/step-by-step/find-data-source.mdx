...
Click https://github.com/settings/tokens to generate your personal access token, before that you should know:

_Save token to somewhere because you will never see it after closing the tab._  
_Save token to somewhere because you will never see it after closing the tab._  
_Save token to somewhere because you will never see it after closing the tab._  
