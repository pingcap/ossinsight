...
mysql --host (your cloud tidb host, e.g: gateway01.us-west-2.prod.aws.tidbcloud.com) --port 4000 -u (your username, e.g.: 39jzyT3RT1DWrAr.root) -p gharchive_dev < gharchive_dev.github_events.000000000.sql
```
