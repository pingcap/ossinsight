...
```
  ...
  <TabItem value="cloud" label="Explain SQL - TiDB Cloud">
...
```
  ...
  <TabItem value="local" label="Explain SQL - Local TiDB">
...
<Tabs>
  <TabItem value="cloud" label="Result - TiDB Cloud" default>
...
```
  ...
  <TabItem value="local" label="Result - Local TiDB">
...
```
  ...
  <TabItem value="cloud" label="Explain - TiDB Cloud">
...
```
  ...
  <TabItem value="local" label="Explain - Local TiDB">
...
<br />
<center><h3>`1.99 sec` VS `0.19 sec`, IT IS FASTER !</h3></center>
<br />
...
<br />
<center><h3>`2.39 sec` VS `0.26 sec`, IT IS FASTER !</h3></center>
<br />
