...
#### i. Example 1
Look at [ti-chi-bot](https://github.com/ti-chi-bot)'s details:
...
| type              | count(*) |
+-------------------+----------+
| PullRequestEvent  |     6184 |
| IssueCommentEvent |    53920 |
+-------------------+----------+
...
:::info
azure-sdk's profile: https://github.com/ti-chi-bot.
:::

#### ii. Example 2
The below SQL is picked from [blog - Love, Code, and Robot](/blog/say-thanks-to-github-robots/), it explains how robots grow on GitHub:
...
`28.39 sec` VS `0.26 sec`, **IT IS SUPER FASTER**! We provide a all-in-one script to run `SET TIFLASH REPLICA` on all tables:
```bash
