...
:::info
We will use TiDB Cloud Serverless Tier in this workshop, it's free for 1 year after signing up. The resource of Serverless Tier is limited, and it's provided for development stage.
:::
