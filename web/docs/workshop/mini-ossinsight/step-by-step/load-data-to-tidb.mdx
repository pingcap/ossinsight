...
:::info
We will use TiDB Cloud Serverless Tier in this workshop, it's free FOREVER. The resource of Serverless Tier is limited, and it's provided for development stage.
:::

First, [sign up](https://tidbcloud.com/?utm_source=ossinsight&utm_medium=referral) TiDB Cloud, then create a `Serverless Tier` database which is free for 1 year.
