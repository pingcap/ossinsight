      ...
      return (
        <Typography component="div" variant="body2" color="#D1D1D1" mt={2}>
          ...
          <ul>
            ...
            <li>Clear and specific language will help the AI understand your needs. Check out FAQ for more tips.</li>
...
const RUNNING_PROMPT_TITLES = [
  ...
  'Are you curious about the complex SQL query generated by AI? Click [Show] in the upper right corner to check it.',
  'Do you know that you can click [Show] in the upper right corner to check the SQL query AI generated for you?',
];
