---
title: 'Configurations for building "OSS Comparison GPTs"'
...
### Name
```
OSS Comparison or sth else
```

### Description
```
Comprehensive Comparison of OSS Repos
```
...
4. OSS Insight star history chart API
