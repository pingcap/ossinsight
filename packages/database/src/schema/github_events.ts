...
export const githubEvents = mysqlTable(
  ...
  (table) => ({
    ...
    index_github_events_on_repo_id_type_action_month_actor_login: index('index_github_events_on_repo_id_type_action_month_actor_login').on(
      table.repo_id,
      table.type,
      table.action,
      table.event_month,
    ...
    index_ge_on_repo_id_type_action_pr_merged_created_at_add_del: index('index_ge_on_repo_id_type_action_pr_merged_created_at_add_del').on(
      table.repo_id,
      table.type,
      table.action,
      table.pr_merged,
    ...
    index_ge_on_creator_id_type_action_merged_created_at_add_del: index('index_ge_on_creator_id_type_action_merged_created_at_add_del').on(
      table.creator_user_id,
      table.type,
      table.action,
      table.pr_merged,
      table.created_at,
    ...
    index_ge_on_actor_id_type_action_created_at_repo_id_commits: index('index_ge_on_actor_id_type_action_created_at_repo_id_commits').on(
      table.actor_id,
      table.type,
      table.action,
      table.created_at,
      table.repo_id,
      table.push_distinct_size
    ),
    index_ge_on_repo_id_type_action_created_at_number_pdsize_psize: index('index_ge_on_repo_id_type_action_created_at_number_pdsize_psize').on(
      table.repo_id,
      table.type,
      table.action,
      table.created_at,
    ...
    index_ge_on_repo_id_type_action_created_at_actor_login: index('index_ge_on_repo_id_type_action_created_at_actor_login').on(
      table.repo_id,
      table.type,
      table.action,
      table.created_at,
