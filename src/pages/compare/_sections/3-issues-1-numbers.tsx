...
export default function () {
  return (
    <Section
      title='Issues'
      description='The charts below compare the two projects in regard to the total number of issues, issue submitters, issues comments, and issue commenters since 2011.'
    >
      {({repo1, repo2}) => (
