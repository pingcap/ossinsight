...
function Collection({ name, repos, collectionRepos }: RecentHotCollectionData) {
  return (
    <Box border="2px dashed #3c3c3c" p={2} borderRadius={1} sx={{ '&:not(:first-child)': { ml: 2 } }}>
      ...
      <Typography variant="body2" color="#7C7C7C" mt={2}>{repos} Repositories</Typography>
      <Box px={0.75} py={0.25} fontSize={14} my={2} color="#C4C4C4" border="1px solid rgba(196,196,196,0.2)"
           borderRadius={.75} bgcolor="rgba(196,196,196,0.1)">
        Top 3 Repos Last Month
      </Box>
