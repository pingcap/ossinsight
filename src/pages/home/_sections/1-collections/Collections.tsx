        ...
        <Stack key={repo.repo_id} direction="row" mt={1} alignItems="center">
          ...
          <Box>
            <Link href={`/analyze/${repo.repo_name}`} target='_blank'>
              ...
              <Box component='span' display='inline-flex' bgcolor='white' borderRadius='24px' padding='2px' alignItems='center' justifyContent='center' sx={{ verticalAlign: 'text-bottom'}} mr={1}>
