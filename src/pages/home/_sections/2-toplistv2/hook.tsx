import trendingReposQuery from '../../../../../configs/queries/trending-repos/params.json';
...
const params = (trendingReposQuery as any).params ?? [];

export const periods: Period[] = params.find((param: any) => param.name === 'period')?.enums ?? [];
export const languages: Language[] = params.find((param: any) => param.name === 'language')?.enums ?? [];
...
export default function TopListHookPagePlaceholder () {
  return null;
}
