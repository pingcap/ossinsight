...
import { isNonemptyString, isNullish, notFalsy, notNullish, Nullish } from '@/utils/value';
import { useHistory, useLocation } from '@/compat/docusaurus/router';
...
export function stringParam (defaultValue: string = ''): UseUrlSearchStateProps<string> {
  return {
    defaultValue,
    serialize: s => s,
    deserialize: s => s,
