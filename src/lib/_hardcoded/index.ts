import {query, registerStaticData} from "./query";
import {AxiosInstance} from "axios";

export default function registerData (client: AxiosInstance) {

  registerStaticData(client, query('archive-2021-archive-ranking', params => params?.repo === 'db_repos'), {
  ...
  registerStaticData(client, query('archive-2021-archive-ranking', params => params?.repo === 'js_framework_repos'), {
    expiresAt: "2099-12-31T00:00:00.000+08:00",
    params: {repo: "db_repos"},
    requestedAt: "2022-03-14T12:39:54.417+08:00",
    spent: 54.503,
  ...
  registerStaticData(client, query('archive-2021-archive-ranking', params => params?.repo === 'web_framework_repos'), {
    expiresAt: "2099-12-31T00:00:00.000+08:00",
    params: {repo: "db_repos"},
    requestedAt: "2022-03-14T12:39:54.417+08:00",
    spent: 54.503,
  ...
  registerStaticData(client, query('archive-2021-archive-ranking', params => params?.repo === 'programming_language_repos'), {
    expiresAt: "2099-12-31T00:00:00.000+08:00",
    params: {repo: "db_repos"},
    requestedAt: "2022-03-14T12:39:54.417+08:00",
    spent: 54.503,
  ...
  registerStaticData(client, query('archive-2021-archive-ranking', params => params?.repo === 'nocode_repos'), {
    expiresAt: "2099-12-31T00:00:00.000+08:00",
    params: {repo: "db_repos"},
    requestedAt: "2022-03-14T12:39:54.417+08:00",
    spent: 54.503,
