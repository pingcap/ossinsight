...
import { Box, GridLegacy as Grid, Tab, Tabs } from '@mui/material';
...
export const PeopleSection = forwardRef(function (_, ref: ForwardedRef<HTMLElement>) {
  ...
  const [companyType, setCompanyType] = useState<keyof typeof companyValueIndices>('analyze-stars-company');
  const handleChangeCompanyType = useCallback((event: React.SyntheticEvent, value: keyof typeof companyValueIndices) => {
