...
import { GridLegacy as Grid, Stack, Tooltip, Skeleton, CircularProgress } from '@mui/material';

type LegacyGridProps = React.ComponentProps<typeof Grid>;

export interface SummaryItemProps<F extends string> extends Omit<LegacyGridProps, 'title'> {
...
export interface StaticSummaryItemProps extends Omit<LegacyGridProps, 'title'> {
  icon?: React.ReactNode;
  title: React.ReactNode;
