...
import { useLocation } from '@/compat/docusaurus/router';
import { useRouteMatch } from 'react-router';
import { translate } from '@/compat/docusaurus/Translate';
import { Add } from '@mui/icons-material';
import DocSidebar from '@/compat/theme/DocSidebar';
import IconArrow from '@/compat/theme/IconArrow';
...
import { isFalsy, notFalsy } from '@/utils/value';

import { Stack, Typography } from '@mui/material';
import EditCollection from '@/dynamic-pages/collections/components/EditCollection';
...
function CollectionsPageLayout ({ title: propTitle, description, keywords, children }: PropsWithChildren<CollectionsPageLayoutProps>) {
  const { params: { slug } } = useRouteMatch() as { params: CollectionsPageParams };
