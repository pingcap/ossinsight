...
export default function Page() {
  ...
  const { data: tableInfoData, error } = useRemoteData<QueryParams, TidbTableInfo>('stats-table-info', { tableName: slug }, false, true);
  ...
  return (
    <CustomPage title={`Stats - ${slug}`}>
      <Container maxWidth="lg">
        ...
        <Tabs onChange={(_, value) => setCurrent(value)} value={current}>
