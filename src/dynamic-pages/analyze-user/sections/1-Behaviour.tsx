...
import { Axis, BarSeries, Dataset, Once } from '@/lib/echartsx';
...
export default forwardRef(function BehaviourSection (_props: unknown, ref: ForwardedRef<HTMLElement>) {
  return (
