import { isEmptyResult, QuestionLoadingPhase, QuestionManagementContext, useQuestionManagementValues } from '@/legacy-pages/explore/_components/useQuestion';
import useUrlSearchState, { nullableStringParam } from '@/hooks/url-search-state';
import React, { SetStateAction, useEffect, useMemo, useState } from 'react';
import { isBlankString, isNullish, notNullish } from '@/utils/value';
import { useEventCallback } from '@mui/material';
import { ExploreContext } from '@/legacy-pages/explore/_components/context';
import { Decorators } from '@/legacy-pages/explore/_components/Decorators';
import Layout from '@/legacy-pages/explore/_components/Layout';
import Header from '@/legacy-pages/explore/_components/Header';
import ExploreSearch from '@/legacy-pages/explore/_components/Search';
import Faq from '@/legacy-pages/explore/_components/Faq';
import Side from '@/legacy-pages/explore/_components/Side';
import ExploreMain from '@/legacy-pages/explore/_components/ExploreMain';
