...
import ChatMessages, { ChatMessagesInstance } from '@/legacy-pages/explore/_components/ChatMessages';
import React, { ReactElement, useDebugValue, useEffect, useRef, useState } from 'react';
import { isNullish, nonEmptyArray, notFalsy, notNullish } from '@/utils/value';
...
import { Assumption, CombinedTitle, Line, ListItem, RevisedTitle, Strong } from '@/legacy-pages/explore/_components/SqlSection/styled';
import { useMemoizedFn } from 'ahooks';
import BotIcon from '@/legacy-pages/explore/_components/BotIcon';
import CopyButton from './CopyButton';
import { ExpandMore } from '@mui/icons-material';
import { useWhenMounted } from '@/hooks/mounted';
import { parseKeywords } from '@/legacy-pages/explore/_components/SqlSection/AIMessagesV3';
