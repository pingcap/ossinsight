import { Line, StyledTitle } from '@/legacy-pages/explore/_components/SqlSection/styled';
import React, { ReactElement, useMemo, useRef, useState } from 'react';
import { GENERATE_SQL_NON_FINAL_PHASES, hasAIPrompts, QuestionLoadingPhase } from '@/legacy-pages/explore/_components/useQuestion';
import { isNullish, notNullish } from '@/utils/value';
import { SectionStatus, SectionStatusIcon } from '@/legacy-pages/explore/_components/Section';
import { Button } from '@mui/material';
import { ExpandMore } from '@mui/icons-material';
import { useInterval, useMemoizedFn } from 'ahooks';
import { randomOf } from '@/utils/generate';
...
import { Question } from '@/api/explorer';
import AIMessagesV3 from '@/legacy-pages/explore/_components/SqlSection/AIMessagesV3';
