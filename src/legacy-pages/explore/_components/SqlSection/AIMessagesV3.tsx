import { AIMessagesV2Props, joinComma, trimNo } from '@/legacy-pages/explore/_components/SqlSection/AIMessagesV2';
import React, { cloneElement, createContext, createElement, ReactElement, useEffect, useRef, useState } from 'react';
import { Pace, WindupChildren } from 'windups';
import { Question, QuestionStatus } from '@/api/explorer';
import { notNone } from '@/legacy-pages/explore/_components/SqlSection/utils';
import { Collapse, IconButton, styled } from '@mui/material';
import { isEmptyArray, isNullish, nonEmptyArray, notFalsy, notNullish } from '@/utils/value';
import { Line } from '@/legacy-pages/explore/_components/SqlSection/styled';
import CopyButton from '@/legacy-pages/explore/_components/SqlSection/CopyButton';
import { ExpandMore } from '@mui/icons-material';
import { useSafeSetTimeout } from '@/hooks/mounted';
import BotIcon from '@/legacy-pages/explore/_components/BotIcon';
...
class QuestionModel {
  ...
  private run<T> (get: (question: Question) => T, validate: (value: T) => value is NonNullable<T>, renderer: (value: NonNullable<T>) => ReactElement, collapsable = false) {
  ...
  accept (question: Question, fromInner = true) {
    ...
    switch (this.stage) {
      ...
      case QuestionModelStage.cq:
        this.run(() => true, (value): value is true => value === true, this.renderMessage);
        break;
