...
import { ChartResult, Question, QuestionStatus } from '@/api/explorer';
import Anchor from '@/components/Anchor';
import { Charts } from '@/legacy-pages/explore/_components/charts';
import TableChart from '@/legacy-pages/explore/_components/charts/TableChart';
import { useExploreContext } from '@/legacy-pages/explore/_components/context';
import ErrorBlock from '@/legacy-pages/explore/_components/ErrorBlock';
import Feedback from '@/legacy-pages/explore/_components/Feedback';
import Info from '@/legacy-pages/explore/_components/Info';
import { Prompts } from '@/legacy-pages/explore/_components/Prompt';
import ErrorMessage from '@/legacy-pages/explore/_components/ResultSection/ErrorMessage';
import ShowExecutionInfoButton from '@/legacy-pages/explore/_components/ResultSection/ShowExecutionInfoButton';
import Section, { SectionProps, SectionStatus, SectionStatusIcon } from '@/legacy-pages/explore/_components/Section';
import SummaryCard from '@/legacy-pages/explore/_components/SummaryCard';
import TypewriterEffect from '@/legacy-pages/explore/_components/TypewriterEffect';
import { QuestionLoadingPhase } from '@/legacy-pages/explore/_components/useQuestion';
import { uniqueItems } from '@/utils/generate';
import { isEmptyArray, isNonemptyString, isNullish, nonEmptyArray, notFalsy, notNullish } from '@/utils/value';
  ...
  if (notNullish(question) && !isEmptyArray(question.engines)) {
    return (
      <>
        . Running on&nbsp;
        <EngineTag>
          <TidbLogo src="/img/tidb-cloud-logo-o.png" alt="TiDB" />
