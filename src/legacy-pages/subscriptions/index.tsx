...
import { useSubscriptions } from '@/api/user';
...
import { clientWithoutCache } from '@/api/client';
import { Unsubscribe } from '@mui/icons-material';
import EnableEmailSwitch from '@/legacy-pages/subscriptions/EnableEmailSwitch';
