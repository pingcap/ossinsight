        ...
        routes: [
          {
            ...
            exact: true,
            component: '@site/dynamic-pages/analyze',
          ...
          },
          {
            path: '/analyze/:login',
            exact: true,
            component: '@site/dynamic-pages/analyze-user',
          },
          {
            path: '/collections/:slug',
            exact: true,
            component: '@site/dynamic-pages/collections',
          ...
          },
          {
            ...
            exact: true,
            component: '@site/dynamic-pages/collections/dynamic-trends',
            params: getPrefetched('.prefetch/collections.json')?.data.map(({ name }) => ({
              slug: require('param-case').paramCase(name)
            }))
          },
          {
            ...
            exact: true,
            component: '@site/dynamic-pages/stats/tables',
          },
          {
            path: '/stats',
            exact: true,
            component: '@site/dynamic-pages/stats',
          }
        ]
      }
    ],
