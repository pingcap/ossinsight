...
export default function PrefetchPlugin (_: unknown, options: Record<string, string>): Plugin<PrefetchContent[]> {
  return {
    ...
    injectHtmlTags ({ content }: { content: PrefetchContent[] }) {
    ...
    async contentLoaded ({
      ...
      actions: { setGlobalData: (data: Record<string, unknown>) => void };
