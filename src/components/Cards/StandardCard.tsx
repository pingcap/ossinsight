...
import isInternalUrl from '@/compat/docusaurus/isInternalUrl';
import { notNullish } from '@/utils/value';

import { Card, Typography, Button, Chip, Box, ButtonBase } from '@mui/material';

type StandardCardGridProps = Pick<GridLegacyProps, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'sx' | 'className' | 'style' | 'id'>;

export interface StandardCardProps extends StandardCardGridProps {
