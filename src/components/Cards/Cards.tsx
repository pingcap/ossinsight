...
type GridSizeProps = {
  xs?: GridLegacyProps['xs'];
  sm?: GridLegacyProps['sm'];
  md?: GridLegacyProps['md'];
  lg?: GridLegacyProps['lg'];
  xl?: GridLegacyProps['xl'];
};
...
export interface CardsProps extends GridLegacyProps {
}
