...
import { InputLabel, Select, useTheme, useMediaQuery, Box, FormControl, MenuItem, NoSsr } from '@mui/material';
...
export default function HeatMapChart<T> ({
  ...
  const onZoneChange = useCallback((e: SelectChangeEvent<number>) => {
