...
import { usePluginData } from '@/compat/docusaurus/useGlobalData';
...
export const useRealtimeRemoteData: UseRemoteData<false> = (query: string, params: any, formatSql: boolean, shouldLoad = true, wsApi?: 'unique' | true | undefined): AsyncData<RemoteData<any, any>> => {
  const { inView } = useContext(InViewContext);
