...
function useRepoSelector ({
  ...
  const onAutoCompleteChange = useCallback((event: any, newValue: Repo | null) => {
  ...
  const onInputChange: UseAutocompleteProps<any, any, any, any>['onInputChange'] = useCallback((event: any, value: string) => {
    setHelperText('');
