import { AnchorHTMLAttributes, createElement, ElementType, FC, useContext, useMemo } from 'react';
import { coalesce, isNonemptyString, notNullish } from '@/utils/value';
import { useResponsiveAuth0 } from '@/theme/NavbarItem/useResponsiveAuth0';
import { User } from '@auth0/auth0-react';
import TiDBCloudLinkContext, { TiDBCloudLinkContextValues } from './context';
import useDocusaurusContext from '@/compat/docusaurus/useDocusaurusContext';
...
export interface TiDBCloudLinkProps extends TiDBCloudLinkContextValues, Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'href' | 'rel'> {
  as?: 'a' | FC<AnchorHTMLAttributes<HTMLAnchorElement>> | ElementType<any>;
}

export default function TiDBCloudLink<P> ({ as = 'a', campaign: propCampaign, trial: propTrial, content, ...props }: TiDBCloudLinkProps & P) {
