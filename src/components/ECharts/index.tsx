...
import { isPositiveNumber } from '@/utils/value';
import { Backdrop, CircularProgress } from '@mui/material';
import type EChartsReact from 'echarts-for-react';
import 'react-aspect-ratio/aspect-ratio.css';
import { EChartsType } from 'echarts/types/dist/shared';
import type { TypedKey } from '@/lib/echartsx/charts/sort-bar/hook';
...
const LazyLineChart: typeof import('@/lib/echartsx').LineChart = lazy(async () => await import('./lazy').then(({ LineChart }) => ({ default: LineChart }))) as never;
const LazyRankChart: typeof import('@/lib/echartsx').RankChart = lazy(async () => await import('./lazy').then(({ RankChart }) => ({ default: RankChart }))) as never;
const LazySortingBarChart: typeof import('@/lib/echartsx').SortingBarChart = lazy(async () => await import('./lazy').then(({ SortingBarChart }) => ({ default: SortingBarChart }))) as never;
...
export const EChartsx = forwardRef(function AsyncEChartsx (props: import('@/lib/echartsx').OptionProps, ref: ForwardedRef<EChartsType>) {
  if (typeof window === 'undefined') {
...
export const LineChart = forwardRef(function <T extends Record<string, unknown>> (props: PropsWithChildren<import('@/lib/echartsx').LineChartProps<T>>, ref: ForwardedRef<EChartsType>) {
  if (typeof window === 'undefined') {
...
export const RankChart = forwardRef(function <T extends Record<string, unknown>> (props: PropsWithChildren<import('@/lib/echartsx').RankChartProps<T>>, ref: ForwardedRef<EChartsType>) {
  if (typeof window === 'undefined') {
    return <LazyEChartsxPlaceholder height={props.height} />;
  }
  return (
...
export const SortingBarChart = forwardRef(function <T, N extends TypedKey<T, string>, K extends TypedKey<T, string>> (props: PropsWithChildren<import('@/lib/echartsx').SortingBarChartProps<T, N, K>>, ref: ForwardedRef<EChartsType>) {
  if (typeof window === 'undefined') {
    return <LazyEChartsxPlaceholder height={props.height} />;
  }
  return (
