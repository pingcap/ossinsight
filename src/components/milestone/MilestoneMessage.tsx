...
import { useFindCollectionById } from '@/dynamic-pages/collections/hooks/useCollection';
...
export default function MilestoneMessage ({ milestone_number, milestone_type_id, reached_at, ...props }: MilestoneMessageProps) {
  const template: MilestoneTemplate = config[milestone_type_id as MilestoneType] ?? DEFAULT_TEMPLATE;
