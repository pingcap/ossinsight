import { useGroupedMilestones, useMilestones } from '@/components/milestone/hooks';
import React, { useMemo, useRef, useState } from 'react';
import { Timeline, TimelineConnector, TimelineContent, TimelineDot, TimelineItem, timelineItemClasses, TimelineSeparator } from '@mui/lab';
import MilestoneMessage from '@/components/milestone/MilestoneMessage';
import { Badge, Button, Skeleton, styled, Tooltip } from '@mui/material';
import { H3 } from '@/dynamic-pages/analyze/typography';
import { Milestone } from '@ossinsight/api';
import ScrollSpy from '@/components/LegacyScrollSpy';
import { ScrollSpyInstance } from '@/components/LegacyScrollSpy/ScrollSpy';
import SubscribeButton from '@/components/milestone/SubscribeButton';
