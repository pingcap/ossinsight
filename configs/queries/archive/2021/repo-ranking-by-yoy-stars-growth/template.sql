...
FROM (
    SELECT
        repo_id,
        SUM(YEAR(created_at) = 2020) AS stars2020,
        SUM(YEAR(created_at) = 2021) AS stars2021,
        (SUM(YEAR(created_at) = 2021) - SUM(YEAR(created_at) = 2020)) / SUM(YEAR(created_at) = 2020) AS yoy
