...
SELECT
    ...
    ROUND(cpppt.prs / cppt.prs_total, 2) AS current_period_percentage,
    ppppt.prs AS past_period_prs,
    ROUND(ppppt.prs / pppt.prs_total, 2) AS past_period_percentage,
    ROUND((cpppt.prs / cppt.prs_total - ppppt.prs / pppt.prs_total), 2) AS percentage_change
