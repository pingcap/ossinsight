...
`,N=(0,x.ZP)(A)`
  ...
  overflow: hidden;
`;var M=n(36336),L=n(98885),P=n(93580);const T=400;function G(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),d=(0,o.useRef)(null),m=(0,P.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??0),[null==m?void 0:m.height]);return o.createElement(R,{maxWidth:"xl"},o.createElement(L.ZP,{nodeRef:s,in:c,timeout:T},(e=>o.createElement(o.Fragment,null,o.createElement(D,{ref:s,className:`Header-${e}`,height:g},n),o.createElement(F,{className:`Body-header-${e}`,headerHeight:g},o.createElement(L.ZP,{nodeRef:u,in:i,timeout:T},(e=>o.createElement($,{ref:u,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:d,in:i,timeout:T,unmountOnExit:!0},(e=>o.createElement(q,{ref:d,className:`Side-${e}`},a))))))),o.createElement(B,null,l&&r))}const R=(0,x.ZP)(M.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,ee=(0,x.ZP)("p")`
  color: #7C7C7C;
  margin: 0;
`;var te=n(80562),ne=n(75345),ae=n(9144),oe=n(95537),re=n(63871),le=n(89022),ie=n(88100);function ce(e){let{value:t,onChange:n,onAction:a,onClear:r,disableInput:l=!1,disableAction:i=!1,disableClear:c=!1,clearState:s}=e;const u=(0,o.useRef)(null),{isLoading:d,isAuthenticated:m}=(0,ie.D3)(),g=(0,w.Z)((e=>{n(e.target.value)})),p=(0,w.Z)((e=>{"Enter"===e.key&&(i||null==a||a())}));return o.createElement(o.Fragment,null,o.createElement(se,{fullWidth:!0,disabled:d&&!m||l,ref:u,value:t,onChange:g,onKeyDown:p,placeholder:"Questions about repos, users, orgs, languages...",endAdornment:o.createElement(ae.Z,{direction:"row",gap:1},!i&&o.createElement(ue,{color:"inherit",onClick:a,disabled:i},o.createElement(re.Z,null)),o.createElement(ue,{color:"stop"===s?"error":"inherit",onClick:r,disabled:c},"stop"===s?o.createElement(le.Z,null):o.createElement(oe.Z,null)))}))}const se=(0,x.ZP)(ne.ZP)`
...
`;var he=n(3106),fe=n(52263);function Ee(e){let{as:t="a",campaign:n,trial:a,...r}=e;const{user:l}=(0,m.g)(),{campaign:i,trial:c}=(0,o.useContext)(he.Z),{siteConfig:{customFields:s}}=(0,fe.Z)(),{campaign:d,trial:g}=(0,o.useMemo)((()=>({campaign:(0,u.kX)(u.GC,n,i,void 0),trial:(0,u.kX)(u.nf,a,c,!1)})),[n,i,a,c]),p=(0,o.useMemo)((()=>{const e=new URL(`https://${null==s?void 0:s.tidbcloud_host}/channel`);if((0,u.GC)(d)&&(e.searchParams.set("utm_source","ossinsight"),e.searchParams.set("utm_medium","referral"),e.searchParams.set("utm_campaign",d)),g){const t=function(e){if((0,u.nf)(e)&&(0,u.GC)(e.email)&&(0,u.GC)(e.sub)){let t;switch(e.sub.split("|")[0]){case"github":t="github";break;case"google-oauth2":t="google";break;case"windowslive":t="microsoft";break;default:return}return{email:e.email,connection:t}}return}(l);(0,u.nf)(t)&&(e.searchParams.set("email",t.email),e.searchParams.set("connection",t.connection))}return e.toString()}),[l,d,g]);return(0,o.createElement)(t,{href:p,target:"_blank",rel:"noopener",...r})}function ye(e){let{align:t="left",sx:n}=e;return o.createElement(be,{align:t,sx:n},"Powered by ",o.createElement(Ee,null,"TiDB Cloud"))}const be=(0,x.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`;var ve=n(14850),xe=n(74065),we=n(47028),Se=n(21945),Ze=n(70795),Ie=n(70918),Ce=n(70983),Ae=n(96812),ke=n(6571),Ne=n(47135),Me=n(19604),Le=n(29630);function Pe(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Te=n(54566),Ge=n(21039),Re=n(23147),Fe=n(79072),De=n(91655),$e=n(50522),qe=n(39960);const Be=(0,x.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,ze=(0,x.ZP)($e.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,Oe=(0,x.ZP)(Be,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`;(0,x.ZP)(ze,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,Oe.withComponent($e.Z),Oe.withComponent(qe.Z);function Ue(e){let{question:t,questionId:n,variant:a="card",prefix:r,disabled:l}=e;const{handleSelect:i,handleSelectId:c}=(0,o.useContext)(S),s=(0,w.Z)((()=>{(0,u.GC)(n)?c(n):"string"==typeof t&&i(t)}));switch(a){case"recommended-card":return o.createElement(Be,null,o.createElement(ze,{onClick:s,disabled:l},t),o.createElement(_e,null,"\u2728"));case"card":return o.createElement(ze,{onClick:s,disabled:l},t);default:return o.createElement(He,{disableRipple:!0,disableTouchRipple:!0,onClick:s,disabled:l},r,t)}}const He=(0,x.ZP)($e.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`,_e=(0,x.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`;var Qe=n(8100);function We(e){const t=new Array(e);for(let n=0;n<e;n++)t[n]=n;return t}function Ve(e,t){if(0!==e.length&&(1!==e.length||!(0,u.nf)(t)||0!==t))for(;;){const n=Math.floor((Math.random()-1e-5)*e.length);if(n!==t)return e[n]}}function Ke(e,t){const{data:n,isValidating:a,mutate:l}=(0,Qe.ZP)([e,t,"data-explorer-recommend-question"],{fetcher:async(e,t)=>await async function(e,t){return await r.po.get("/explorer/questions/recommend",{params:{aiGenerated:e,n:t}})}(e,t),shouldRetryOnError:!1,revalidateIfStale:!1,revalidateOnReconnect:!1,revalidateOnFocus:!1});return{data:n,loading:a,reload:(0,o.useMemo)((()=>()=>{l(void 0,{revalidate:!0}).catch(console.error)}),[])}}function Ye(e){let{variant:t,disabled:n,questions:a,n:r,questionPrefix:l}=e;const i=0===a.length?(()=>{const e=e=>o.createElement(Ue,{key:e,variant:t,question:"text"===t?o.createElement(De.Z,{width:"230px"}):o.createElement(o.Fragment,null,o.createElement(De.Z,{width:"100%"}),o.createElement(De.Z,{width:"61%"})),disabled:!0});return"text"===t?We(r).map(e):We(r).map((t=>o.createElement(Fe.ZP,{item:!0,xs:12,md:4,key:t,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t))))})():(()=>{const e=(e,a)=>o.createElement(Ue,{key:a,variant:t,question:e.title,questionId:e.questionId,prefix:l,disabled:n});return"text"===t?a.map(e):a.map(((t,n)=>o.createElement(Fe.ZP,{item:!0,xs:12,md:4,key:t.hash,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t,n))))})();return"text"===t?o.createElement(v.Z,null,i):o.createElement(Fe.ZP,{container:!0,spacing:2},i)}function je(e){let{aiGenerated:t=!1,n:n,disabled:a=!1,title:r,questionPrefix:l,variant:i}=e;const{data:c=[],reload:s,loading:u}=Ke(t,n);return o.createElement(o.Fragment,null,o.createElement(v.Z,{mb:.5},(null==r?void 0:r(s,u))??null),o.createElement(Ye,{n:n,questions:c,disabled:a,questionPrefix:l,variant:i??(t?"recommended-card":"card")}))}function Xe(e){let{severity:t,sx:n,children:a,createIssueUrl:r=(()=>Pe("pingcap/ossinsight")),showSuggestions:l}=e;const i=(0,w.Z)((()=>{var e;null==(e=document.getElementById("data-explorer-faq"))||e.scrollIntoView({behavior:"smooth"})})),c=(0,w.Z)((()=>{window.open(r(),"_blank")}));return o.createElement(o.Fragment,null,o.createElement(Je,{sx:n,variant:"outlined",severity:t},o.createElement(Le.Z,{variant:"body1"},a),o.createElement(ae.Z,{direction:"row",spacing:2,mt:2},o.createElement(tt,{onClick:i},o.createElement(Ge.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"See faq")),o.createElement(tt,{onClick:c},o.createElement(Re.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"Feedback")))),l&&o.createElement(et,null,o.createElement(je,{title:(e,t)=>o.createElement(v.Z,{component:"p",m:0,mt:3,height:"40px"},"\ud83d\udc40 How about try other questions? ",o.createElement(te.Z,{onClick:e,disabled:t},o.createElement(Te.Z,null))),n:4,variant:"text",questionPrefix:"> "})))}const Je=(0,x.ZP)(Me.Z)`
  background: #18191A;
...
`;var nt=n(36782);function at(e){return()=>{var t;null==(t=document.getElementById(e))||t.scrollIntoView({behavior:"smooth"})}}function ot(e){void 0===e&&(e="");try{return(0,nt.WU)(e,{language:"mysql"})}catch{return e}}function rt(){const{question:e}=y(),t=(0,o.useMemo)((()=>()=>{var t;return Pe("pingcap/ossinsight",{title:`Empty result from question ${(null==e?void 0:e.id)??""}`,labels:"area/data-explorer",body:`\nHi, The result of [question](https://ossinsight.io/explore/?id=${(null==e?void 0:e.id)??""}) is empty\nThe title is: **${(null==e||null==(t=e.title)?void 0:t.replaceAll("@",""))??""}**\n\nGenerated SQL is:\n\`\`\`mysql\n${ot(null==e?void 0:e.querySQL)}\n\`\`\` \n      `})}),[e]);return o.createElement(Xe,{severity:"info",createIssueUrl:t,showSuggestions:!0},"Oops! Your query yielded no results. Try our ",o.createElement("a",{href:"javascript:void(0)",onClick:at("faq-optimize-sql")},"tips")," for crafting effective queries and give it another go.")}function lt(e){let{severity:t,title:n,prompt:a,sx:r,error:l,showSuggestions:i,children:c}=e;const{question:s}=y();return o.createElement(Xe,{severity:t,sx:r,createIssueUrl:()=>{var e;return Pe("pingcap/ossinsight",{title:`${n} for question ${(null==s?void 0:s.id)??""}`,body:`\n${a} [question](https://ossinsight.io/explore?id=${(null==s?void 0:s.id)??""})\n\n## Question title\n**${(null==s||null==(e=s.title)?void 0:e.replaceAll("@",""))??""}**\n\n## Error message\n${l}\n${(0,u.nf)(null==s?void 0:s.querySQL)?`\n## Generated SQL\n\`\`\`mysql\n${ot(null==s?void 0:s.querySQL)}\n\`\`\`\n`:""}\n${(0,u.nf)(null==s?void 0:s.chart)?`\n## Chart info\n\`\`\`json\n${JSON.stringify(null==s?void 0:s.chart,void 0,2)}\n\`\`\`\n`:""}\n`,labels:"area/data-explorer,type/bug"})},showSuggestions:i&&!(0,Ne.X_)(l,429)},c)}var it=n(70917);function ct(e){let{animated:t=!0}=e;return o.createElement(ut,{className:t?"animated":"",size:16})}const st=it.F4`
  0% {
...
`,ut=(0,x.ZP)("span")`
  ...
  &.animated {
    animation: ${st} 0.8s infinite;
  }
`;const dt=(0,n(1588).Z)("RippleDot",["root","info","success","error","warning","active"]);var mt=n(86010);function gt(e){let{active:t=!0,color:n="info",size:a=8}=e;return o.createElement(ht,{size:a,className:(0,mt.Z)({[dt.root]:!0,[dt.active]:t,[dt[n]]:!0})})}const pt=it.F4`
  0% {
    opacity: 1;
    transform: initial;
  }
...
`,ht=(0,x.ZP)("span",{name:"RippleDot",shouldForwardProp:e=>"size"!==e})`
  display: inline-block;
  position: relative;
...
`;function ft(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:l,errorWithChildren:i=!1,errorMessage:c,children:s,errorPrompt:d,errorTitle:m,icon:g="default"}=e;const[p,h]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":h(!1);break;case"error":h(!0)}}),[t]);const f=(0,w.Z)(((e,t)=>{E||h(t)})),E=!0===a,y=(0,u.N6)(r)&&"success"===t;return o.createElement(Et,{className:"pending"===t?"pending":(0,u.Rw)(l)?t:"error",elevation:1},o.createElement(yt,{expanded:!!E||p,defaultExpanded:a,elevation:0,onChange:f},o.createElement(bt,{alwaysOpen:E,expandIcon:(0,u.X0)(a)&&"success"===t&&o.createElement(ke.Z,null),disabled:"loading"===t},o.createElement(vt,null,"loading"===t?"bot"===g?o.createElement(ct,null):o.createElement(gt,{size:12}):"success"===t&&(0,u.Rw)(l)?o.createElement(Ce.Z,{color:"success",fontSize:"inherit"}):o.createElement(Ae.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(wt,null,n),y&&o.createElement(o.Fragment,null,o.createElement(St,null),o.createElement(xt,null,"auto"===r?p?"Hide":"Show":r)))),o.createElement(we.Z,null,i?(0,u.Rw)(l)?s:o.createElement(o.Fragment,null,o.createElement(lt,{title:m,prompt:d,error:(0,Ne.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0},c),s):(0,u.Rw)(l)?s:o.createElement(lt,{title:m,prompt:d,error:(0,Ne.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0},c))))}const Et=(0,x.ZP)(Ie.Z)`
...
`,yt=(0,x.ZP)(xe.Z)`
  ...
  padding: 4px 8px;
`,bt=(0,x.ZP)(Se.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
  &.${Ze.Z.content} {
    margin-top: 4px;
    margin-bottom: 4px;
  }
...
`,St=(0,x.ZP)("span")`
  flex: 1;
`;var Zt=n(18629);function It(e){let{content:t,avgInterval:n=80,maxDiff:a=50,maxContinuous:r=1}=e;const[l,i,c]=function(e){const[t,n]=(0,o.useState)(e),a=(0,o.useRef)(t);return(0,o.useEffect)((()=>{a.current=t}),[t]),[t,n,a]}(0),[s,u]=(0,o.useState)(!0);return(0,o.useEffect)((()=>{let e;i(0);const o=We(r).map((e=>e+1));return u(!1),function r(){e=setTimeout((()=>{c.current>=t.length?(clearTimeout(e),u(!0)):(i((e=>{const n=e+(Ve(o)??1);return t.substring(e,n).includes(" ")?e+1:n})),r())}),n+(.5-Math.random())*a)}(),()=>{clearTimeout(e)}}),[t]),o.createElement(o.Fragment,null,t.slice(0,l),t.length!==l,!s&&o.createElement(At,null))}const Ct=it.F4`
  to {
    visibility: hidden;
  }
`,At=(0,x.ZP)("span")`
  ...
  animation: ${Ct} 1s steps(2, start) infinite;
`;function kt(){var e;const{question:t,error:n,phase:a}=y(),r=(0,o.useMemo)((()=>{try{if((0,u.nf)(t))return(0,nt.WU)(t.querySQL,{language:"mysql"});var e;if(function(e){if((0,Ne.IZ)(e)&&(0,u.nf)(e.response)&&(0,u.nf)(e.response.data))return"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL;return!1}(n))return(0,nt.WU)((null==(e=n.response)?void 0:e.data.querySQL)??"",{language:"mysql"})}catch(a){return(null==t?void 0:t.querySQL)??""}}),[t,n]),l=(0,o.useMemo)((()=>{switch(a){case g.NONE:return"pending";case g.LOADING:case g.CREATING:case g.GENERATING_SQL:return"loading";case g.GENERATE_SQL_FAILED:case g.LOAD_FAILED:case g.CREATE_FAILED:return"error";default:return"success"}}),[a]),i=(0,o.useMemo)((()=>{switch(a){case g.NONE:return"";case g.LOADING:return"Loading question...";case g.CREATING:return"Generating SQL...";case g.GENERATING_SQL:return o.createElement(Mt,null);case g.LOAD_FAILED:return"Question not found";case g.GENERATE_SQL_FAILED:case g.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[a]),c=(0,o.useMemo)((()=>{if("error"===l)return n}),[l,n]),s=a===g.CREATED||a===g.GENERATING_SQL;return o.createElement(ft,{status:l,title:i,icon:s?"bot":"default",extra:"auto",error:c,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for",errorMessage:(0,Ne.IZ)(c)&&429===(null==(e=c.response)?void 0:e.status)?o.createElement(o.Fragment,null,"Wow, you're a natural explorer! But it's a little tough to keep up!",o.createElement("br",null),"Take a break and try again in ",Lt(c),".",o.createElement("br",null),"Check out ",o.createElement(Ee,null,"Chat2Query")," if you want to try AI-generated SQL in any other dataset ",o.createElement("b",null,"within 5 minutes"),"."):o.createElement(o.Fragment,null,"Whoops! No SQL query is generated. Check out ",o.createElement("a",{href:"javascript:void(0)",onClick:at("faq-failed-to-generate-sql")},"potential reasons")," and try again later.")},(0,u.N6)(r)&&o.createElement(ve.Z,{language:"sql"},r))}const Nt=[["Great question!","Interesting question!","Awesome question!","You asked a winner!"],["Sometimes I'm not smart enough...","Sometimes it's difficult for me...","Not always generate perfect SQL...","Struggling with SQL accuracy..."],["Tough, but still trying...","Hard, but persevering.","Tough, but forging ahead...","Challenging, but still striving...","Struggling, but pushing on..."],["Mastering the art of turning words into SQL magic\u2026","Gaining knowledge from your input...","Learning from your question...","Getting smarter with your input..."],["Making every effort!","Working my hardest","Trying my best...","Striving for greatness...","Trying my best..."],["Almost there\u2026","Almost done...","Just a second!"]];function Mt(){const e=(0,o.useRef)({group:0}),[t,n]=(0,o.useState)((()=>Ve(Nt[0])));return(0,Zt.Z)((()=>{let{group:t}=e.current;t<5?t+=1:t=4,n(Ve(Nt[t])),e.current.group=t}),3e3),(0,u.nf)(t)?o.createElement(It,{content:t}):o.createElement(o.Fragment,null,"Generating SQL...")}function Lt(e){const t=(0,Ne.PY)(e);if((0,u.nf)(null==t?void 0:t.waitMinutes))return`${null==t?void 0:t.waitMinutes} minutes`;const n=(0,Ne.e$)(e).match(/please wait (.+)\./);return(0,u.nf)(n)?n[1]:"30 minutes"}var Pt=n(87462),Tt=n(36804),Gt=n(88784);function Rt(e){let{children:t}=e;return o.createElement(Gt.Z,{title:o.createElement(v.Z,{p:1,fontSize:14},t)},o.createElement(te.Z,null,o.createElement(Tt.Z,{fontSize:"inherit"})))}var Ft=n(44373),Dt=n(78385),$t=n(87054),qt=n(85390);function Bt(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,u.uW)(a)?a.map((e=>({name:e}))):(0,u.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(zt,null,o.createElement(Ot,{className:"clearTable"},o.createElement("thead",null,(0,u.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const zt=(0,x.ZP)("div")`
  overflow: scroll;
`,Ot=(0,x.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var Ut=n(66284);function Ht(e){return/date|time|year|month/.test(e)}function _t(e){return"number"==typeof e?e>=1970&&e<2100:_t(Number(e))}function Qt(e,t){return e.map((e=>{let n=e[t];return _t(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function Wt(e,t){return(0,u.YN)(t,(e=>!(0,u.Rw)(e)&&(e instanceof Array?e.length>0&&(0,u.YN)(e,u.GC):(0,u.GC)(e))))?e.filter((e=>(0,u.YN)(t,(e=>t=>"string"==typeof t?(0,u.nf)(e[t]):(0,u.YN)(t,(t=>(0,u.nf)(e[t]))))(e)))):[]}var Vt=n(85214),Kt=n(81284),Yt=n(19594),jt=n(95309),Xt=n(61702),Jt=n(44731);function en(e){let{name:t}=e;const n=(0,o.useMemo)((()=>/\[bot]/i.test(t)?"/img/github-bot-icon.svg":`https://github.com/${t}.png`),[t]);return o.createElement(Jt.Z,{src:n})}var tn=n(49837),nn=n(91359),an=n(45344);const on=(0,x.ZP)("span")`
  font-size: 16px;
  opacity: 0.3;
  margin-left: 4px;
`;var rn=n(74446),ln=n(75559),cn=n(40172);const sn=(0,x.ZP)("div")`
  height: 100%;
`;var un=n(6068),dn=n(30120);function mn(e){let{title:t}=e;const{question:n}=y(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r,l;return Pe("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n\n## Question title:\n**${(null==n||null==(e=n.title)?void 0:e.replaceAll("@",""))??""}**\n\n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(a=n.result)?void 0:a.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(o=n.result)?void 0:o.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(r=n.result)||null==(l=r.rows)?void 0:l[0],void 0,2)}\n\`\`\`\n\n## Time info:\n| createdAt              | executedAt              | finishedAt              | requestedAt              |\n|------------------------|-------------------------|-------------------------|--------------------------|\n| ${gn(null==n?void 0:n.createdAt)} | ${gn(null==n?void 0:n.executedAt)} | ${gn(null==n?void 0:n.finishedAt)} | ${gn(null==n?void 0:n.requestedAt)} |\n\n      `})}),[n]);return o.createElement(Xe,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}function gn(e){return(0,u.Rw)(e)?"-":dn.ou.fromISO(e).toFormat("yyyy-MM-dd HH:mm:ss")}(0,un.y)();const pn={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=Ht(a);l=e?Qt(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(Ut.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const{options:i,height:c}=(0,o.useMemo)((()=>{const e=Ht(a);l=e?Qt(l,a):l;const t=!e,o=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:t?e:a,y:t?a:e}}:e.map(o)};return{options:{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:o(r),title:{text:n},[t?"yAxis":"xAxis"]:{type:e?"time":"category",inverse:t},[t?"xAxis":"yAxis"]:{type:"value",position:t?"top":void 0},animationDuration:2e3},height:Math.max(t?40*l.length:400,400)}}),[t,n,a,r,l]);return o.createElement(Ut.Z,{theme:"dark",style:{height:c},opts:{height:c},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",top:36,name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(Ut.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(Vt.Z,null,r.map(((e,t)=>o.createElement(Kt.ZP,{key:t},o.createElement(jt.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(Yt.Z,null,o.createElement(en,{name:e[a]})),o.createElement(Xt.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(Vt.Z,null,r.map(((e,t)=>o.createElement(Kt.ZP,{key:t},o.createElement(jt.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(Yt.Z,null,o.createElement(en,{name:e[a].split("/")[0]})),o.createElement(Xt.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:Bt,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l,columns:i,fields:c}=e;const s=(0,o.useMemo)((()=>(0,u.uW)(i)?i.map((e=>({name:e}))):(0,u.nf)(c)?c:l.length>0?Object.keys(l[0]).map((e=>({name:e}))):[{name:""}]),[l,i,c]),d=(0,o.useMemo)((()=>{var e;return(0,u.GC)(a)?a:(null==c||null==(e=c.find((e=>/repo|name|user|login/.test(e.name)&&e.name!==r)))?void 0:e.name)??""}),[s,a]);if(1===l.length){const e=l[0][d]??n,t=l[0][r];return o.createElement(tn.Z,null,o.createElement(nn.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Le.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},e),(0,u.z0)(t)?o.createElement(an.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(t),o.createElement(on,null,r)))}return(0,u.N6)(d)?o.createElement(o.Fragment,null,o.createElement(Le.Z,{variant:"h4"},n),o.createElement(Fe.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Fe.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(tn.Z,{sx:{p:2}},o.createElement(Le.Z,{variant:"subtitle1"},e[d]),o.createElement(Le.Z,{variant:"body2",color:"#7c7c7c"},e[r]))))))):o.createElement(Vt.Z,null,l.map(((e,t)=>o.createElement(Kt.ZP,{key:t},o.createElement(tn.Z,{sx:{p:4}},o.createElement(Xt.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),d=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,rn.$)(e[t]),{long:o,lat:r}=(0,rn.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,u.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=d[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,ln.Mm)(),dataset:[{id:"top1",source:d.slice(0,1)},{id:"rest",source:d.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=d[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,d]);return(0,o.useEffect)((()=>{if((0,u.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(cn.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(sn,{ref:c},o.createElement(Ut.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function hn(e){let{onPrepared:t,onExit:n,...a}=e;const{config:r,fields:l}=(0,o.useMemo)((()=>{const e=pn[a.chartName];return{config:e,fields:((null==e?void 0:e.requiredFields)??[]).map((e=>a[e]))}}),[(0,Qe.wE)(a)]),i=Wt(a.data,l);let c,s;return(0,u.Rw)(r)&&(c=o.createElement(mn,{title:`AI has generated an unknown chart type '${a.chartName}'`})),0===a.data.length?c=o.createElement(rt,null):i.length>0?(0,u.nf)(r)&&(s=(0,o.createElement)(r.Chart,{...a,data:i})):c=o.createElement(mn,{title:"AI has generated invalid chart info"}),(0,o.useEffect)((()=>(0!==a.data.length&&0===i.length?null==t||t(!0):null==t||t(!1),()=>{null==n||n()})),[i.length,a.data.length,t,n]),o.createElement(o.Fragment,null,c,s)}var fn=n(91693),En=n(96942),yn=n(45670),bn=n(55050),vn=n(89747),xn=n(76743);function wn(e){let{loading:t=!1,children:n}=e;return o.createElement(Sn,{elevation:0},o.createElement(nn.Z,null,o.createElement(Le.Z,{variant:"h4",display:"flex",alignItems:"center",fontSize:16,fontFamily:"monospace"},o.createElement(Zn,null),o.createElement(In,null,"Insight robot:")),o.createElement(Le.Z,{variant:"body1",fontSize:14,fontFamily:"monospace",mt:2,whiteSpace:"pre-wrap"},t?o.createElement(De.Z,{variant:"text",width:"61%"}):n)))}const Sn=(0,x.ZP)(tn.Z)`
...
`,In=(0,x.ZP)("span")`
  margin-left: 12px;
`;var Cn=n(21972),An=n(46895),kn=n(78667),Nn=n(49185),Mn=n(87385),Ln=n(37332),Pn=n(70431),Tn=n(44276),Gn=n(1969);function Rn(e){let{url:t,title:n,summary:a,hashtags:r}=e;const{showTips:l}=Z(),i=(0,s.Z)((e=>{l(),window.open(e,"_blank")}));return o.createElement($n,null,o.createElement(Cn.Z,{ariaLabel:"share",sx:{display:"inline-block",position:"absolute",right:0,top:0,[`.${kn.Z.actions}`]:{width:64,display:"flex",flexDirection:"column",alignItems:"flex-end"}},icon:o.createElement("span",null,"Share",o.createElement(Nn.Z,{fontSize:"inherit"})),FabProps:Fn},o.createElement(An.Z,{sx:{overflow:"hidden"},icon:o.createElement(Mn.Z,null),FabProps:Dn,onClick:(0,w.Z)((()=>i((0,Gn.PE)(t,{title:n,hashtags:r}))))}),o.createElement(An.Z,{sx:{overflow:"hidden"},icon:o.createElement(Ln.Z,null),FabProps:Dn,onClick:(0,w.Z)((()=>i((0,Gn.BE)(t,{title:n,summary:a}))))}),o.createElement(An.Z,{sx:{overflow:"hidden"},icon:o.createElement(Pn.Z,null),FabProps:Dn,onClick:(0,w.Z)((()=>i((0,Gn.$Z)(t,{title:n}))))}),o.createElement(An.Z,{sx:{overflow:"hidden"},icon:o.createElement(Tn.Z,null),FabProps:Dn,onClick:(0,w.Z)((()=>i((0,Gn.OA)(t,{title:n}))))})))}const Fn={color:"inherit",disableRipple:!0,sx:{fontFamily:"var(--ifm-heading-font-family)",textTransform:"unset",fontSize:16,fontWeight:"normal",width:68,height:32,minHeight:32,background:"none",boxShadow:"none !important",pr:.5,"> span":{display:"inline-flex",gap:.5,alignItems:"center"},"&:hover, &:active":{background:"none"}}},Dn={sx:{width:32,height:32,minHeight:32,borderRadius:16,mx:0,overflow:"hidden"}},$n=(0,x.ZP)("div")`
  display: inline-block;
  position: relative;
  width: 64px;
  height: 32px;
  line-height: 32px;
`;var qn=n(4316),Bn=n(95764),zn=n(85753),On=n(98628),Un=n(4882),Hn=n(71406);function _n(e){let{sx:t}=e;const{showTips:n}=Z(),{question:a}=y(),{setAsyncData:l}=(0,Un.P)(void 0),s=(0,Hn.Gb)("explorer-feedback-button"),{isAuthenticated:d}=(0,ie.D3)(),{data:m,mutate:g}=(0,Qe.ZP)(d&&(0,u.nf)(a)?[a.id,"question-feedback"]:void 0,{fetcher:async e=>await s().then((async t=>await async function(e,t){return await r.po.get(`/explorer/questions/${e}/feedback`,{oToken:t})}(e,t))).then((e=>(0,u.uW)(e)?Boolean(e[0].satisfied):void 0)),errorRetryCount:0}),p=(0,w.Z)((()=>{(0,u.Rw)(a)||(l(!0===m?s().then((async e=>await c(a.id,!0,e).finally((()=>{g(void 0)})))):s().then((async e=>await i(a.id,{satisfied:!0},e).finally((()=>{g(!0)}))))),n())})),h=(0,w.Z)((()=>{(0,u.Rw)(a)||l(!1===m?s().then((async e=>await c(a.id,!1,e).finally((()=>{g(void 0)})))):s().then((async e=>await i(a.id,{satisfied:!1},e).finally((()=>{g(!1)})))))}));return o.createElement(ae.Z,{sx:t,direction:"row",spacing:2},o.createElement(te.Z,{onClick:p,color:!0===m?"primary":void 0,size:"small"},!0===m?o.createElement(zn.Z,{color:"primary",fontSize:"inherit"}):o.createElement(On.Z,{fontSize:"inherit"})),o.createElement(te.Z,{onClick:h,color:!1===m?"primary":void 0,size:"small"},!1===m?o.createElement(qn.Z,{color:"primary",fontSize:"inherit"}):o.createElement(Bn.Z,{fontSize:"inherit"})))}function Qn(){var e,t,n;const{question:a,error:r,phase:i}=y(),{search:c}=Z(),[s,d]=(0,o.useState)(null),m=null==a||null==(e=a.result)?void 0:e.rows,p=(0,o.useMemo)((()=>{switch(i){case g.CREATED:case g.QUEUEING:case g.EXECUTING:return"loading";case g.EXECUTE_FAILED:case g.VISUALIZE_FAILED:case g.UNKNOWN_ERROR:return"error";case g.READY:case g.SUMMARIZING:return"success";default:return"pending"}}),[i]),h=(0,o.useMemo)((()=>{var e;switch(i){case g.CREATED:return"Pending...";case g.QUEUEING:return`${(null==a?void 0:a.queuePreceding)??NaN} requests ahead`;case g.EXECUTING:return"Running SQL...";case g.EXECUTE_FAILED:return"Failed to execute SQL";case g.UNKNOWN_ERROR:return"Unknown error";case g.VISUALIZE_FAILED:case g.READY:case g.SUMMARIZING:return o.createElement(o.Fragment,null,`${(null==a||null==(e=a.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==a?void 0:a.spent)??"NaN"} seconds`,function(e){if((0,u.nf)(e)&&!(0,u.yD)(e.engines))return o.createElement(o.Fragment,null,". Running on",o.createElement(Vn,null,e.engines.map(Wn).join(", ")),o.createElement(Rt,null,"All queries run on ",o.createElement("b",null,"ONE")," TiDB service. The TiDB SQL optimizer decides which engine to use for executing queries:",o.createElement("ul",null,o.createElement("li",null,"Complex and heavy OLAP queries are executed by the columnar engine."),o.createElement("li",null,"Low-latency high-concurrency OLTP queries are executed by the row-based engine."))));return null}(a));default:return"pending"}}),[a,i]),{url:f,title:E,hashtags:b}=(0,o.useMemo)((()=>{var e;if((0,u.Rw)(a))return{url:"https://ossinsight.io/explore/",title:"Data Explorer",hashtags:[]};let t;const n=`${c} | OSSInsight Data Explorer`,o=function(){const e=new Set,t=[];for(var n=arguments.length,a=new Array(n),o=0;o<n;o++)a[o]=arguments[o];return a.forEach((n=>{for(const a of n)e.has(a)||(e.add(a),t.push(a))})),t}((null==(e=a.answerSummary)?void 0:e.hashtags)??[],["OpenSource","OpenAI","TiDBCloud"]);return t=(0,u.GC)(a.id)?`https://ossinsight.io/explore?id=${a.id}`:"https://ossinsight.io/explore/",{url:t,title:n,hashtags:o}}),[a,c]),v=(0,o.useMemo)((()=>{if("error"===p)return r}),[p,r]),x=(0,o.useMemo)((()=>{if(i===g.VISUALIZE_FAILED)return r}),[i,r]),w=(0,o.useMemo)((()=>(0,u.nf)(a)&&(0,u.nf)(a.answerSummary)?(0,u.uW)(a.answerSummary.hashtags)?`${a.answerSummary.content}\n${a.answerSummary.hashtags.map((e=>`#${e}`)).join(" ")}`:a.answerSummary.content:""),[null==a?void 0:a.answerSummary]);return o.createElement(ft,{status:p,title:h,extra:o.createElement(aa,null,o.createElement("span",{ref:d}),o.createElement(Rn,{url:f,title:E,summary:null==a||null==(t=a.answerSummary)?void 0:t.content,hashtags:b})),error:v,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute",errorMessage:o.createElement(o.Fragment,null,"Oops, something went wrong while executing your SQL query. Please try again. If the problem persists, check out ",o.createElement("a",{href:"javascript:void(0)",onClick:at("data-explorer-faq")},"FAQ"))},((0,u.nf)(null==a?void 0:a.answerSummary)||(null==a?void 0:a.status)===l.Summarizing)&&o.createElement(wn,{loading:(null==a?void 0:a.status)===l.Summarizing},o.createElement(It,{content:w,maxContinuous:2,avgInterval:40})),i===g.QUEUEING&&o.createElement(Jn,{source:0===(null==a?void 0:a.queuePreceding)?jn:Yn,interval:5e3}),i===g.EXECUTING&&o.createElement(Jn,{source:Xn,interval:3e3}),o.createElement(Kn,{chartData:(null==a?void 0:a.chart)??void 0,chartError:x,result:m,fields:null==a||null==(n=a.result)?void 0:n.fields,controlsContainer:s}))}function Wn(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const Vn=(0,x.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function Kn(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization"),s=(0,o.useRef)("visualization");(0,o.useEffect)((()=>{c(s.current)}),[t]);const d=(e,t)=>{(0,u.GC)(t)&&c(t)},m=(0,w.Z)((e=>{s.current=e?"raw":"visualization"})),g=(0,w.Z)((()=>{s.current="visualization"}));return(0,o.useMemo)((()=>{const e=(0,Ne.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(lt,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,u.Rw)(r))return(0,u.nf)(n)?c(!1,!0):null;const s=()=>o.createElement(o.Fragment,null,o.createElement(ae.Z,{direction:"row",justifyContent:"center",alignItems:"center",flexWrap:"wrap",spacing:.5,py:1,mt:2,fontSize:"inherit",bgcolor:"#323140"},o.createElement(Le.Z,{variant:"body1",mr:2},"Do you like the result?"),o.createElement(_n,null)),o.createElement(Ft.Z,{sx:{my:2}}),o.createElement(Le.Z,{component:"div",variant:"body2",color:"#D1D1D1"},"\ud83e\udd14 Not exactly what you're looking for?",o.createElement("ul",null,o.createElement("li",null,"AI can write SQL effectively, but remember that it's still a work in progress with limitations. "),o.createElement("li",null,"Clear and specific language will help the AI understand your needs. Eg. use '@facebook/react' instead of 'react'. Check out ",o.createElement("a",{href:"javascript:void(0)",onClick:at("data-explorer-faq")},"FAQ")," for more tips."),o.createElement("li",null,"GitHub data is not your focus? ",o.createElement(Ee,null,"Use Chat2Query to empower your data exploration")," on any dataset.")))),p=()=>o.createElement(o.Fragment,null,o.createElement(ra,null,o.createElement(Bt,{chartName:"Table",title:"",data:r,fields:a})),s());if((0,u.Rw)(t))return(0,u.nf)(n)?o.createElement(o.Fragment,null,c(!0),p()):null;const h=()=>o.createElement(o.Fragment,null,o.createElement(ra,null,o.createElement(hn,(0,Pt.Z)({},t,{data:r,fields:a,onPrepared:m,onExit:g}))),s());return(0,u.nf)(n)?o.createElement(o.Fragment,null,c(!0),p()):"Table"===t.chartName?h():o.createElement(o.Fragment,null,o.createElement(Dt.Z,{container:l},o.createElement(na,{className:"chart-controls"},o.createElement(qt.Z,{size:"small",value:i,onChange:d,exclusive:!0,color:"primary"},o.createElement($t.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(fn.Z,{fontSize:"small"})),o.createElement($t.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(En.Z,{fontSize:"small"}))))),o.createElement(yn.ZP,{value:i},o.createElement(oa,{value:"visualization"},h()),o.createElement(oa,{value:"raw"},p())))}),[i,t,n,r,a])}const Yn=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? - 17 types!","GitHub generates over 4 million new events each day. We synchronize with them in real time and insert updates in milliseconds.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],jn=["Almost there! Can't wait to see your result!"],Xn=[o.createElement(o.Fragment,null,"Querying ",o.createElement("b",null,"5+ billion")," rows of GitHub data..."),o.createElement(o.Fragment,null,"We stay in sync with GitHub event data for ",o.createElement("b",null,"real-time")," insights!"),o.createElement(o.Fragment,null,"We can handle ",o.createElement("b",null,"complex queries")," with a powerful database, even those generated by AI."),o.createElement(o.Fragment,null,o.createElement("b",null,"\ud83d\udc40 Tips"),": Click ",o.createElement("b",null,"Show")," in the upper right corner to check the SQL query generated by AI.")],Jn=e=>{let{source:t,interval:n}=e;const[a,r]=(0,o.useState)(0);return(0,Zt.Z)((()=>{r((e=>(e+1)%t.length))}),n),o.createElement(vn.Z,{component:ea},o.createElement(ct,{animated:!1}),o.createElement(xn.Z,{key:a,timeout:400,classNames:"item"},o.createElement(ta,null,t[a])))},ea=(0,x.ZP)("span")`
  position: relative;
  display: block;
  min-height: 42px;
  min-width: 1px;
...
`,Ia=o.createElement(Sa,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Re.Z,null)),Ca=o.createElement(Za,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(fa.Z,{fontSize:"inherit"}));var Aa=n(77331);function ka(){const{question:e}=y(),[t,n]=(0,o.useState)(!1);(0,o.useEffect)((()=>{n(!1)}),[null==e?void 0:e.id]);const a=(0,s.Z)((e=>()=>{e(),n(!0)}));return o.createElement(Na,null,o.createElement(je,{variant:"text",n:4,title:(e,t)=>o.createElement(Le.Z,{variant:"h3",mb:0,fontSize:16},"\ud83d\udca1 Get inspired",o.createElement(te.Z,{onClick:a(e),disabled:t},o.createElement(Te.Z,{fontSize:"inherit"})))}),t&&o.createElement(o.Fragment,null,o.createElement(Ft.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(v.Z,null,o.createElement(Ee,{as:Ma},"Check out ",o.createElement("b",null,"Chat2Query")," to empower any dataset you want.",o.createElement(Aa.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})),o.createElement(La,null,"*Chat2Query: an AI-powered querying tool in TiDB Cloud that generates SQL for your queries."))))}const Na=(0,x.ZP)("div")`
  position: sticky;
  top: 92px;
`,Ma=(0,x.ZP)(qe.Z)`
  display: block;
...
`,La=(0,x.ZP)("p")`
  ...
  font-size: 12px;
  color: #7c7c7c;
`;var Pa=n(5299),Ta=n(63675),Ga=n(25425),Ra=n(7449);const Fa=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,Ta.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>dn.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,s.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(dn.ou.now()))??[dn.ou.now()])))})),c=(0,w.Z)((()=>{a(!1)}));return(0,Ra.h)(t,{show:i}),o.createElement(Dt.Z,null,o.createElement(Ga.Z,{direction:"left",in:n},o.createElement(Da,null,o.createElement($a,null),o.createElement(qa,null),o.createElement(Ba,null,o.createElement(nn.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Try ",o.createElement(Ee,null,"Chat2Query")," to empower your own data exploration."),o.createElement(za,{size:"small",onClick:c},o.createElement(oe.Z,null))))))})),Da=(0,x.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
...
`,za=(0,x.ZP)(te.Z)`
  ...
  right: 8px;
  top: 8px;
`;function Oa(){var e;const{question:t,loading:n,load:a,error:r,phase:l,reset:i,create:c}=f({pollInterval:2e3}),[s,d]=(0,b.ZP)("id",(0,b.Rc)(),!0),[m,h]=(0,o.useState)(""),y=(0,o.useRef)(null),x=!p.has(l),Z=x||(0,u.oM)(m),C=(0,u.Rw)(null==t?void 0:t.id)&&!n&&l!==g.CREATE_FAILED,A=((null==t||null==(e=t.result)?void 0:e.rows.length)??0)>0;(0,o.useEffect)((()=>{(0,u.nf)(t)&&h(t.title)}),[null==t?void 0:t.title]),(0,o.useEffect)((()=>{(0,u.nf)(s)?a(s):N()}),[s]),(0,o.useEffect)((()=>{(0,u.nf)(null==t?void 0:t.id)&&d(null==t?void 0:t.id)}),[n,null==t?void 0:t.id]);const k=(0,w.Z)((()=>{x||c(m)})),N=(0,w.Z)((()=>{i(),h(""),d(void 0)})),M=(0,w.Z)((e=>{h(e),c(e)})),L=(0,w.Z)(((e,t)=>{s!==e&&(h(t??""),a(e))})),P=(0,w.Z)((()=>{var e;null==(e=y.current)||e.show()})),T=!C&&(l===g.READY||l===g.SUMMARIZING)&&A;return o.createElement(E.Provider,{value:{phase:l,question:t,loading:n,error:r,create:c,load:a,reset:i}},o.createElement(S.Provider,{value:{search:m,handleSelect:M,handleSelectId:L,showTips:P}},o.createElement(I,null),o.createElement(G,{showSide:T,showHeader:C,showFooter:C,header:o.createElement(K,null),side:o.createElement(ka,null),footer:o.createElement(v.Z,{mt:2},o.createElement(Ee,{as:Ua},"GitHub data is just the beginning. Try Chat2Query to maximize your data value with AI-generated SQL.",o.createElement(Pa.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})),o.createElement(Ha,null,"*Chat2Query: an AI-powered querying tool in TiDB Cloud that generates SQL for your queries."))},o.createElement(ce,{value:m,onChange:h,onAction:k,disableInput:x,disableClear:""===m,disableAction:Z,onClear:N,clearState:x?"stop":void 0}),o.createElement(me,{state:C?"recommend":"execution",direction:C?"down":"up"},o.createElement(v.Z,{key:"execution",sx:{mt:1.5}},o.createElement(la,{search:m})),o.createElement(v.Z,{key:"recommend",sx:{mt:4}},o.createElement(ia,null)))),o.createElement(Ea,null),o.createElement(Fa,{ref:y})))}const Ua=(0,x.ZP)(qe.Z)`
  display: block;
  color: white !important;
  text-decoration: none !important;
  margin-top: 72px;
