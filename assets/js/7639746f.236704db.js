...
`,P=(0,w.ZP)(N)`
  ...
  overflow: hidden;
`;var M=n(36336),L=n(98885),T=n(93580);const R=400;function G(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),d=(0,o.useRef)(null),m=(0,T.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??0),[null==m?void 0:m.height]);return o.createElement(F,{maxWidth:"xl"},o.createElement(L.ZP,{nodeRef:s,in:c,timeout:R},(e=>o.createElement(o.Fragment,null,o.createElement($,{ref:s,className:`Header-${e}`,height:g},n),o.createElement(D,{className:`Body-header-${e}`,headerHeight:g},o.createElement(L.ZP,{nodeRef:u,in:i,timeout:R},(e=>o.createElement(B,{ref:u,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:d,in:i,timeout:R,unmountOnExit:!0},(e=>o.createElement(q,{ref:d,className:`Side-${e}`},a))))))),o.createElement(z,null,l&&r))}const F=(0,w.ZP)(M.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`;var ye=n(14850),be=n(74065),ve=n(47028),xe=n(21945),we=n(70795),Se=n(70918),Ze=n(70983),Ie=n(96812),Ce=n(6571),Ae=n(47135),Ne=n(19604),ke=n(29630);function Pe(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Me=n(54566),Le=n(21039),Te=n(23147),Re=n(79072),Ge=n(91655),Fe=n(50522),De=n(39960);const $e=(0,w.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Be=(0,w.ZP)(Fe.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,qe=(0,w.ZP)($e,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`;(0,w.ZP)(Be,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,qe.withComponent(Fe.Z),qe.withComponent(De.Z);function ze(e){let{question:t,questionId:n,variant:a="card",prefix:r,disabled:l}=e;const{handleSelect:i,handleSelectId:c}=(0,o.useContext)(Z),s=(0,S.Z)((()=>{(0,d.GC)(n)?c(n):"string"==typeof t&&i(t)}));switch(a){case"recommended-card":return o.createElement($e,null,o.createElement(Be,{onClick:s,disabled:l},t),o.createElement(Ue,null,"\u2728"));case"card":return o.createElement(Be,{onClick:s,disabled:l},t);default:return o.createElement(Oe,{disableRipple:!0,disableTouchRipple:!0,onClick:s,disabled:l},r,t)}}const Oe=(0,w.ZP)(Fe.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`;function It(){const{question:e,error:t,phase:n}=b(),a=(0,o.useMemo)((()=>{try{if((0,d.nf)(e))return(0,et.WU)(e.querySQL,{language:"mysql"});var n;if(function(e){if((0,Ae.IZ)(e)&&(0,d.nf)(e.response)&&(0,d.nf)(e.response.data))return"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL;return!1}(t))return(0,et.WU)((null==(n=t.response)?void 0:n.data.querySQL)??"",{language:"mysql"})}catch(a){return(null==e?void 0:e.querySQL)??""}}),[e,t]),r=(0,o.useMemo)((()=>{switch(n){case h.NONE:return"pending";case h.LOADING:case h.CREATING:case h.GENERATING_SQL:return"loading";case h.GENERATE_SQL_FAILED:case h.LOAD_FAILED:case h.CREATE_FAILED:return"error";default:return"success"}}),[n]),l=(0,o.useMemo)((()=>{switch(n){case h.NONE:return"";case h.LOADING:return"Loading question...";case h.CREATING:return"Generating SQL...";case h.GENERATING_SQL:return o.createElement(At,null);case h.LOAD_FAILED:return"Question not found";case h.GENERATE_SQL_FAILED:case h.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[n]),i=(0,o.useMemo)((()=>{if("error"===r)return t}),[r,t]),c=n===h.CREATED||n===h.GENERATING_SQL;return o.createElement(gt,{status:r,title:l,icon:c?"bot":"default",extra:"auto",error:i,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for"},(0,d.N6)(a)&&o.createElement(ye.Z,{language:"sql"},a))}const Ct=[["Great question!","Interesting question!","Awesome question!","You asked a winner!"],["Thinking...","Brain busting!","Creating SQL..."],["Tough, but still trying...","Hard, but persevering.","Tough, but forging ahead...","Challenging, but still striving...","Struggling, but pushing on..."],["Mastering the art of turning words into SQL magic\u2026","Gaining knowledge from your input...","Learning from your question...","Getting smarter with your input..."],["Making every effort!","Working my hardest","Trying my best...","Striving for greatness...","Trying my best..."],["Almost there\u2026","Almost done...","Just a second!"]];function At(){const e=(0,o.useRef)({group:0}),[t,n]=(0,o.useState)((()=>Qe(Ct[0])));return(0,xt.Z)((()=>{let{group:t}=e.current;t<5?t+=1:t=4,n(Qe(Ct[t])),e.current.group=t}),3e3),(0,d.nf)(t)?o.createElement(wt,{content:t}):o.createElement(o.Fragment,null,"Generating SQL...")}var Nt=n(87462),kt=n(36804),Pt=n(88784);function Mt(e){let{children:t}=e;return o.createElement(Pt.Z,{title:o.createElement(x.Z,{p:1,fontSize:14},t)},o.createElement(ne.Z,null,o.createElement(kt.Z,{fontSize:"inherit"})))}var Lt=n(78385),Tt=n(87054),Rt=n(85390),Gt=n(44373),Ft=n(4316),Dt=n(95764),$t=n(85753),Bt=n(98628),qt=n(4882),zt=n(71406);function Ot(){const{showTips:e}=I(),{question:t}=b(),{loading:n,setAsyncData:a}=(0,qt.P)(void 0),r=(0,zt.Gb)(),{isAuthenticated:l}=(0,ce.D3)(),{data:c,mutate:u}=(0,_e.ZP)(l&&(0,d.nf)(t)?[t.id,"question-feedback"]:void 0,{fetcher:async e=>await r().then((async t=>await async function(e,t){return await i.po.get(`/explorer/questions/${e}/feedback`,{oToken:t})}(e,t))).then((e=>(0,d.uW)(e)?Boolean(e[0].satisfied):void 0)),errorRetryCount:0}),m=(0,S.Z)((()=>{(0,d.Rw)(t)||(a(r().then((async e=>await s(t.id,{satisfied:!0},e).finally((()=>{u(!0)}))))),e())})),g=(0,S.Z)((()=>{(0,d.Rw)(t)||a(r().then((async e=>await s(t.id,{satisfied:!1},e).finally((()=>{u(!0)})))))}));return o.createElement(Ut,null,o.createElement(_t,null,o.createElement(Ht,{disabled:!0===c||n,onClick:m},!0===c?o.createElement($t.Z,{color:"primary",fontSize:"inherit"}):o.createElement(Bt.Z,{fontSize:"inherit"})),o.createElement(Gt.Z,{orientation:"vertical",flexItem:!0,sx:{my:.5}}),o.createElement(Ht,{disabled:!1===c||n,onClick:g},!1===c?o.createElement(Ft.Z,{color:"primary",fontSize:"inherit"}):o.createElement(Dt.Z,{fontSize:"inherit"}))))}const Ut=(0,w.ZP)("div")`
  position: absolute;
  pointer-events: none;
  right: 8px;
  bottom: 8px;
...
`,An=(0,w.ZP)("span")`
  margin-left: 12px;
`;var Nn=n(21972),kn=n(46895),Pn=n(78667),Mn=n(49185),Ln=n(87385),Tn=n(37332),Rn=n(70431),Gn=n(44276),Fn=n(1969);function Dn(e){let{url:t,title:n,summary:a,hashtags:r}=e;const{showTips:l}=I(),i=(0,u.Z)((e=>{l(),window.open(e,"_blank")}));return o.createElement(qn,null,o.createElement(Nn.Z,{ariaLabel:"share",sx:{display:"inline-block",position:"absolute",right:0,top:0,[`.${Pn.Z.actions}`]:{width:64,display:"flex",flexDirection:"column",alignItems:"flex-end"}},icon:o.createElement("span",null,"Share",o.createElement(Mn.Z,{fontSize:"inherit"})),FabProps:$n},o.createElement(kn.Z,{sx:{overflow:"hidden"},icon:o.createElement(Ln.Z,null),FabProps:Bn,onClick:(0,S.Z)((()=>i((0,Fn.PE)(t,{title:n,hashtags:r}))))}),o.createElement(kn.Z,{sx:{overflow:"hidden"},icon:o.createElement(Tn.Z,null),FabProps:Bn,onClick:(0,S.Z)((()=>i((0,Fn.BE)(t,{title:n,summary:a}))))}),o.createElement(kn.Z,{sx:{overflow:"hidden"},icon:o.createElement(Rn.Z,null),FabProps:Bn,onClick:(0,S.Z)((()=>i((0,Fn.$Z)(t,{title:n}))))}),o.createElement(kn.Z,{sx:{overflow:"hidden"},icon:o.createElement(Gn.Z,null),FabProps:Bn,onClick:(0,S.Z)((()=>i((0,Fn.OA)(t,{title:n}))))})))}const $n={color:"inherit",disableRipple:!0,sx:{fontFamily:"var(--ifm-heading-font-family)",textTransform:"unset",fontSize:16,fontWeight:"normal",width:68,height:32,minHeight:32,background:"none",boxShadow:"none !important",pr:.5,"> span":{display:"inline-flex",gap:.5,alignItems:"center"},"&:hover, &:active":{background:"none"}}},Bn={sx:{width:32,height:32,minHeight:32,borderRadius:16,mx:0,overflow:"hidden"}},qn=(0,w.ZP)("div")`
  display: inline-block;
  position: relative;
  width: 64px;
  height: 32px;
  line-height: 32px;
`;function zn(){var e,t,n;const{question:a,error:r,phase:l}=b(),{search:i}=I(),[s,u]=(0,o.useState)(null),m=null==a||null==(e=a.result)?void 0:e.rows,g=(0,o.useMemo)((()=>{switch(l){case h.CREATED:case h.QUEUEING:case h.EXECUTING:return"loading";case h.EXECUTE_FAILED:case h.VISUALIZE_FAILED:case h.UNKNOWN_ERROR:return"error";case h.READY:case h.SUMMARIZING:return"success";default:return"pending"}}),[l]),p=(0,o.useMemo)((()=>{var e;switch(l){case h.CREATED:return"Pending...";case h.QUEUEING:return`${(null==a?void 0:a.queuePreceding)??NaN} requests ahead`;case h.EXECUTING:return"Running SQL...";case h.EXECUTE_FAILED:return"Failed to execute SQL";case h.UNKNOWN_ERROR:return"Unknown error";case h.VISUALIZE_FAILED:case h.READY:case h.SUMMARIZING:return o.createElement(o.Fragment,null,`${(null==a||null==(e=a.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==a?void 0:a.spent)??"NaN"} seconds`,function(e){if((0,d.nf)(e)&&!(0,d.yD)(e.engines))return o.createElement(o.Fragment,null,". Running on",o.createElement(Un,null,e.engines.map(On).join(", ")),o.createElement(Mt,null,"All queries run on ",o.createElement("b",null,"ONE")," TiDB service. The TiDB SQL optimizer decides which engine to use for executing queries:",o.createElement("ul",null,o.createElement("li",null,"Complex and heavy OLAP queries are executed by the columnar engine."),o.createElement("li",null,"Low-latency high-concurrency OLTP queries are executed by the row-based engine."))));return null}(a));default:return"pending"}}),[a,l]),{url:f,title:E,hashtags:y}=(0,o.useMemo)((()=>{var e;if((0,d.Rw)(a))return{url:"https://ossinsight.io/explore",title:"Data Explorer",hashtags:[]};let t;const n=`${i} | OSSInsight Data Explorer`,o=function(){const e=new Set,t=[];for(var n=arguments.length,a=new Array(n),o=0;o<n;o++)a[o]=arguments[o];return a.forEach((n=>{for(const a of n)e.has(a)||(e.add(a),t.push(a))})),t}((null==(e=a.answerSummary)?void 0:e.hashtags)??[],["OpenSource","OpenAI","TiDBCloud"]);return t="undefined"==typeof location?(0,d.GC)(a.id)?`https://ossinsight.io/explore?id=${a.id}`:"https://ossinsight.io/explore":location.href,{url:t,title:n,hashtags:o}}),[a,i]),v=(0,o.useMemo)((()=>{if("error"===g)return r}),[g,r]),x=(0,o.useMemo)((()=>{if(l===h.VISUALIZE_FAILED)return r}),[l,r]),w=(0,o.useMemo)((()=>(0,d.nf)(a)&&(0,d.nf)(a.answerSummary)?(0,d.uW)(a.answerSummary.hashtags)?`${a.answerSummary.content}\n${a.answerSummary.hashtags.map((e=>`#${e}`)).join(" ")}`:a.answerSummary.content:""),[null==a?void 0:a.answerSummary]);return o.createElement(gt,{status:g,title:p,extra:o.createElement(Jn,null,o.createElement("span",{ref:u}),o.createElement(Dn,{url:f,title:E,summary:null==a||null==(t=a.answerSummary)?void 0:t.content,hashtags:y})),error:v,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},((0,d.nf)(null==a?void 0:a.answerSummary)||(null==a?void 0:a.status)===c.Summarizing)&&o.createElement(Zn,{loading:(null==a?void 0:a.status)===c.Summarizing},o.createElement(wt,{content:w,maxContinuous:2,avgInterval:40})),l===h.QUEUEING&&o.createElement(Vn,{source:0===(null==a?void 0:a.queuePreceding)?Qn:Hn,interval:5e3}),l===h.EXECUTING&&o.createElement(Vn,{source:Wn,interval:3e3}),o.createElement(_n,{chartData:(null==a?void 0:a.chart)??void 0,chartError:x,result:m,fields:null==a||null==(n=a.result)?void 0:n.fields,controlsContainer:s}))}function On(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const Un=(0,w.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function _n(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization"),s=(0,o.useMemo)((()=>e=>()=>{var t;null==(t=document.getElementById(e))||t.scrollIntoView({behavior:"smooth"})}),[]);(0,o.useEffect)((()=>{c("visualization")}),[t]);const u=(e,t)=>{(0,d.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,Ae.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(at,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,d.Rw)(r))return(0,d.nf)(n)?c(!1,!0):null;const m=()=>o.createElement(ke.Z,{component:"div",variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Not exactly what you're looking for?",o.createElement("ul",null,o.createElement("li",null,"AI can write SQL effectively, but remember that it's still a work in progress with limitations. "),o.createElement("li",null,"Clear and specific language will help the AI understand your needs. Check out ",o.createElement("a",{href:"javascript:void(0)",onClick:s("data-explorer-faq")},"FAQ")," for more tips."),o.createElement("li",null,"GitHub data is not your focus? Explore any other dataset with our capabilities."))),g=()=>o.createElement(o.Fragment,null,o.createElement(ea,null,o.createElement(Qt,{chartName:"Table",title:"",data:r,fields:a}),o.createElement(Ot,null)),m());if((0,d.Rw)(t))return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),g()):null;const h=()=>o.createElement(o.Fragment,null,o.createElement(ea,null,o.createElement(En,(0,Nt.Z)({},t,{data:r,fields:a})),o.createElement(Ot,null)),m());return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),g()):"Table"===t.chartName?h():o.createElement(o.Fragment,null,o.createElement(Lt.Z,{container:l},o.createElement(jn,{className:"chart-controls"},o.createElement(Rt.Z,{size:"small",value:i,onChange:u,exclusive:!0,color:"primary"},o.createElement(Tt.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(yn.Z,{fontSize:"small"})),o.createElement(Tt.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(bn.Z,{fontSize:"small"}))))),o.createElement(vn.ZP,{value:i},o.createElement(Xn,{value:"visualization"},h()),o.createElement(Xn,{value:"raw"},g())))}),[i,t,n,r,a])}const Hn=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? - 17 types!","GitHub generates over 4 million new events each day. We synchronize with them in real time and insert updates in milliseconds.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],Qn=["Almost there! Can't wait to see your result!"],Wn=["GitHub has an incredible 5+ billion rows of event data waiting for you to explore.","Perhaps AI generates a complex SQL.","Are you curious about the complex SQL query generated by AI? Click [Show] in the upper right corner to check it.","Do you know that you can click [Show] in the upper right corner to check the SQL query AI generated for you?"],Vn=e=>{let{source:t,interval:n}=e;const[a,r]=(0,o.useState)(0);return(0,xt.Z)((()=>{r((e=>(e+1)%t.length))}),n),o.createElement(wn.Z,{component:Kn},o.createElement(rt,{animated:!1}),o.createElement(Sn.Z,{key:a,timeout:400,classNames:"item"},o.createElement(Yn,null,t[a])))},Kn=(0,w.ZP)("span")`
  position: relative;
  display: block;
  min-height: 42px;
  min-width: 1px;
...
`,va=o.createElement(ya,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Te.Z,null)),xa=o.createElement(ba,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(da.Z,{fontSize:"inherit"}));var wa=n(77331),Sa=n(27952);function Za(){const{question:e}=b(),[t,n]=(0,o.useState)(!1);(0,o.useEffect)((()=>{n(!1)}),[null==e?void 0:e.id]);const a=(0,u.Z)((e=>()=>{e(),n(!0)}));return o.createElement(Ca,null,o.createElement(Ke,{variant:"text",n:4,title:(e,t)=>o.createElement(ke.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(Ia,null),"Get inspired",o.createElement(ne.Z,{onClick:a(e),disabled:t},o.createElement(Me.Z,{fontSize:"inherit"})))}),t&&o.createElement(o.Fragment,null,o.createElement(Gt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(Na,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(wa.Z,{color:"inherit"})))))}function Ia(){return o.createElement(o.Fragment,null,He(3).map((e=>o.createElement(Aa,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const Ca=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Aa=(0,w.ZP)(Sa.Z)`
  vertical-align: text-bottom;
...
`;var ka=n(5299),Pa=n(63675),Ma=n(30120),La=n(25425),Ta=n(7449);const Ra=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,Pa.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>Ma.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,u.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(Ma.ou.now()))??[Ma.ou.now()])))})),c=(0,S.Z)((()=>{a(!1)}));return(0,Ta.h)(t,{show:i}),o.createElement(Lt.Z,null,o.createElement(La.Z,{direction:"left",in:n},o.createElement(Ga,null,o.createElement(Fa,null),o.createElement(Da,null),o.createElement($a,null,o.createElement(sn.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Check out our ",o.createElement(De.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"tutorial"),", if you want to try AI-generated SQL for any other dataset."),o.createElement(Ba,{size:"small",onClick:c},o.createElement(re.Z,null))))))})),Ga=(0,w.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
