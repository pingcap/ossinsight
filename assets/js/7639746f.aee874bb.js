...
`,M=(0,Z.ZP)(A)`
  ...
  overflow: hidden;
`;var L=n(98885),P=n(8410);const R=400;function F(e){let{children:t,header:n,side:a,showSide:r,showHeader:l}=e;const i=(0,o.useRef)(null),c=(0,o.useRef)(null),s=(0,o.useRef)(null),d=(0,P.Z)(i),u=(0,o.useMemo)((()=>(null==d?void 0:d.height)??32),[null==d?void 0:d.height]);return o.createElement(o.Fragment,null,o.createElement(L.ZP,{nodeRef:i,in:l,timeout:R},(e=>o.createElement(k,{ref:i,className:`Header-${e}`,height:u},n))),o.createElement(T,null,o.createElement(L.ZP,{nodeRef:c,in:r,timeout:R},(e=>o.createElement(G,{ref:c,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:s,in:r,timeout:R,unmountOnExit:!0},(e=>o.createElement(D,{ref:s,className:`Side-${e}`},a)))))}const T=(0,Z.ZP)("div",{name:"Container"})`
...
`,k=(0,Z.ZP)("div",{name:"Header",shouldForwardProp:e=>"height"!==e})`
  opacity: 0;
  margin-top: -${e=>{let{height:t}=e;return t+32}}px;
  margin-bottom: ${32}px;
  transition: ${e=>{let{theme:t}=e;return t.transitions.create(["margin","opacity"],{duration:R})}};

  ${B("Header",!0)} {
    opacity: 1;
    margin-top: 0;
  }
`,G=(0,Z.ZP)("div",{name:"Main"})`
...
`,X=(0,Z.ZP)("p")`
  color: #7C7C7C;
  margin: 0;
`;var J=n(80562),j=n(75345),ee=n(9144),te=n(95537),ne=n(63871),ae=n(89022);function oe(e){let{value:t,onChange:n,onAction:a,onClear:r,disableInput:l=!1,disableAction:i=!1,disableClear:c=!1,clearState:s}=e;const d=(0,o.useRef)(null),{validating:u,validated:g}=(0,m.Ey)(),h=(0,w.Z)((e=>{n(e.target.value)})),p=(0,w.Z)((e=>{"Enter"===e.key&&(i||null==a||a())}));return o.createElement(o.Fragment,null,o.createElement(re,{fullWidth:!0,disabled:u&&!g||l,ref:d,value:t,onChange:h,onKeyDown:p,placeholder:"Type any question here, or choose one below",endAdornment:o.createElement(ee.Z,{direction:"row",gap:1},!i&&o.createElement(le,{color:"inherit",onClick:a,disabled:i},o.createElement(ne.Z,null)),o.createElement(le,{color:"stop"===s?"error":"inherit",onClick:r,disabled:c},"stop"===s?o.createElement(ae.Z,null):o.createElement(te.Z,null)))}))}const re=(0,Z.ZP)(j.ZP)`
...
`;function ie(e){const{marginTop:t,marginBottom:n}=getComputedStyle(e);return e.offsetHeight+parseFloat(t)+parseFloat(n)}function ce(e){let{state:t,transitionDelay:n=0,transitionDuration:a=400,offset:r=120,direction:l="up",revert:i=!1,children:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),[m,g]=(0,o.useState)();(0,o.useEffect)((()=>{if(2!==c.length)throw new Error("SwitchLayout should have exactly two children");if((0,d.Rw)(c[0].key)||(0,d.Rw)(c[1].key))throw new Error("SwitchLayout's children must have keys")}),[]);const h=(0,w.Z)((()=>{(0,d.nf)(s.current)&&g(ie(s.current))})),p=(0,w.Z)((()=>{(0,d.nf)(u.current)&&g(ie(u.current))})),f=(0,w.Z)((()=>{g(void 0)})),E=(0,w.Z)((()=>{(0,d.nf)(u.current)&&g(ie(u.current))})),y=(0,w.Z)((()=>{(0,d.nf)(s.current)&&g(ie(s.current))})),v=(0,w.Z)((()=>{g(void 0)})),b=n+a;return o.createElement(se,{offset:r,style:{height:m},duration:a,delay:n},o.createElement(L.ZP,{key:c[0].key,in:t===c[0].key,timeout:b,unmountOnExit:!0,onExit:h,onExiting:p,onExited:f},(e=>o.createElement(de,{ref:s,className:`SwitchItem-${l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[0]))),o.createElement(L.ZP,{key:c[1].key,in:t===c[1].key,timeout:b,unmountOnExit:!0,onExit:E,onExiting:y,onExited:v},(e=>o.createElement(de,{ref:u,className:`SwitchItem-${i?"up"===l?"down":"up":l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[1]))))}const se=(0,Z.ZP)("div",{name:"SwitchLayoutContainer",shouldForwardProp:e=>!["duration","delay","offset"].includes(String(e))})`
  position: relative;
  transition: ${e=>{let{theme:t,duration:n,delay:a}=e;return t.transitions.create("height",{duration:n,delay:a})}};
`,de=(0,Z.ZP)("div",{name:"SwitchItem",shouldForwardProp:e=>!["offset","duration","delay"].includes(String(e))})`
...
`;var ue=n(87462),me=n(36782),ge=n(74065),he=n(47028),pe=n(29618),fe=n(70754),Ee=n(70918),ye=n(70983),ve=n(96812),be=n(6571),xe=n(47135),we=n(19604),Se=n(29630);function Ze(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Ce=n(54566),Ie=n(21039),Ae=n(23147),Ne=n(79072),Me=n(91655),Le=n(50522),Pe=n(39960);const Re=(0,Z.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Fe=(0,Z.ZP)(Le.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,Te=(0,Z.ZP)(Re,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`,ke=(0,Z.ZP)(Fe,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,Ge={button:Te.withComponent(Le.Z),link:Te.withComponent(Pe.Z)};function De(e){let{variant:t,children:n,...a}=e;return o.createElement(Te,(0,ue.Z)({as:Ge[t]},a),o.createElement(ke,{as:"div"},n))}function Be(e){let{question:t,variant:n="card",disabled:a}=e;const{handleSelect:r}=(0,o.useContext)(S),l=(0,w.Z)((()=>{"string"==typeof t&&r(t)}));switch(n){case"recommended-card":return o.createElement(Re,null,o.createElement(Fe,{onClick:l,disabled:a},t),o.createElement($e,null,"\u2728"));case"card":return o.createElement(Fe,{onClick:l,disabled:a},t);default:return o.createElement(Oe,{disableRipple:!0,disableTouchRipple:!0,onClick:l,disabled:a},t)}}const Oe=(0,Z.ZP)(Le.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`,$e=(0,Z.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`;var Ue=n(8100);function ze(e){const t=new Array(e);for(let n=0;n<e;n++)t[n]=n;return t}function qe(e,t){const{data:n,isValidating:a,mutate:r}=(0,Ue.ZP)([e,t,"data-explorer-recommend-question"],{fetcher:async(e,t)=>await async function(e,t){return await i.po.get("/explorer/questions/recommend",{params:{aiGenerated:e,n:t}})}(e,t),shouldRetryOnError:!1,revalidateIfStale:!1,revalidateOnReconnect:!1,revalidateOnFocus:!1});return{data:n,loading:a,reload:(0,o.useMemo)((()=>()=>{r(void 0,{revalidate:!0}).catch(console.error)}),[])}}function _e(e){let{variant:t,disabled:n,questions:a,n:r}=e;const l=0===a.length?(()=>{const e=e=>o.createElement(Be,{key:e,variant:t,question:"text"===t?o.createElement(Me.Z,{width:"230px"}):o.createElement(o.Fragment,null,o.createElement(Me.Z,{width:"100%"}),o.createElement(Me.Z,{width:"61%"})),disabled:!0});return"text"===t?ze(r).map(e):ze(r).map((t=>o.createElement(Ne.ZP,{item:!0,xs:12,md:4,key:t,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t))))})():(()=>{const e=(e,a)=>o.createElement(Be,{key:a,variant:t,question:e.title,disabled:n});return"text"===t?a.map(e):a.map(((t,n)=>o.createElement(Ne.ZP,{item:!0,xs:12,md:4,key:t.hash,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t,n))))})();return"text"===t?o.createElement(b.Z,null,l):o.createElement(Ne.ZP,{container:!0,spacing:2},l)}function He(e){let{aiGenerated:t=!1,n:n,disabled:a=!1,title:r,variant:l}=e;const{data:i=[],reload:c,loading:s}=qe(t,n);return o.createElement(o.Fragment,null,(null==r?void 0:r(c,s))??null,o.createElement(_e,{n:n,questions:i,disabled:a,variant:l??(t?"recommended-card":"card")}))}function We(e){let{severity:t,sx:n,children:a,createIssueUrl:r=(()=>Ze("pingcap/ossinsight")),showSuggestions:l}=e;const i=(0,w.Z)((()=>{var e;null==(e=document.getElementById("data-explorer-faq"))||e.scrollIntoView({behavior:"smooth"})})),c=(0,w.Z)((()=>{window.open(r(),"_blank")}));return o.createElement(o.Fragment,null,o.createElement(Ve,{sx:n,variant:"outlined",severity:t},o.createElement(Se.Z,{variant:"body1"},a),o.createElement(ee.Z,{direction:"row",spacing:2,mt:2},o.createElement(Qe,{onClick:i},o.createElement(Ie.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"See faq")),o.createElement(Qe,{onClick:c},o.createElement(Ae.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"Feedback")))),l&&o.createElement(Ke,null,o.createElement(He,{title:(e,t)=>o.createElement(b.Z,{component:"p",m:0,mt:2,height:"40px"},"How about try other questions? ",o.createElement(J.Z,{onClick:e,disabled:t},o.createElement(Ce.Z,null))),n:5,variant:"text"})))}const Ve=(0,Z.ZP)(we.Z)`
  background: #18191A;
...
`;function Ye(e){void 0===e&&(e="");try{return(0,me.WU)(e,{language:"mysql"})}catch{return e}}function Xe(){const{question:e}=y(),t=(0,o.useMemo)((()=>()=>Ze("pingcap/ossinsight",{title:`Empty result from question ${(null==e?void 0:e.id)??""}`,labels:"area/data-explorer",body:`\nHi, The result of [question](https://ossinsight.io/explore/?id=${(null==e?void 0:e.id)??""}) is empty\nThe title is: **${(null==e?void 0:e.title)??""}**\n\nGenerated SQL is:\n\`\`\`mysql\n${Ye(null==e?void 0:e.querySQL)}\n\`\`\` \n      `})),[e]);return o.createElement(We,{severity:"info",createIssueUrl:t,showSuggestions:!0},"This question has no results.")}function Je(e){let{severity:t,title:n,prompt:a,sx:r,error:l,showSuggestions:i}=e;const{question:c}=y();return o.createElement(We,{severity:t,sx:r,createIssueUrl:()=>Ze("pingcap/ossinsight",{title:`${n} for question ${(null==c?void 0:c.id)??""}`,body:`\n${a} [question](https://ossinsight.io/explore?id=${(null==c?void 0:c.id)??""})\n\n## Question title\n**${(null==c?void 0:c.title)??""}**\n\n## Error message\n${l}\n${(0,d.nf)(null==c?void 0:c.querySQL)?`\n## Generated SQL\n\`\`\`mysql\n${Ye(null==c?void 0:c.querySQL)}\n\`\`\`\n`:""}\n${(0,d.nf)(null==c?void 0:c.chart)?`\n## Chart info\n\`\`\`json\n${JSON.stringify(null==c?void 0:c.chart,void 0,2)}\n\`\`\`\n`:""}\n`,labels:"area/data-explorer,type/bug"}),showSuggestions:i&&!(0,xe.X_)(l,429)},n,": ",l)}function je(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:l,errorWithChildren:i=!1,children:c,errorPrompt:s,errorTitle:u}=e;const[m,g]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":g(!1);break;case"error":g(!0)}}),[t]);const h=!0===a,p=(0,w.Z)(((e,t)=>{h||g(t)}));return o.createElement(et,{className:"pending"===t?"pending":(0,d.Rw)(l)?t:"error",elevation:1},o.createElement(tt,{expanded:!!h||m,defaultExpanded:a,elevation:0,onChange:p},o.createElement(nt,{alwaysOpen:h,expandIcon:(0,d.X0)(a)&&o.createElement(be.Z,null),disabled:"loading"===t},o.createElement(at,null,"loading"===t?o.createElement(fe.Z,{size:16}):"success"===t&&(0,d.Rw)(l)?o.createElement(ye.Z,{color:"success",fontSize:"inherit"}):o.createElement(ve.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(rt,null,n),(0,d.N6)(r)?o.createElement(o.Fragment,null,o.createElement(lt,null),o.createElement(ot,null,"auto"===r?m?"Hide":"Show":r)):void 0)),o.createElement(he.Z,null,i?(0,d.Rw)(l)?c:o.createElement(o.Fragment,null,o.createElement(Je,{title:u,prompt:s,error:(0,xe.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}),c):(0,d.Rw)(l)?c:o.createElement(Je,{title:u,prompt:s,error:(0,xe.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}))))}const et=(0,Z.ZP)(Ee.Z)`
...
`,tt=(0,Z.ZP)(ge.Z)`
  ...
  padding: 4px 8px;
`,nt=(0,Z.ZP)(pe.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
...
`,lt=(0,Z.ZP)("span")`
  flex: 1;
`;var it=n(14850),ct=n(66284);function st(e){return"number"==typeof e?e>=1970&&e<2100:st(Number(e))}function dt(e,t){return e.map((e=>{let n=e[t];return st(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function ut(e,t){return(0,d.YN)(t,(e=>!(0,d.Rw)(e)&&(e instanceof Array?e.length>0&&(0,d.YN)(e,d.GC):(0,d.GC)(e))))?e.filter((e=>(0,d.YN)(t,(e=>t=>"string"==typeof t?(0,d.nf)(e[t]):(0,d.YN)(t,(t=>(0,d.nf)(e[t]))))(e)))):[]}var mt=n(60338),gt=n(68023),ht=n(33989),pt=n(31281),ft=n(8690),Et=n(27240),yt=n(76395);(0,gt.D)([ht.N,pt.N,ft.N,Et.N,yt.N]);var vt=n(44731),bt=n(85214),xt=n(81284),wt=n(19594),St=n(95309),Zt=n(61702);function Ct(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,d.uW)(a)?a.map((e=>({name:e}))):(0,d.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(It,null,o.createElement(At,{className:"clearTable"},o.createElement("thead",null,(0,d.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const It=(0,Z.ZP)("div")`
  overflow: scroll;
`,At=(0,Z.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var Nt=n(49837),Mt=n(91359),Lt=n(45344);var Pt=n(74446),Rt=n(75559),Ft=n(40172);const Tt=(0,Z.ZP)("div")`
  height: 100%;
`;function kt(e){let{title:t}=e;const{question:n}=y(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return Ze("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(We,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const Gt={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=/date|time|year|month/.test(a);l=e?dt(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(ct.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=/date|time|year|month/.test(a);l=e?dt(l,a):l;const t=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:a,y:e}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(ct.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(mt.ZP,{height:400,option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(bt.Z,null,r.map(((e,t)=>o.createElement(xt.ZP,{key:t},o.createElement(St.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(wt.Z,null,o.createElement(vt.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(Zt.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(bt.Z,null,r.map(((e,t)=>o.createElement(xt.ZP,{key:t},o.createElement(St.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(wt.Z,null,o.createElement(vt.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(Zt.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:Ct,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if((0,d.N6)(a)){if(1===l.length&&(0,d.Rw)(l[0][a])){const e=l[0][r];return o.createElement(Nt.Z,null,o.createElement(Mt.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Se.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},n),(0,d.z0)(e)?o.createElement(Lt.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return o.createElement(o.Fragment,null,o.createElement(Se.Z,{variant:"h4"},n),o.createElement(Ne.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Ne.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(Nt.Z,{sx:{p:2}},o.createElement(Se.Z,{variant:"subtitle1"},e[a]),o.createElement(Se.Z,{variant:"body2",color:"#7c7c7c"},e[r])))))))}return o.createElement(bt.Z,null,l.map(((e,t)=>o.createElement(xt.ZP,{key:t},o.createElement(Nt.Z,{sx:{p:4}},o.createElement(Zt.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),u=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,Pt.$)(e[t]),{long:o,lat:r}=(0,Pt.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,d.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=u[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,Rt.Mm)(),dataset:[{id:"top1",source:u.slice(0,1)},{id:"rest",source:u.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=u[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,u]);return(0,o.useEffect)((()=>{if((0,d.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(Ft.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(Tt,{ref:c},o.createElement(ct.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function Dt(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=Gt[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,Ue.wE)(e)]),a=ut(e.data,n);let r,l;return(0,d.Rw)(t)&&(r=o.createElement(kt,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(Xe,null):a.length>0?(0,d.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(kt,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var Bt=n(44373),Ot=n(78385),$t=n(87054),Ut=n(85390),zt=n(45670),qt=n(55050),_t=n(91693),Ht=n(96942),Wt=n(36804),Vt=n(88784);function Kt(e){let{children:t}=e;return o.createElement(Vt.Z,{title:t},o.createElement(J.Z,null,o.createElement(Wt.Z,{fontSize:"inherit"})))}var Qt=n(1969),Yt=n(64232);function Xt(e){return o.createElement(Jt,(0,ue.Z)({target:"_blank"},e),"Share",o.createElement(jt,null))}const Jt=(0,Z.ZP)("a")`
  display: inline-flex;
  align-items: center;
  opacity: 0.8;
...
`,jt=(0,Z.ZP)(Yt.Z)`
  margin-left: 4px;
  color: #1D9BF0;
`;function en(e){var t,n;let{search:a}=e;const{question:r,error:l,phase:i}=y(),[c,s]=(0,o.useState)(null),u=(0,o.useMemo)((()=>{try{if((0,d.nf)(r))return(0,me.WU)(r.querySQL,{language:"mysql"});var e;if(function(e){return!!((0,xe.IZ)(e)&&(0,d.nf)(e.response)&&(0,d.nf)(e.response.data))&&"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL}(l))return(0,me.WU)((null==(e=l.response)?void 0:e.data.querySQL)??"",{language:"mysql"})}catch(t){return(null==r?void 0:r.querySQL)??""}}),[r,l]),m=(0,o.useMemo)((()=>{switch(i){case g.NONE:return"pending";case g.LOADING:case g.CREATING:return"loading";case g.GENERATE_SQL_FAILED:case g.LOAD_FAILED:case g.CREATE_FAILED:return"error";default:return"success"}}),[i]),h=(0,o.useMemo)((()=>{switch(i){case g.NONE:return"";case g.LOADING:return"Loading question...";case g.CREATING:return"Generating SQL...";case g.LOAD_FAILED:return"Question not found";case g.GENERATE_SQL_FAILED:case g.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[i]),p=null==r||null==(t=r.result)?void 0:t.rows,f=(0,o.useMemo)((()=>{switch(i){case g.CREATED:case g.QUEUEING:case g.EXECUTING:return"loading";case g.EXECUTE_FAILED:case g.VISUALIZE_FAILED:case g.UNKNOWN_ERROR:return"error";case g.READY:return"success";default:return"pending"}}),[i]),E=(0,o.useMemo)((()=>{var e;switch(i){case g.CREATED:return"Pending...";case g.QUEUEING:return`Waiting execution in queue (currently in position ${(null==r?void 0:r.queuePreceding)??NaN})...`;case g.EXECUTING:return"Running SQL...";case g.EXECUTE_FAILED:return"Failed to execute SQL";case g.UNKNOWN_ERROR:return"Unknown error";case g.VISUALIZE_FAILED:case g.READY:return o.createElement(o.Fragment,null,`${(null==r||null==(e=r.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==r?void 0:r.spent)??"NaN"} seconds`,function(e){if((0,d.nf)(e)&&!(0,d.yD)(e.engines))return o.createElement(o.Fragment,null,", Running on",o.createElement(nn,null,e.engines.map(tn).join(", ")),o.createElement(Kt,null,o.createElement(Se.Z,{variant:"body1"},o.createElement("b",null,"tikv"),": row storage engine",o.createElement("br",null),o.createElement("b",null,"tiflash"),": columnar storage engine"),o.createElement(Bt.Z,{orientation:"horizontal",sx:{my:1.5},light:!0}),o.createElement(Se.Z,{variant:"body2"},"Intelligent query processing in ",o.createElement("a",null,"TiDB optimizer"),".")));return null}(r));default:return"pending"}}),[r,i]),v=(0,o.useMemo)((()=>{if((0,d.Rw)(r))return(0,Qt.PE)(location.href,{title:"OSSInsight Data Explorer",hashtags:["OpenSource","OpenAI","TiDBCloud"]});let e;return e="undefined"==typeof location?(0,d.GC)(r.id)?`https://ossinsight.io/explore?id=${r.id}`:"https://ossinsight.io/explore":(0,Qt.PE)(location.href,{title:`${a} | OSSInsight Data Explorer\n`,hashtags:["OpenSource","OpenAI","TiDBCloud"]}),e}),[r,a]),b=(0,o.useMemo)((()=>{if("error"===m)return l}),[m,l]),x=(0,o.useMemo)((()=>{if("error"===f)return l}),[f,l]),w=(0,o.useMemo)((()=>{if(i===g.VISUALIZE_FAILED)return l}),[i,l]);return o.createElement(o.Fragment,null,o.createElement(je,{status:m,title:h,extra:"auto",error:b,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for"},(0,d.N6)(u)&&o.createElement(it.Z,{language:"sql"},u)),o.createElement(je,{status:f,title:E,extra:o.createElement(rn,null,o.createElement("span",{ref:s}),o.createElement(Xt,{href:v})),error:x,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},o.createElement(an,{chartData:(null==r?void 0:r.chart)??void 0,chartError:w,result:p,fields:null==r||null==(n=r.result)?void 0:n.fields,controlsContainer:c})))}function tn(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const nn=(0,Z.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function an(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization");(0,o.useEffect)((()=>{c("visualization")}),[t]);const s=(e,t)=>{(0,d.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,xe.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(Je,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,d.Rw)(r))return(0,d.nf)(n)?c(!1,!0):null;const u=()=>o.createElement(Se.Z,{variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Confused with this answer? Try to tiny your words and help the AI identify your question, for example, you can try to use \u2018@repo_name/user_name\u2019 to narrow down your query. If you have more questions about the accuracy of the answers, see FAQ here."),m=()=>o.createElement(o.Fragment,null,o.createElement(Ct,{chartName:"Table",title:"",data:r,fields:a}),u());if((0,d.Rw)(t))return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):null;const g=()=>o.createElement(o.Fragment,null,o.createElement(Dt,(0,ue.Z)({},t,{data:r,fields:a})),u());return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):"Table"===t.chartName?g():o.createElement(o.Fragment,null,o.createElement(Ot.Z,{container:l},o.createElement(on,{className:"chart-controls"},o.createElement(Ut.Z,{size:"small",value:i,onChange:s,exclusive:!0,color:"primary"},o.createElement($t.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(_t.Z,{fontSize:"small"})),o.createElement($t.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(Ht.Z,{fontSize:"small"}))))),o.createElement(zt.ZP,{value:i},o.createElement(ln,{value:"visualization"},g()),o.createElement(ln,{value:"raw"},m())))}),[i,t,n,r,a])}const on=(0,Z.ZP)("div")`
  display: inline-flex;
...
`,ln=(0,Z.ZP)(qt.Z)`
  padding: 0;
`;function cn(e){let{title:t="\ud83d\udd25 Popular queries"}=e;return o.createElement(o.Fragment,null,o.createElement(He,{title:()=>o.createElement(b.Z,{height:"40px"},t),n:6}),o.createElement(De,{variant:"link",sx:{mt:3},to:"/blog/chat2query-tutorials",target:"_blank"},"\ud83e\uddd0 Not an expert? Uncover insights with your OWN dataset!"))}var sn=n(41796),dn=n(44044),un=n(60641),mn=n(64421),gn=n(98948),hn=n(61225);function pn(e){let{startColor:t="#794BC5",stopColor:n="#3D44FF",steps:a,sx:r}=e;const l=(0,hn.Z)((e=>e.breakpoints.down("md"))),i=(0,o.useMemo)((()=>{const e=(0,sn.tB)("#794BC5").values,t=(0,sn.tB)("#3D44FF").values;return ze(a.length+1).map((n=>function(e,t,n){let[a,o,r]=e,[l,i,c]=t;const s=1-n;return(0,sn.wy)({type:"rgb",values:[a*s+l*n,o*s+i*n,r*s+c*n]})}(e,t,n/a.length)))}),[t,n,a.length]);return o.createElement(o.Fragment,null,o.createElement("svg",{width:"0",height:"0"},o.createElement("defs",null,a.map(((e,t)=>o.createElement("linearGradient",{id:`explore-step-gradient-${t}`,key:t,x1:"0%",y1:"0%",x2:"100%",y2:"0%"},o.createElement("stop",{offset:"0%",style:{stopColor:i[t],stopOpacity:1}}),o.createElement("stop",{offset:"100%",style:{stopColor:i[t+1],stopOpacity:1}})))))),o.createElement(gn.Z,{sx:r,orientation:l?"vertical":"horizontal"},a.map(((e,t)=>o.createElement(dn.Z,{key:e,completed:!1,active:!0},o.createElement(fn,{fill:`explore-step-gradient-${t}`},e))))))}const fn=(0,Z.ZP)(mn.Z,{shouldForwardProp:e=>"fill"!==e})`
  .${un.Z.root}.${un.Z.active} {
    fill: url(#${e=>{let{fill:t}=e;return t}}); // ${e=>{let{color:t}=e;return t}};
  }
`;function En(){return o.createElement(b.Z,{component:"section",id:"data-explorer-faq",pt:8},o.createElement(Se.Z,{variant:"h2",textAlign:"center"},"FAQ"),yn.map(((e,t)=>{let{q:n,a:a}=e;return o.createElement(vn,{key:t},o.createElement(bn,null,n),o.createElement(xn,null,a))})),o.createElement(Se.Z,{variant:"body1",textAlign:"center",color:"#929292",fontSize:16,mt:8},"Still have problems? please feel free to contact us ",Cn," ",In))}const yn=[{q:"How it works?",a:o.createElement(pn,{steps:["Input your question","Translate your question to SQL with OpenAI","Visualize and output your results"]})},{q:"How do I use this tool?",a:"You can start with selecting a popular query from the query wall or directly input a short text query statement to the search box. OpenAI will translate your question into Structured Query Language (SQL), and we will use the generated SQL to query in the database and return the results."},{q:"Why the answer do not turn out to my intended?",a:"We use the text completion provided by OpenAI to translate the text into Structured Query Language (SQL), and the final output depends on the accuracy of the generated SQL. If the final query result does not meet your expectation, please shorten your input statement and using more concise and clear short words for AI recognition."},{q:"Why is the output report an error or show 0 results?",a:o.createElement(o.Fragment,null,"Unfortunately, we do not have useful GitHub insights for you. Usually, there are two situations that cause the answer not to be found:",o.createElement("ol",null,o.createElement("li",null,"AI unrecognized/misunderstand your text and generated wrong/bad SQLs, the query mission failed."),o.createElement("li",null,"Data restrictions. All the data we use here on this website sources from\xa0",o.createElement("a",{href:"http://www.gharchive.org/",target:"_blank",rel:"noreferrer"},"GH Archive"),", a non-profit project that records and archives all GitHub events data since 2011. We can not offer you more insights if you are looking for answers about other topics.")),o.createElement("br",null),"The potential solution is phrase your question which is related GitHub with short, specific words , then try again. And we strongly recommend you use our query templates near the search box to start your exploring.")}],vn=(0,Z.ZP)("div")`
  &:not(:first-of-type) {
    margin-top: 48px;
  }
`,bn=(0,Z.ZP)("h3")`
...
`,Cn=o.createElement(Sn,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Ae.Z,null)),In=o.createElement(Zn,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(Yt.Z,{fontSize:"inherit"}));var An=n(27952),Nn=n(5299);function Mn(){return o.createElement(Pn,null,o.createElement(He,{variant:"text",n:4,title:(e,t)=>o.createElement(Se.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(Ln,null),"Get inspired",o.createElement(J.Z,{onClick:e,disabled:t},o.createElement(Ce.Z,{fontSize:"inherit"})))}),o.createElement(Bt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(b.Z,null,o.createElement(Fn,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(Nn.Z,{color:"inherit"})),o.createElement(Tn,null,"Get hands-on with your data Get hands-on with your data")))}function Ln(){return o.createElement(o.Fragment,null,ze(3).map((e=>o.createElement(Rn,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const Pn=(0,Z.ZP)("div")`
  position: sticky;
  top: 92px;
`,Rn=(0,Z.ZP)(An.Z)`
  vertical-align: text-bottom;
