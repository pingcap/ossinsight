...
`,L=(0,w.ZP)(A)`
  ...
  overflow: hidden;
`;var M=n(98885),P=n(8410);const T=400;function k(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),d=(0,o.useRef)(null),m=(0,P.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??0),[null==m?void 0:m.height]);return o.createElement(R,{maxWidth:"xl"},o.createElement(M.ZP,{nodeRef:s,in:c,timeout:T},(e=>o.createElement(o.Fragment,null,o.createElement(F,{ref:s,className:`Header-${e}`,height:g},n),o.createElement(G,{className:`Body-header-${e}`,headerHeight:g},o.createElement(M.ZP,{nodeRef:u,in:i,timeout:T},(e=>o.createElement(D,{ref:u,className:`Main-side-${e}`},t))),o.createElement(M.ZP,{nodeRef:d,in:i,timeout:T,unmountOnExit:!0},(e=>o.createElement($,{ref:d,className:`Side-${e}`},a))))))),o.createElement(B,null,l&&r))}const R=(0,w.ZP)(x.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,F=(0,w.ZP)("div",{name:"Layout-Header",shouldForwardProp:e=>"height"!==e})`
  opacity: 0.1;
...
`,B=(0,w.ZP)("div",{name:"Layout-Footer"})`
  position: relative;
  display: flex;
  align-self: stretch;
  flex: 1;
...
`,j=(0,w.ZP)("p")`
  color: #7C7C7C;
  margin: 0;
`;var ee=n(80562),te=n(75345),ne=n(9144),ae=n(95537),oe=n(63871),re=n(89022);function le(e){let{value:t,onChange:n,onAction:a,onClear:r,disableInput:l=!1,disableAction:i=!1,disableClear:c=!1,clearState:s}=e;const u=(0,o.useRef)(null),{isLoading:d,isAuthenticated:g}=(0,m.D3)(),p=(0,S.Z)((e=>{n(e.target.value)})),h=(0,S.Z)((e=>{"Enter"===e.key&&(i||null==a||a())}));return o.createElement(o.Fragment,null,o.createElement(ie,{fullWidth:!0,disabled:d&&!g||l,ref:u,value:t,onChange:p,onKeyDown:h,placeholder:"Type any question here, or choose one below",endAdornment:o.createElement(ne.Z,{direction:"row",gap:1},!i&&o.createElement(ce,{color:"inherit",onClick:a,disabled:i},o.createElement(oe.Z,null)),o.createElement(ce,{color:"stop"===s?"error":"inherit",onClick:r,disabled:c},"stop"===s?o.createElement(re.Z,null):o.createElement(ae.Z,null)))}))}const ie=(0,w.ZP)(te.ZP)`
...
`;function se(e){const{marginTop:t,marginBottom:n}=getComputedStyle(e);return e.offsetHeight+parseFloat(t)+parseFloat(n)}function ue(e){let{state:t,transitionDelay:n=0,transitionDuration:a=400,offset:r=120,direction:l="up",revert:i=!1,children:c}=e;const s=(0,o.useRef)(null),d=(0,o.useRef)(null),[m,g]=(0,o.useState)();(0,o.useEffect)((()=>{if(2!==c.length)throw new Error("SwitchLayout should have exactly two children");if((0,u.Rw)(c[0].key)||(0,u.Rw)(c[1].key))throw new Error("SwitchLayout's children must have keys")}),[]);const p=(0,S.Z)((()=>{(0,u.nf)(s.current)&&g(se(s.current))})),h=(0,S.Z)((()=>{(0,u.nf)(d.current)&&g(se(d.current))})),f=(0,S.Z)((()=>{g(void 0)})),E=(0,S.Z)((()=>{(0,u.nf)(d.current)&&g(se(d.current))})),y=(0,S.Z)((()=>{(0,u.nf)(s.current)&&g(se(s.current))})),b=(0,S.Z)((()=>{g(void 0)})),v=n+a;return o.createElement(de,{offset:r,style:{height:m},duration:a,delay:n},o.createElement(M.ZP,{key:c[0].key,in:t===c[0].key,timeout:v,unmountOnExit:!0,onExit:p,onExiting:h,onExited:f},(e=>o.createElement(me,{ref:s,className:`SwitchItem-${l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[0]))),o.createElement(M.ZP,{key:c[1].key,in:t===c[1].key,timeout:v,unmountOnExit:!0,onExit:E,onExiting:y,onExited:b},(e=>o.createElement(me,{ref:d,className:`SwitchItem-${i?"up"===l?"down":"up":l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[1]))))}const de=(0,w.ZP)("div",{name:"SwitchLayoutContainer",shouldForwardProp:e=>!["duration","delay","offset"].includes(String(e))})`
  position: relative;
...
`;function ge(e){let{align:t="left",sx:n}=e;return o.createElement(pe,{align:t,sx:n},"Powered by ",o.createElement("a",{href:"https://www.pingcap.com/tidb-cloud/",target:"_blank",rel:"noreferrer"},"TiDB Cloud"))}const pe=(0,w.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`;var he=n(14850),fe=n(74065),Ee=n(47028),ye=n(21945),be=n(70795),ve=n(70918),xe=n(70983),we=n(96812),Se=n(6571),Ze=n(47135),Ce=n(19604),Ie=n(29630);function Ae(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Ne=n(54566),Le=n(21039),Me=n(23147),Pe=n(79072),Te=n(91655),ke=n(50522),Re=n(39960);const Ge=(0,w.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Fe=(0,w.ZP)(ke.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,De=(0,w.ZP)(Ge,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`;(0,w.ZP)(Fe,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,De.withComponent(ke.Z),De.withComponent(Re.Z);function $e(e){let{question:t,variant:n="card",disabled:a}=e;const{handleSelect:r}=(0,o.useContext)(Z),l=(0,S.Z)((()=>{"string"==typeof t&&r(t)}));switch(n){case"recommended-card":return o.createElement(Ge,null,o.createElement(Fe,{onClick:l,disabled:a},t),o.createElement(Oe,null,"\u2728"));case"card":return o.createElement(Fe,{onClick:l,disabled:a},t);default:return o.createElement(Be,{disableRipple:!0,disableTouchRipple:!0,onClick:l,disabled:a},t)}}const Be=(0,w.ZP)(ke.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`,Oe=(0,w.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`;var ze=n(8100);function Ue(e){const t=new Array(e);for(let n=0;n<e;n++)t[n]=n;return t}function qe(e,t){if(0!==e.length&&(1!==e.length||!(0,u.nf)(t)||0!==t))for(;;){const n=Math.floor((Math.random()-1e-5)*e.length);if(n!==t)return e[n]}}function _e(e,t){const{data:n,isValidating:a,mutate:r}=(0,ze.ZP)([e,t,"data-explorer-recommend-question"],{fetcher:async(e,t)=>await async function(e,t){return await i.po.get("/explorer/questions/recommend",{params:{aiGenerated:e,n:t}})}(e,t),shouldRetryOnError:!1,revalidateIfStale:!1,revalidateOnReconnect:!1,revalidateOnFocus:!1});return{data:n,loading:a,reload:(0,o.useMemo)((()=>()=>{r(void 0,{revalidate:!0}).catch(console.error)}),[])}}function He(e){let{variant:t,disabled:n,questions:a,n:r}=e;const l=0===a.length?(()=>{const e=e=>o.createElement($e,{key:e,variant:t,question:"text"===t?o.createElement(Te.Z,{width:"230px"}):o.createElement(o.Fragment,null,o.createElement(Te.Z,{width:"100%"}),o.createElement(Te.Z,{width:"61%"})),disabled:!0});return"text"===t?Ue(r).map(e):Ue(r).map((t=>o.createElement(Pe.ZP,{item:!0,xs:12,md:4,key:t,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t))))})():(()=>{const e=(e,a)=>o.createElement($e,{key:a,variant:t,question:e.title,disabled:n});return"text"===t?a.map(e):a.map(((t,n)=>o.createElement(Pe.ZP,{item:!0,xs:12,md:4,key:t.hash,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t,n))))})();return"text"===t?o.createElement(v.Z,null,l):o.createElement(Pe.ZP,{container:!0,spacing:2},l)}function We(e){let{aiGenerated:t=!1,n:n,disabled:a=!1,title:r,variant:l}=e;const{data:i=[],reload:c,loading:s}=_e(t,n);return o.createElement(o.Fragment,null,(null==r?void 0:r(c,s))??null,o.createElement(He,{n:n,questions:i,disabled:a,variant:l??(t?"recommended-card":"card")}))}function Qe(e){let{severity:t,sx:n,children:a,createIssueUrl:r=(()=>Ae("pingcap/ossinsight")),showSuggestions:l}=e;const i=(0,S.Z)((()=>{var e;null==(e=document.getElementById("data-explorer-faq"))||e.scrollIntoView({behavior:"smooth"})})),c=(0,S.Z)((()=>{window.open(r(),"_blank")}));return o.createElement(o.Fragment,null,o.createElement(Ve,{sx:n,variant:"outlined",severity:t},o.createElement(Ie.Z,{variant:"body1"},a),o.createElement(ne.Z,{direction:"row",spacing:2,mt:2},o.createElement(Ye,{onClick:i},o.createElement(Le.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"See faq")),o.createElement(Ye,{onClick:c},o.createElement(Me.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"Feedback")))),l&&o.createElement(Ke,null,o.createElement(We,{title:(e,t)=>o.createElement(v.Z,{component:"p",m:0,mt:2,height:"40px"},"How about try other questions? ",o.createElement(ee.Z,{onClick:e,disabled:t},o.createElement(Ne.Z,null))),n:5,variant:"text"})))}const Ve=(0,w.ZP)(Ce.Z)`
  background: #18191A;
...
`;var Xe=n(36782);function Je(e){void 0===e&&(e="");try{return(0,Xe.WU)(e,{language:"mysql"})}catch{return e}}function je(){const{question:e}=y(),t=(0,o.useMemo)((()=>()=>Ae("pingcap/ossinsight",{title:`Empty result from question ${(null==e?void 0:e.id)??""}`,labels:"area/data-explorer",body:`\nHi, The result of [question](https://ossinsight.io/explore/?id=${(null==e?void 0:e.id)??""}) is empty\nThe title is: **${(null==e?void 0:e.title)??""}**\n\nGenerated SQL is:\n\`\`\`mysql\n${Je(null==e?void 0:e.querySQL)}\n\`\`\` \n      `})),[e]);return o.createElement(Qe,{severity:"info",createIssueUrl:t,showSuggestions:!0},"This question has no results.")}function et(e){let{severity:t,title:n,prompt:a,sx:r,error:l,showSuggestions:i}=e;const{question:c}=y();return o.createElement(Qe,{severity:t,sx:r,createIssueUrl:()=>Ae("pingcap/ossinsight",{title:`${n} for question ${(null==c?void 0:c.id)??""}`,body:`\n${a} [question](https://ossinsight.io/explore?id=${(null==c?void 0:c.id)??""})\n\n## Question title\n**${(null==c?void 0:c.title)??""}**\n\n## Error message\n${l}\n${(0,u.nf)(null==c?void 0:c.querySQL)?`\n## Generated SQL\n\`\`\`mysql\n${Je(null==c?void 0:c.querySQL)}\n\`\`\`\n`:""}\n${(0,u.nf)(null==c?void 0:c.chart)?`\n## Chart info\n\`\`\`json\n${JSON.stringify(null==c?void 0:c.chart,void 0,2)}\n\`\`\`\n`:""}\n`,labels:"area/data-explorer,type/bug"}),showSuggestions:i&&!(0,Ze.X_)(l,429)},n,": ",l)}var tt=n(70917);function nt(){return o.createElement(ot,{size:16})}const at=tt.F4`
  0% {
...
`;const rt=(0,n(1588).Z)("RippleDot",["root","info","success","error","warning","active"]);var lt=n(86010);function it(e){let{active:t=!0,color:n="info",size:a=8}=e;return o.createElement(st,{size:a,className:(0,lt.Z)({[rt.root]:!0,[rt.active]:t,[rt[n]]:!0})})}const ct=tt.F4`
  0% {
    opacity: 1;
    transform: initial;
  }
...
`,st=(0,w.ZP)("span",{name:"RippleDot",shouldForwardProp:e=>"size"!==e})`
  display: inline-block;
  position: relative;
...
`;function ut(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:l,errorWithChildren:i=!1,children:c,errorPrompt:s,errorTitle:d,icon:m="default"}=e;const[g,p]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":p(!1);break;case"error":p(!0)}}),[t]);const h=(0,S.Z)(((e,t)=>{f||p(t)})),f=!0===a,E=(0,u.N6)(r)&&"success"===t;return o.createElement(dt,{className:"pending"===t?"pending":(0,u.Rw)(l)?t:"error",elevation:1},o.createElement(mt,{expanded:!!f||g,defaultExpanded:a,elevation:0,onChange:h},o.createElement(gt,{alwaysOpen:f,expandIcon:(0,u.X0)(a)&&"success"===t&&o.createElement(Se.Z,null),disabled:"loading"===t},o.createElement(pt,null,"loading"===t?"bot"===m?o.createElement(nt,null):o.createElement(it,{size:12}):"success"===t&&(0,u.Rw)(l)?o.createElement(xe.Z,{color:"success",fontSize:"inherit"}):o.createElement(we.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(ft,null,n),E&&o.createElement(o.Fragment,null,o.createElement(Et,null),o.createElement(ht,null,"auto"===r?g?"Hide":"Show":r)))),o.createElement(Ee.Z,null,i?(0,u.Rw)(l)?c:o.createElement(o.Fragment,null,o.createElement(et,{title:d,prompt:s,error:(0,Ze.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}),c):(0,u.Rw)(l)?c:o.createElement(et,{title:d,prompt:s,error:(0,Ze.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}))))}const dt=(0,w.ZP)(ve.Z)`
...
`,mt=(0,w.ZP)(fe.Z)`
  ...
  padding: 4px 8px;
`,gt=(0,w.ZP)(ye.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
  &.${be.Z.content} {
    margin-top: 4px;
    margin-bottom: 4px;
  }
...
`,Et=(0,w.ZP)("span")`
  flex: 1;
`;var yt=n(18629);function bt(){const{question:e,error:t,phase:n}=y(),a=(0,o.useMemo)((()=>{try{if((0,u.nf)(e))return(0,Xe.WU)(e.querySQL,{language:"mysql"});var n;if(function(e){if((0,Ze.IZ)(e)&&(0,u.nf)(e.response)&&(0,u.nf)(e.response.data))return"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL;return!1}(t))return(0,Xe.WU)((null==(n=t.response)?void 0:n.data.querySQL)??"",{language:"mysql"})}catch(a){return(null==e?void 0:e.querySQL)??""}}),[e,t]),r=(0,o.useMemo)((()=>{switch(n){case g.NONE:return"pending";case g.LOADING:case g.CREATING:case g.GENERATING_SQL:return"loading";case g.GENERATE_SQL_FAILED:case g.LOAD_FAILED:case g.CREATE_FAILED:return"error";default:return"success"}}),[n]),l=(0,o.useMemo)((()=>{switch(n){case g.NONE:return"";case g.LOADING:return"Loading question...";case g.CREATING:return"Creating question...";case g.GENERATING_SQL:return o.createElement(xt,null);case g.LOAD_FAILED:return"Question not found";case g.GENERATE_SQL_FAILED:case g.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[n]),i=(0,o.useMemo)((()=>{if("error"===r)return t}),[r,t]),c=n===g.CREATED||n===g.GENERATING_SQL;return o.createElement(ut,{status:r,title:l,icon:c?"bot":"default",extra:"auto",error:i,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for"},(0,u.N6)(a)&&o.createElement(he.Z,{language:"sql"},a))}const vt=[["Great question!","Interesting question!","Awesome question!","You asked a winner!"],["Thinking...","Brain busting!","Creating SQL..."],["Tough, but still trying...","Hard, but persevering.","Tough, but forging ahead...","Challenging, but still striving...","Struggling, but pushing on..."],["Mastering the art of turning words into SQL magic\u2026","Gaining knowledge from your input...","Learning from your question...","Getting smarter with your input..."],["Making every effort!","Working my hardest","Trying my best...","Striving for greatness...","Trying my best..."],["Almost there\u2026","Almost done...","Just a second!"]];function xt(){const e=(0,o.useRef)({group:0}),[t,n]=(0,o.useState)((()=>qe(vt[0])));return(0,yt.Z)((()=>{let{group:t}=e.current;t<5?t+=1:t=4,n(qe(vt[t])),e.current.group=t}),3e3),(0,u.nf)(t)?o.createElement(wt,{prompt:t}):o.createElement(o.Fragment,null,"Generating SQL...")}function wt(e){let{prompt:t,avgInterval:n=80,maxDiff:a=50}=e;const[r,l,i]=function(e){const[t,n]=(0,o.useState)(e),a=(0,o.useRef)(t);return(0,o.useEffect)((()=>{a.current=t}),[t]),[t,n,a]}(0);return(0,o.useEffect)((()=>{let e;return l(0),function o(){e=setTimeout((()=>{i.current>=t.length?clearTimeout(e):(l((e=>e+1)),o())}),n+(.5-Math.random())*a)}(),()=>{clearTimeout(e)}}),[t]),o.createElement(o.Fragment,null,t.slice(0,r),t.length!==r)}var St=n(87462),Zt=n(64232);function Ct(e){return o.createElement(It,(0,St.Z)({target:"_blank"},e),"Share",o.createElement(At,null))}const It=(0,w.ZP)("a")`
  display: inline-flex;
  align-items: center;
  opacity: 0.8;
...
`,At=(0,w.ZP)(Zt.Z)`
  margin-left: 4px;
  color: #1D9BF0;
`;var Nt=n(1969),Lt=n(36804),Mt=n(88784);function Pt(e){let{children:t}=e;return o.createElement(Mt.Z,{title:t},o.createElement(ee.Z,null,o.createElement(Lt.Z,{fontSize:"inherit"})))}var Tt=n(44373),kt=n(78385),Rt=n(87054),Gt=n(85390);function Ft(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,u.uW)(a)?a.map((e=>({name:e}))):(0,u.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(Dt,null,o.createElement($t,{className:"clearTable"},o.createElement("thead",null,(0,u.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const Dt=(0,w.ZP)("div")`
  overflow: scroll;
`,$t=(0,w.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var Bt=n(66284);function Ot(e){return/date|time|year|month/.test(e)}function zt(e){return"number"==typeof e?e>=1970&&e<2100:zt(Number(e))}function Ut(e,t){return e.map((e=>{let n=e[t];return zt(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function qt(e,t){return(0,u.YN)(t,(e=>!(0,u.Rw)(e)&&(e instanceof Array?e.length>0&&(0,u.YN)(e,u.GC):(0,u.GC)(e))))?e.filter((e=>(0,u.YN)(t,(e=>t=>"string"==typeof t?(0,u.nf)(e[t]):(0,u.YN)(t,(t=>(0,u.nf)(e[t]))))(e)))):[]}var _t=n(60338),Ht=n(68023),Wt=n(33989),Qt=n(31281),Vt=n(8690),Kt=n(27240),Yt=n(76395);(0,Ht.D)([Wt.N,Qt.N,Vt.N,Kt.N,Yt.N]);var Xt=n(44731),Jt=n(85214),jt=n(81284),en=n(19594),tn=n(95309),nn=n(61702);var an=n(49837),on=n(91359),rn=n(45344);var ln=n(74446),cn=n(75559),sn=n(40172);const un=(0,w.ZP)("div")`
  height: 100%;
`;function dn(e){let{title:t}=e;const{question:n}=y(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return Ae("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(Qe,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const mn={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=Ot(a);l=e?Ut(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(Bt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const{options:i,height:c}=(0,o.useMemo)((()=>{const e=Ot(a);l=e?Ut(l,a):l;const t=!e,o=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:t?e:a,y:t?a:e}}:e.map(o)};return{options:{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:o(r),title:{text:n},[t?"yAxis":"xAxis"]:{type:e?"time":"category"},[t?"xAxis":"yAxis"]:{type:"value"},animationDuration:2e3},height:t?40*l.length:400}}),[t,n,a,r,l]);return o.createElement(Bt.Z,{theme:"dark",style:{height:c},opts:{height:c},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(_t.ZP,{height:400,option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(Jt.Z,null,r.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(tn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(en.Z,null,o.createElement(Xt.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(nn.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(Jt.Z,null,r.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(tn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(en.Z,null,o.createElement(Xt.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(nn.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:Ft,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if((0,u.N6)(a)){if(1===l.length&&(0,u.Rw)(l[0][a])){const e=l[0][r];return o.createElement(an.Z,null,o.createElement(on.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Ie.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},n),(0,u.z0)(e)?o.createElement(rn.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return o.createElement(o.Fragment,null,o.createElement(Ie.Z,{variant:"h4"},n),o.createElement(Pe.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Pe.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(an.Z,{sx:{p:2}},o.createElement(Ie.Z,{variant:"subtitle1"},e[a]),o.createElement(Ie.Z,{variant:"body2",color:"#7c7c7c"},e[r])))))))}return o.createElement(Jt.Z,null,l.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(an.Z,{sx:{p:4}},o.createElement(nn.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),d=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,ln.$)(e[t]),{long:o,lat:r}=(0,ln.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,u.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=d[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,cn.Mm)(),dataset:[{id:"top1",source:d.slice(0,1)},{id:"rest",source:d.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=d[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,d]);return(0,o.useEffect)((()=>{if((0,u.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(sn.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(un,{ref:c},o.createElement(Bt.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function gn(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=mn[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,ze.wE)(e)]),a=qt(e.data,n);let r,l;return(0,u.Rw)(t)&&(r=o.createElement(dn,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(je,null):a.length>0?(0,u.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(dn,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var pn=n(91693),hn=n(96942),fn=n(45670),En=n(55050),yn=n(89747),bn=n(76743);function vn(){var e,t;const{question:n,error:a,phase:r}=y(),{search:l}=(0,o.useContext)(Z),[i,c]=(0,o.useState)(null),s=null==n||null==(e=n.result)?void 0:e.rows,d=(0,o.useMemo)((()=>{switch(r){case g.CREATED:case g.QUEUEING:case g.EXECUTING:return"loading";case g.EXECUTE_FAILED:case g.VISUALIZE_FAILED:case g.UNKNOWN_ERROR:return"error";case g.READY:return"success";default:return"pending"}}),[r]),m=(0,o.useMemo)((()=>{var e;switch(r){case g.CREATED:return"Pending...";case g.QUEUEING:return`${(null==n?void 0:n.queuePreceding)??NaN} requests ahead`;case g.EXECUTING:return"Running SQL...";case g.EXECUTE_FAILED:return"Failed to execute SQL";case g.UNKNOWN_ERROR:return"Unknown error";case g.VISUALIZE_FAILED:case g.READY:return o.createElement(o.Fragment,null,`${(null==n||null==(e=n.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==n?void 0:n.spent)??"NaN"} seconds`,function(e){if((0,u.nf)(e)&&!(0,u.yD)(e.engines))return o.createElement(o.Fragment,null,", Running on",o.createElement(wn,null,e.engines.map(xn).join(", ")),o.createElement(Pt,null,o.createElement(Ie.Z,{variant:"body1"},o.createElement("b",null,"tikv"),": row storage engine",o.createElement("br",null),o.createElement("b",null,"tiflash"),": columnar storage engine"),o.createElement(Tt.Z,{orientation:"horizontal",sx:{my:1.5},light:!0}),o.createElement(Ie.Z,{variant:"body2"},"Intelligent query processing in ",o.createElement("a",null,"TiDB optimizer"),".")));return null}(n));default:return"pending"}}),[n,r]),p=(0,o.useMemo)((()=>{if((0,u.Rw)(n))return(0,Nt.PE)(location.href,{title:"OSSInsight Data Explorer",hashtags:["OpenSource","OpenAI","TiDBCloud"]});let e;return e="undefined"==typeof location?(0,u.GC)(n.id)?`https://ossinsight.io/explore?id=${n.id}`:"https://ossinsight.io/explore":(0,Nt.PE)(location.href,{title:`${l} | OSSInsight Data Explorer\n`,hashtags:["OpenSource","OpenAI","TiDBCloud"]}),e}),[n,l]),h=(0,o.useMemo)((()=>{if("error"===d)return a}),[d,a]),f=(0,o.useMemo)((()=>{if(r===g.VISUALIZE_FAILED)return a}),[r,a]);return o.createElement(ut,{status:d,title:m,extra:o.createElement(Pn,null,o.createElement("span",{ref:c}),o.createElement(Ct,{href:p})),error:h,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},r===g.QUEUEING&&o.createElement(An,{source:0===(null==n?void 0:n.queuePreceding)?Cn:Zn,interval:3e3}),r===g.EXECUTING&&o.createElement(An,{source:In,interval:2e3}),o.createElement(Sn,{chartData:(null==n?void 0:n.chart)??void 0,chartError:f,result:s,fields:null==n||null==(t=n.result)?void 0:t.fields,controlsContainer:i}))}function xn(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const wn=(0,w.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function Sn(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization");(0,o.useEffect)((()=>{c("visualization")}),[t]);const s=(e,t)=>{(0,u.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,Ze.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(et,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,u.Rw)(r))return(0,u.nf)(n)?c(!1,!0):null;const d=()=>o.createElement(Ie.Z,{variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Confused with this answer? Try to tiny your words and help the AI identify your question, for example, you can try to use \u2018@repo_name/user_name\u2019 to narrow down your query. If you have more questions about the accuracy of the answers, see FAQ here."),m=()=>o.createElement(o.Fragment,null,o.createElement(Ft,{chartName:"Table",title:"",data:r,fields:a}),d());if((0,u.Rw)(t))return(0,u.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):null;const g=()=>o.createElement(o.Fragment,null,o.createElement(gn,(0,St.Z)({},t,{data:r,fields:a})),d());return(0,u.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):"Table"===t.chartName?g():o.createElement(o.Fragment,null,o.createElement(kt.Z,{container:l},o.createElement(Mn,{className:"chart-controls"},o.createElement(Gt.Z,{size:"small",value:i,onChange:s,exclusive:!0,color:"primary"},o.createElement(Rt.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(pn.Z,{fontSize:"small"})),o.createElement(Rt.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(hn.Z,{fontSize:"small"}))))),o.createElement(fn.ZP,{value:i},o.createElement(Tn,{value:"visualization"},g()),o.createElement(Tn,{value:"raw"},m())))}),[i,t,n,r,a])}const Zn=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? 17.","GitHub accumulates over 4 million new events each day. We synchronize these data in real time.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],Cn=["Almost there! Can't wait to see your result!"],In=["GitHub has an incredible 5+ billion rows of event data waiting for you to explore.","Perhaps AI generates a complex SQL.","Are you curious about the complex SQL generated by AI?"],An=e=>{let{source:t,interval:n}=e;const[a,r]=(0,o.useState)(0);return(0,yt.Z)((()=>{r((e=>(e+1)%t.length))}),n),o.createElement(yn.Z,{component:Nn},o.createElement(bn.Z,{key:a,timeout:400,classNames:"item"},o.createElement(Ln,null,t[a])))},Nn=(0,w.ZP)("span")`
  position: relative;
  display: block;
  min-height: 42px;
  min-width: 1px;
...
`,Tn=(0,w.ZP)(En.Z)`
  padding: 0;
`;function kn(e){let{search:t}=e;const{phase:n}=y();return o.createElement(o.Fragment,null,o.createElement(bt,null),o.createElement(vn,null),n===g.READY&&o.createElement(ge,{sx:{mt:2}}))}function Rn(e){let{title:t="\ud83d\udd25 Popular queries"}=e;return o.createElement(o.Fragment,null,o.createElement(We,{title:()=>o.createElement(v.Z,{height:"40px"},t),n:6}))}var Gn=n(41796),Fn=n(44044),Dn=n(60641),$n=n(64421),Bn=n(98948),On=n(61225);function zn(e){let{startColor:t="#794BC5",stopColor:n="#3D44FF",steps:a,sx:r}=e;const l=(0,On.Z)((e=>e.breakpoints.down("md"))),i=(0,o.useMemo)((()=>{const e=(0,Gn.tB)(t).values,o=(0,Gn.tB)(n).values;return Ue(a.length+1).map((t=>function(e,t,n){let[a,o,r]=e,[l,i,c]=t;const s=1-n;return(0,Gn.wy)({type:"rgb",values:[a*s+l*n,o*s+i*n,r*s+c*n]})}(e,o,t/a.length)))}),[t,n,a.length]);return o.createElement(o.Fragment,null,o.createElement("svg",{width:"0",height:"0"},o.createElement("defs",null,a.map(((e,t)=>o.createElement("linearGradient",{id:`explore-step-gradient-${t}`,key:t,x1:"0%",y1:"0%",x2:"100%",y2:"0%"},o.createElement("stop",{offset:"0%",style:{stopColor:i[t],stopOpacity:1}}),o.createElement("stop",{offset:"100%",style:{stopColor:i[t+1],stopOpacity:1}})))))),o.createElement(Bn.Z,{sx:r,orientation:l?"vertical":"horizontal"},a.map(((e,t)=>o.createElement(Fn.Z,{key:e,completed:!1,active:!0},o.createElement(Un,{fill:`explore-step-gradient-${t}`},e))))))}const Un=(0,w.ZP)($n.Z,{shouldForwardProp:e=>"fill"!==e})`
  .${Dn.Z.root}.${Dn.Z.active} {
    fill: url(#${e=>{let{fill:t}=e;return t}}); // ${e=>{let{color:t}=e;return t}};
  }
`;function qn(){return o.createElement(v.Z,{component:"section",id:"data-explorer-faq",pt:8},o.createElement(Ie.Z,{variant:"h2",textAlign:"center"},"FAQ"),_n.map(((e,t)=>{let{q:n,a:a}=e;return o.createElement(Hn,{key:t},o.createElement(Wn,null,n),o.createElement(Qn,null,a))})),o.createElement(Ie.Z,{variant:"body1",textAlign:"center",color:"#929292",fontSize:16,mt:8},"Still have problems? please feel free to contact us ",Xn," ",Jn))}const _n=[{q:"How it works?",a:o.createElement(zn,{steps:["Input your question","Translate your question to SQL with OpenAI","Visualize and output your results"]})},{q:"How do I use this tool?",a:"You can start with selecting a popular query from the query wall or directly input a short text query statement to the search box. OpenAI will translate your question into Structured Query Language (SQL), and we will use the generated SQL to query in the database and return the results."},{q:"Why the answer do not turn out to my intended?",a:"We use the text completion provided by OpenAI to translate the text into Structured Query Language (SQL), and the final output depends on the accuracy of the generated SQL. If the final query result does not meet your expectation, please shorten your input statement and using more concise and clear short words for AI recognition."},{q:"Why is the output report an error or show 0 results?",a:o.createElement(o.Fragment,null,"Unfortunately, we do not have useful GitHub insights for you. Usually, there are two situations that cause the answer not to be found:",o.createElement("ol",null,o.createElement("li",null,"AI unrecognized/misunderstand your text and generated wrong/bad SQLs, the query mission failed."),o.createElement("li",null,"Data restrictions. All the data we use here on this website sources from\xa0",o.createElement("a",{href:"http://www.gharchive.org/",target:"_blank",rel:"noreferrer"},"GH Archive"),", a non-profit project that records and archives all GitHub events data since 2011. We can not offer you more insights if you are looking for answers about other topics.")),o.createElement("br",null),"The potential solution is phrase your question which is related GitHub with short, specific words , then try again. And we strongly recommend you use our query templates near the search box to start your exploring.")}],Hn=(0,w.ZP)("div")`
  &:not(:first-of-type) {
    margin-top: 48px;
  }
`,Wn=(0,w.ZP)("h3")`
...
`,Xn=o.createElement(Kn,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Me.Z,null)),Jn=o.createElement(Yn,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(Zt.Z,{fontSize:"inherit"}));var jn=n(27952),ea=n(5299);function ta(){return o.createElement(aa,null,o.createElement(We,{variant:"text",n:4,title:(e,t)=>o.createElement(Ie.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(na,null),"Get inspired",o.createElement(ee.Z,{onClick:e,disabled:t},o.createElement(Ne.Z,{fontSize:"inherit"})))}),o.createElement(Tt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(v.Z,null,o.createElement(ra,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(ea.Z,{color:"inherit"})),o.createElement(la,null,"Get hands-on with your data Get hands-on with your data")))}function na(){return o.createElement(o.Fragment,null,Ue(3).map((e=>o.createElement(oa,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const aa=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,oa=(0,w.ZP)(jn.Z)`
  vertical-align: text-bottom;
...
`,la=(0,w.ZP)("p")`
  margin-top: 8px;
  font-size: 12px;
`;function ia(){var e;const{question:t,loading:n,load:a,error:r,phase:l,reset:i,create:c}=f({pollInterval:2e3}),[s,d]=(0,b.ZP)("id",(0,b.Rc)(),!0),[m,h]=(0,o.useState)(""),y=!p.has(l),w=y||(0,u.oM)(m),I=(0,u.Rw)(null==t?void 0:t.id)&&!n,A=((null==t||null==(e=t.result)?void 0:e.rows.length)??0)>0;(0,o.useEffect)((()=>{(0,u.nf)(t)&&h(t.title)}),[null==t?void 0:t.title]),(0,o.useEffect)((()=>{(0,u.nf)(s)?a(s):L()}),[s]),(0,o.useEffect)((()=>{(0,u.nf)(null==t?void 0:t.id)&&d(null==t?void 0:t.id)}),[n,null==t?void 0:t.id]);const N=(0,S.Z)((()=>{y||c(m)})),L=(0,S.Z)((()=>{i(),h(""),d(void 0)})),M=(0,S.Z)((e=>{h(e),c(e)}));return o.createElement(E.Provider,{value:{phase:l,question:t,loading:n,error:r,create:c,load:a,reset:i}},o.createElement(Z.Provider,{value:{search:m,handleSelect:M}},o.createElement(C,null),o.createElement(k,{showSide:!I&&l===g.READY&&A,showHeader:I,showFooter:I,header:o.createElement(V,null),side:o.createElement(ta,null),footer:o.createElement(v.Z,{mt:2},o.createElement(ge,{align:"center"}),o.createElement(ca,{to:"/blog/chat2query-tutorials",target:"_blank"},"\ud83e\uddd0 GitHub data is just the beginning. Uncover hidden insights in your OWN data!",o.createElement(ea.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})))},o.createElement(le,{value:m,onChange:h,onAction:N,disableInput:y,disableClear:""===m,disableAction:w,onClear:L,clearState:y?"stop":void 0}),o.createElement(ue,{state:I?"recommend":"execution",direction:I?"down":"up"},o.createElement(v.Z,{key:"execution",sx:{mt:1.5}},o.createElement(kn,{search:m})),o.createElement(v.Z,{key:"recommend",sx:{mt:4}},o.createElement(Rn,null)))),o.createElement(x.Z,{maxWidth:"lg",sx:{pb:8}},o.createElement(qn,null))))}const ca=(0,w.ZP)(Re.Z)`
  display: block;
  text-align: center;
  color: white !important;
  text-decoration: none !important;
