...
`;var pe=n(3106),fe=n(52263);function Ee(e){let{as:t="a",campaign:n,trial:a,...r}=e;const{user:l}=(0,m.g)(),{campaign:i,trial:c}=(0,o.useContext)(pe.Z),{siteConfig:{customFields:s}}=(0,fe.Z)(),{campaign:d,trial:g}=(0,o.useMemo)((()=>({campaign:(0,u.kX)(u.GC,n,i,void 0),trial:(0,u.kX)(u.nf,a,c,!1)})),[n,i,a,c]),h=(0,o.useMemo)((()=>{const e=new URL(`https://${null==s?void 0:s.tidbcloud_host}/channel`);if((0,u.GC)(d)&&(e.searchParams.set("utm_source","ossinsight"),e.searchParams.set("utm_medium","referral"),e.searchParams.set("utm_campaign",d)),g){const t=function(e){if((0,u.nf)(e)&&(0,u.GC)(e.email)&&(0,u.GC)(e.sub)){let t;switch(e.sub.split("|")[0]){case"github":t="github";break;case"google-oauth2":t="google";break;case"windowslive":t="microsoft";break;default:return}return{email:e.email,connection:t}}return}(l);(0,u.nf)(t)&&(e.searchParams.set("email",t.email),e.searchParams.set("connection",t.connection))}return e.toString()}),[l,d,g]);return(0,o.createElement)(t,{href:h,target:"_blank",rel:"noopener",...r})}function ye(e){let{align:t="left",sx:n}=e;return o.createElement(be,{align:t,sx:n},"Powered by ",o.createElement(Ee,null,"TiDB Cloud"))}const be=(0,x.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`;const dt=(0,n(1588).Z)("RippleDot",["root","info","success","error","warning","active"]);var mt=n(86010);function gt(e){let{active:t=!0,color:n="info",size:a=8}=e;return o.createElement(pt,{size:a,className:(0,mt.Z)({[dt.root]:!0,[dt.active]:t,[dt[n]]:!0})})}const ht=it.F4`
  0% {
    opacity: 1;
    transform: initial;
  }
...
`,pt=(0,x.ZP)("span",{name:"RippleDot",shouldForwardProp:e=>"size"!==e})`
  display: inline-block;
  position: relative;
...
`,Ia=o.createElement(Sa,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Re.Z,null)),Ca=o.createElement(Za,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(fa.Z,{fontSize:"inherit"}));var Aa=n(77331);function ka(){return o.createElement(Na,null,o.createElement(je,{variant:"text",n:4,title:(e,t)=>o.createElement(Le.Z,{variant:"h3",mb:0,fontSize:16},"\ud83d\udca1 Get inspired",o.createElement(te.Z,{onClick:e,disabled:t},o.createElement(Te.Z,{fontSize:"inherit"})))}),o.createElement(Ft.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(Ee,{as:Ma},"Check out ",o.createElement("b",null,"Chat2Query")," to empower any dataset you want.",o.createElement(Aa.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})),o.createElement(La,null,"*Chat2Query: an AI-powered querying tool in TiDB Cloud that generates SQL for your queries."))}const Na=(0,x.ZP)("div")`
  position: sticky;
  top: 92px;
`,Ma=(0,x.ZP)(qe.Z)`
  display: block;
