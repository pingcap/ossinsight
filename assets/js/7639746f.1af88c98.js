...
`,rt=(0,w.ZP)("span")`
  flex: 1;
`;var lt=n(14850),it=n(66284);function ct(e){return/date|time|year|month/.test(e)}function st(e){return"number"==typeof e?e>=1970&&e<2100:st(Number(e))}function dt(e,t){return e.map((e=>{let n=e[t];return st(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function ut(e,t){return(0,d.YN)(t,(e=>!(0,d.Rw)(e)&&(e instanceof Array?e.length>0&&(0,d.YN)(e,d.GC):(0,d.GC)(e))))?e.filter((e=>(0,d.YN)(t,(e=>t=>"string"==typeof t?(0,d.nf)(e[t]):(0,d.YN)(t,(t=>(0,d.nf)(e[t]))))(e)))):[]}var mt=n(60338),gt=n(68023),ht=n(33989),pt=n(31281),ft=n(8690),Et=n(27240),yt=n(76395);(0,gt.D)([ht.N,pt.N,ft.N,Et.N,yt.N]);var bt=n(44731),xt=n(85214),vt=n(81284),wt=n(19594),St=n(95309),Zt=n(61702);function It(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,d.uW)(a)?a.map((e=>({name:e}))):(0,d.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(Ct,null,o.createElement(At,{className:"clearTable"},o.createElement("thead",null,(0,d.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const Ct=(0,w.ZP)("div")`
  overflow: scroll;
`,At=(0,w.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var Nt=n(49837),Lt=n(91359),Mt=n(45344);var Pt=n(74446),Tt=n(75559),Rt=n(40172);const Ft=(0,w.ZP)("div")`
  height: 100%;
`;function Gt(e){let{title:t}=e;const{question:n}=y(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return Ce("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(He,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const kt={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=ct(a);l=e?dt(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(it.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const{options:i,height:c}=(0,o.useMemo)((()=>{const e=ct(a);l=e?dt(l,a):l;const t=!e,o=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:t?e:a,y:t?a:e}}:e.map(o)};return{options:{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:o(r),title:{text:n},[t?"yAxis":"xAxis"]:{type:e?"time":"category"},[t?"xAxis":"yAxis"]:{type:"value"},animationDuration:2e3},height:t?40*l.length:400}}),[t,n,a,r,l]);return o.createElement(it.Z,{theme:"dark",style:{height:c},opts:{height:c},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(mt.ZP,{height:400,option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(xt.Z,null,r.map(((e,t)=>o.createElement(vt.ZP,{key:t},o.createElement(St.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(wt.Z,null,o.createElement(bt.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(Zt.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(xt.Z,null,r.map(((e,t)=>o.createElement(vt.ZP,{key:t},o.createElement(St.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(wt.Z,null,o.createElement(bt.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(Zt.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:It,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if((0,d.N6)(a)){if(1===l.length&&(0,d.Rw)(l[0][a])){const e=l[0][r];return o.createElement(Nt.Z,null,o.createElement(Lt.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Ie.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},n),(0,d.z0)(e)?o.createElement(Mt.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return o.createElement(o.Fragment,null,o.createElement(Ie.Z,{variant:"h4"},n),o.createElement(Me.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Me.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(Nt.Z,{sx:{p:2}},o.createElement(Ie.Z,{variant:"subtitle1"},e[a]),o.createElement(Ie.Z,{variant:"body2",color:"#7c7c7c"},e[r])))))))}return o.createElement(xt.Z,null,l.map(((e,t)=>o.createElement(vt.ZP,{key:t},o.createElement(Nt.Z,{sx:{p:4}},o.createElement(Zt.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),u=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,Pt.$)(e[t]),{long:o,lat:r}=(0,Pt.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,d.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=u[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,Tt.Mm)(),dataset:[{id:"top1",source:u.slice(0,1)},{id:"rest",source:u.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=u[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,u]);return(0,o.useEffect)((()=>{if((0,d.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(Rt.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(Ft,{ref:c},o.createElement(it.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function Dt(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=kt[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,Oe.wE)(e)]),a=ut(e.data,n);let r,l;return(0,d.Rw)(t)&&(r=o.createElement(Gt,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(Ye,null):a.length>0?(0,d.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(Gt,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var Bt=n(44373),$t=n(78385),Ot=n(87054),Ut=n(85390),zt=n(45670),_t=n(55050),qt=n(91693),Ht=n(96942),Wt=n(36804),Qt=n(88784);function Vt(e){let{children:t}=e;return o.createElement(Qt.Z,{title:t},o.createElement(ee.Z,null,o.createElement(Wt.Z,{fontSize:"inherit"})))}var Kt=n(1969),Yt=n(64232);function Xt(e){return o.createElement(Jt,(0,ge.Z)({target:"_blank"},e),"Share",o.createElement(jt,null))}const Jt=(0,w.ZP)("a")`
  display: inline-flex;
  align-items: center;
  opacity: 0.8;
...
`,jt=(0,w.ZP)(Yt.Z)`
  margin-left: 4px;
  color: #1D9BF0;
`;function en(e){let{align:t="left",sx:n}=e;return o.createElement(tn,{align:t,sx:n},"Powered by ",o.createElement("a",{href:"https://www.pingcap.com/tidb-cloud/",target:"_blank",rel:"noreferrer"},"TiDB Cloud"))}const tn=(0,w.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`,An=o.createElement(In,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Le.Z,null)),Nn=o.createElement(Cn,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(Yt.Z,{fontSize:"inherit"}));var Ln=n(27952),Mn=n(5299);function Pn(){return o.createElement(Rn,null,o.createElement(qe,{variant:"text",n:4,title:(e,t)=>o.createElement(Ie.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(Tn,null),"Get inspired",o.createElement(ee.Z,{onClick:e,disabled:t},o.createElement(Ae.Z,{fontSize:"inherit"})))}),o.createElement(Bt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(Gn,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(Mn.Z,{color:"inherit"})),o.createElement(kn,null,"Get hands-on with your data Get hands-on with your data")))}function Tn(){return o.createElement(o.Fragment,null,Ue(3).map((e=>o.createElement(Fn,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const Rn=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Fn=(0,w.ZP)(Ln.Z)`
  vertical-align: text-bottom;
