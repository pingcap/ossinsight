...
`;var Ta=n(5299),Ga=n(63675),Ra=n(25425),Fa=n(7449);const Da=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,Ga.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>ln.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,s.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(ln.ou.now()))??[ln.ou.now()])))})),c=(0,w.Z)((()=>{a(!1)}));return(0,Fa.h)(t,{show:i}),o.createElement(Tt.Z,null,o.createElement(Ra.Z,{direction:"left",in:n},o.createElement($a,null,o.createElement(qa,null),o.createElement(Ba,null),o.createElement(za,null,o.createElement(Xt.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Check out our ",o.createElement(Fe.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"tutorial"),", if you want to try AI-generated SQL for any other dataset."),o.createElement(Oa,{size:"small",onClick:c},o.createElement(oe.Z,null))))))})),$a=(0,x.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
