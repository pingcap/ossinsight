...
`,M=(0,w.ZP)(k)`
  ...
  overflow: hidden;
`;var P=n(36336),L=n(98885),T=n(93580);const R=400;function F(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),d=(0,o.useRef)(null),m=(0,T.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??0),[null==m?void 0:m.height]);return o.createElement(G,{maxWidth:"xl"},o.createElement(L.ZP,{nodeRef:s,in:c,timeout:R},(e=>o.createElement(o.Fragment,null,o.createElement($,{ref:s,className:`Header-${e}`,height:g},n),o.createElement(D,{className:`Body-header-${e}`,headerHeight:g},o.createElement(L.ZP,{nodeRef:u,in:i,timeout:R},(e=>o.createElement(q,{ref:u,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:d,in:i,timeout:R,unmountOnExit:!0},(e=>o.createElement(B,{ref:d,className:`Side-${e}`},a))))))),o.createElement(z,null,l&&r))}const G=(0,w.ZP)(P.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,Ia=o.createElement(Sa,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Te.Z,null)),Aa=o.createElement(Za,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(fa.Z,{fontSize:"inherit"}));var Ca=n(77331);function ka(){const{question:e}=b(),[t,n]=(0,o.useState)(!1);(0,o.useEffect)((()=>{n(!1)}),[null==e?void 0:e.id]);const a=(0,u.Z)((e=>()=>{e(),n(!0)}));return o.createElement(Na,null,o.createElement(Ke,{variant:"text",n:4,title:(e,t)=>o.createElement(Ne.Z,{variant:"h3",mb:0,fontSize:16},"\ud83d\udca1 Get inspired",o.createElement(ne.Z,{onClick:a(e),disabled:t},o.createElement(Pe.Z,{fontSize:"inherit"})))}),t&&o.createElement(o.Fragment,null,o.createElement(Dt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(Ma,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(Ca.Z,{color:"inherit"})))))}const Na=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Ma=(0,w.ZP)(De.Z)`
  display: inline-flex;
...
`;var Pa=n(5299),La=n(63675),Ta=n(25425),Ra=n(7449);const Fa=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,La.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>yn.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,u.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(yn.ou.now()))??[yn.ou.now()])))})),c=(0,S.Z)((()=>{a(!1)}));return(0,Ra.h)(t,{show:i}),o.createElement(Rt.Z,null,o.createElement(Ta.Z,{direction:"left",in:n},o.createElement(Ga,null,o.createElement(Da,null),o.createElement($a,null),o.createElement(qa,null,o.createElement(dn.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Check out our ",o.createElement(De.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"tutorial"),", if you want to try AI-generated SQL for any other dataset."),o.createElement(Ba,{size:"small",onClick:c},o.createElement(re.Z,null))))))})),Ga=(0,w.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
