...
`,Ee=(0,x.ZP)(ge)`
  ...
  overflow: hidden;
`;var fe=n(36336),ve=n(79104),ye=n(98885),be=n(93580);const xe=400;function Ze(e){let{children:t,header:n,side:a,showSide:o,showHeader:l}=e;const i=(0,r.useRef)(null),c=(0,be.Z)(i),s=(0,r.useMemo)((()=>(null==c?void 0:c.height)??0),[null==c?void 0:c.height]);return r.createElement(we,{maxWidth:"xl"},r.createElement(ye.ZP,{in:l,timeout:xe},(e=>r.createElement(r.Fragment,null,r.createElement(Ae,{ref:i,className:`Header-${e}`,height:s},n),r.createElement(Se,{className:`Body-header-${e}`,headerHeight:s},r.createElement(ve.Z,null,r.createElement(ye.ZP,{in:o,timeout:xe},(e=>r.createElement(Ce,{className:`Main-side-${e}`},t)))),r.createElement(ye.ZP,{in:o,timeout:xe,unmountOnExit:!0},(e=>r.createElement(Ie,{className:`Side-${e}`},function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),a=1;a<t;a++)n[a-1]=arguments[a];return e instanceof Function?e(...n):e}(a,(null==c?void 0:c.height)??0)))))))))}const we=(0,x.ZP)(fe.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,Oe=(0,x.ZP)("div",{shouldForwardProp:e=>"display"!==e})`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Tt=r.createElement(It,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},r.createElement(gt.Z,null)),Lt=r.createElement(kt,{href:"https://twitter.com/OSSInsight",target:"_blank"},r.createElement(pt.Z,{fontSize:"inherit"}));var Nt=n(79072),Ft=n(91655),Rt=n(50522);const Pt=(0,x.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Mt=(0,x.ZP)(Rt.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.5;
  color: white;
...
`;(0,x.ZP)(Mt,{name:"HighlightButton-Content"})`
  ...
  padding: 8px;
  max-width: max-content;
`,qt.withComponent(Rt.Z),qt.withComponent(Et.Z);function Gt(e){let{question:t,questionId:n,variant:a="card",imageUrl:o,prefix:i,tags:c,disabled:s}=e;const{gtagEvent:u}=(0,g.u)(),{handleSelect:d,handleSelectId:m}=(0,r.useContext)(de),h=(0,N.Z)((()=>{u("click_template_question",{questionId:n??"",questionTitle:Bt(t)}),(0,l.GC)(n)?m(n):"string"==typeof t&&d(t)}));switch(a){case"recommended-card":return r.createElement(Pt,null,r.createElement(Mt,{onClick:h,disabled:s},t),r.createElement(_t,null,"\u2728"));case"card":return r.createElement(Mt,{onClick:h,disabled:s},t,null==c?void 0:c.map((e=>r.createElement($t,{key:e.id,color:e.color},e.label))),o&&r.createElement(zt,{src:o,alt:"preview image"}));default:return r.createElement(Dt,{disableRipple:!0,disableTouchRipple:!0,onClick:h,disabled:s},i,t,null==c?void 0:c.map((e=>r.createElement($t,{key:e.id,color:e.color},e.label))))}}const Dt=(0,x.ZP)(Rt.Z,{name:"QuestionCard-Link"})`
  display: block;
  width: 100%;
  text-align: left;
  padding: 8px 0;
...
`;var Vn=n(70983),Wn=n(96812);function Kn(e){let{status:t}=e;switch(t){case zn.loading:return r.createElement(Un,{sx:Yn,size:12});case zn.success:return r.createElement(Vn.Z,{sx:Yn,color:"success",fontSize:"inherit"});case zn.error:return r.createElement(Wn.Z,{sx:Yn,color:"disabled",fontSize:"inherit"});default:return r.createElement(r.Fragment,null)}}const Yn={mr:1,verticalAlign:"middle"};var jn=n(22821),Xn=n(9942),Jn=n(54225),ea=n(18629);function ta(e){let{content:t,avgInterval:n=80,maxDiff:a=50,maxContinuous:o=1}=e;const[l,i,c]=function(e){const[t,n]=(0,r.useState)(e),a=(0,r.useRef)(t);return(0,r.useEffect)((()=>{a.current=t}),[t]),[t,n,a]}(0),[s,u]=(0,r.useState)(!0);return(0,r.useEffect)((()=>{let e;i(0);const r=ut(o).map((e=>e+1));return u(!1),function o(){e=setTimeout((()=>{c.current>=t.length?(clearTimeout(e),u(!0)):(i((e=>{const n=e+(dt(r)??1);return t.substring(e,n).includes(" ")?e+1:n})),o())}),n+(.5-Math.random())*a)}(),()=>{clearTimeout(e)}}),[t]),r.createElement(r.Fragment,null,t.slice(0,l),t.length!==l,!s&&r.createElement(aa,null))}const na=S.F4`
  to {
    visibility: hidden;
  }
`,aa=(0,x.ZP)("span")`
...
`,Fa=(0,x.ZP)("table")`
  ...
  min-width: 100%;
  text-align: center;
`;var Ra=n(49837),Pa=n(91359);const Ma=(0,x.ZP)("span")`
  font-size: 16px;
  opacity: 0.3;
  margin-left: 4px;
`,qa=(0,x.ZP)("table")`
...
`;function lr(){const{question:e}=le();return"error"!==(null==e?void 0:e.status)&&"cancel"!==(null==e?void 0:e.status)?r.createElement(r.Fragment,null):e.errorType===c.QUERY_TIMEOUT?r.createElement(at.Z,{variant:"body1"},"Whoops! Query timed out. SQL may be too complex or incorrect.",r.createElement("br",null),"Optimize your question for effective SQL, or get ideas from ",r.createElement(Et.Z,{to:"/explore/"},"popular questions"),"."):r.createElement(at.Z,{variant:"body1"},"Oops, something wrong with the SQL query. SQL may be too complex or incorrect.",r.createElement("br",null),"Optimize your question for effective SQL, or get ideas from ",r.createElement(Et.Z,{to:"/explore/"},"popular questions"),".")}var ir=n(1890),cr=n(18661),sr=n(62348);function ur(e){let{question:t,open:n,onOpenChange:a}=e;const[o,l]=(0,r.useState)("plan"),i=(0,N.Z)((()=>{null==a||a(!1)})),c=(0,N.Z)(((e,t)=>{l("plan"===t?"plan":"sql")})),s=(0,r.useMemo)((()=>{try{return(0,Nn.WU)((null==t?void 0:t.querySQL)??"",{language:"mysql"})}catch{return(null==t?void 0:t.querySQL)??""}}),[null==t?void 0:t.querySQL]);return r.createElement(ir.Z,{open:n,onClose:i,maxWidth:"xl",fullWidth:!0},r.createElement(sr.Z,{onChange:c,value:o,sx:{mb:2}},r.createElement(cr.Z,{label:"Execution Plan",value:"plan"}),r.createElement(cr.Z,{label:"SQL",value:"sql"})),r.createElement(y.Z,{px:2},(()=>{if("plan"===o){var e;const n=["id","estRows","task","access object","operator info"];return r.createElement(y.Z,{sx:{overflowX:"scroll",color:"rgb(248, 248, 242)",backgroundColor:"rgb(40, 42, 54)",borderRadius:2,py:2},mb:2},r.createElement(y.Z,{display:"table",fontFamily:"monospace",fontSize:16,lineHeight:1,sx:{borderSpacing:"16px 0"}},r.createElement(y.Z,{display:"table-header-group"},r.createElement(y.Z,{display:"table-row"},n.map((e=>r.createElement(y.Z,{key:e,display:"table-cell"},e))))),r.createElement(y.Z,{display:"table-footer-group"},null==t||null==(e=t.plan)?void 0:e.map(((e,t)=>r.createElement(y.Z,{key:t,display:"table-row"},n.map((t=>r.createElement(y.Z,{key:t,display:"table-cell",whiteSpace:"pre"},e[t])))))))))}return r.createElement(xn.Z,{className:"language-sql"},s)})()))}function dr(e){let{question:t,children:n}=e;const[a,o]=(0,r.useState)(!1),l=(0,N.Z)((()=>{o(!0)}));return r.createElement(r.Fragment,null,r.createElement(Jn.Z,{variant:"text",size:"small",sx:{ml:1},onClick:l},n),r.createElement(ur,{open:a,onOpenChange:o,question:t}))}(0,x.ZP)(Ra.Z)`
...
`,(0,x.ZP)("span")`
  margin-left: 12px;
`;var mr=n(21972),hr=n(46895),gr=n(78667),pr=n(49185),Er=n(87385),fr=n(37332),vr=n(70431),yr=n(44276),br=n(1969);function xr(e){let{url:t,title:n,summary:a,hashtags:o}=e;const l=(0,m.Z)((e=>{window.open(e,"_blank")}));return r.createElement(Sr,null,r.createElement(mr.Z,{ariaLabel:"share",sx:{display:"inline-block",position:"absolute",right:0,top:0,[`.${gr.Z.actions}`]:{width:64,display:"flex",flexDirection:"column",alignItems:"flex-end"}},icon:r.createElement("span",null,"Share",r.createElement(pr.Z,{fontSize:"inherit"})),FabProps:Zr},r.createElement(hr.Z,{sx:{overflow:"hidden"},icon:r.createElement(Er.Z,null),FabProps:wr,onClick:(0,N.Z)((()=>l((0,br.PE)(t,{title:n,hashtags:o}))))}),r.createElement(hr.Z,{sx:{overflow:"hidden"},icon:r.createElement(fr.Z,null),FabProps:wr,onClick:(0,N.Z)((()=>l((0,br.BE)(t,{title:n,summary:a}))))}),r.createElement(hr.Z,{sx:{overflow:"hidden"},icon:r.createElement(vr.Z,null),FabProps:wr,onClick:(0,N.Z)((()=>l((0,br.$Z)(t,{title:n}))))}),r.createElement(hr.Z,{sx:{overflow:"hidden"},icon:r.createElement(yr.Z,null),FabProps:wr,onClick:(0,N.Z)((()=>l((0,br.OA)(t,{title:n}))))})))}const Zr={color:"inherit",disableRipple:!0,sx:{fontFamily:"var(--ifm-heading-font-family)",textTransform:"unset",fontSize:16,fontWeight:"normal",width:68,height:32,minHeight:32,background:"none",boxShadow:"none !important",pr:.5,"> span":{display:"inline-flex",gap:.5,alignItems:"center"},"&:hover, &:active":{background:"none"}}},wr={sx:{width:32,height:32,minHeight:32,borderRadius:16,mx:0,overflow:"hidden"}},Sr=(0,x.ZP)("div")`
  display: inline-block;
  position: relative;
  width: 64px;
  height: 32px;
  line-height: 32px;
`,Ar=(0,r.forwardRef)(((e,t)=>{var n,a,o;let{question:i,phase:c,error:s,...u}=e;const{search:d}=(0,r.useContext)(de),[m,h]=(0,r.useState)(null),g=null==i||null==(n=i.result)?void 0:n.rows,p=(0,r.useMemo)((()=>{switch(c){case ee.CREATED:case ee.QUEUEING:case ee.EXECUTING:return zn.loading;case ee.EXECUTE_FAILED:case ee.VISUALIZE_FAILED:case ee.UNKNOWN_ERROR:return zn.error;case ee.READY:case ee.SUMMARIZING:return zn.success;default:return zn.pending}}),[c]),E=(0,r.useMemo)((()=>{var e;switch(c){case ee.CREATED:return"Pending...";case ee.QUEUEING:return`${(null==i?void 0:i.queuePreceding)??NaN} requests ahead`;case ee.EXECUTING:return"Running SQL...";case ee.EXECUTE_FAILED:return"cancel"===(null==i?void 0:i.status)?"Execution canceled":"Failed to execute SQL";case ee.UNKNOWN_ERROR:return"Unknown error";case ee.VISUALIZE_FAILED:case ee.READY:case ee.SUMMARIZING:return r.createElement(r.Fragment,null,`${(null==i||null==(e=i.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==i?void 0:i.spent)??"NaN"} seconds`,function(e){if((0,l.nf)(e)&&!(0,l.yD)(e.engines))return r.createElement(r.Fragment,null,". Running on\xa0",r.createElement(Tr,null,r.createElement(Ir,{src:"/img/tidb-cloud-logo-t.svg",alt:"TiDB"}),e.engines.map(kr).join(", ")),r.createElement(tr,null,"TiDB's optimizer selects the engine for all queries on its single service:",r.createElement("ul",null,r.createElement("li",null,r.createElement(Et.Z,{href:"https://docs.pingcap.com/tidb/stable/tiflash-overview/?utm_source=ossinsight&utm_medium=referral&utm_campaign=chat2query_202301",target:"_blank",rel:"noopener"}," The columnar engine "),"for complex and heavy OLAP queries."),r.createElement("li",null,r.createElement(Et.Z,{href:"https://docs.pingcap.com/tidb/stable/tikv-overview/?utm_source=ossinsight&utm_medium=referral&utm_campaign=chat2query_202301",target:"_blank",rel:"noopener"}," The row-based engine "),"for low-latency high-concurrency OLTP queries."))));return null}(i),function(e){if((0,l.nf)(e)&&!(0,l.yD)(e.plan))return r.createElement(dr,{question:e},"Explain SQL ",r.createElement(ua.Z,null))}(i));default:return"pending"}}),[i,c]),{url:f,title:v,hashtags:b}=(0,r.useMemo)((()=>{var e;if((0,l.Rw)(i))return{url:"https://ossinsight.io/explore/",title:"GitHub Data Explorer",hashtags:[]};let t;const n=`${d} | OSSInsight GitHub Data Explorer`,a=function(){const e=new Set,t=[];for(var n=arguments.length,a=new Array(n),r=0;r<n;r++)a[r]=arguments[r];return a.forEach((n=>{for(const a of n)e.has(a)||(e.add(a),t.push(a))})),t}((null==(e=i.answerSummary)?void 0:e.hashtags)??[],["OpenSource","OpenAI","TiDBCloud"]);return t=(0,l.GC)(i.id)?`https://ossinsight.io/explore?id=${i.id}`:"https://ossinsight.io/explore/",{url:t,title:n,hashtags:a}}),[i,d]),x=(0,r.useMemo)((()=>{if("error"===p)return s}),[p,s]),Z=(0,r.useMemo)((()=>{if(c===ee.VISUALIZE_FAILED)return s}),[c,s]);(0,r.useMemo)((()=>(0,l.nf)(i)&&(0,l.nf)(i.answerSummary)?(0,l.uW)(i.answerSummary.hashtags)?`${i.answerSummary.content}\n${i.answerSummary.hashtags.map((e=>`#${e}`)).join(" ")}`:i.answerSummary.content:""),[null==i?void 0:i.answerSummary]);return(0,l.Rw)(i)?r.createElement("section",{ref:t,hidden:!0}):r.createElement(Bn,(0,rn.Z)({ref:t},u,{header:r.createElement(Ke.Z,{direction:"row",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap"},r.createElement("span",null,r.createElement(Kn,{status:p}),E),p!==zn.error&&r.createElement(qr,null,r.createElement("span",{ref:h}),r.createElement(xr,{url:f,title:v,summary:null==i||null==(a=i.answerSummary)?void 0:a.content,hashtags:b}))),error:x,errorIn:(0,l.N6)(x),errorMessage:r.createElement(lr,null),issueTemplate:(null==i?void 0:i.errorType)??void 0}),false,c===ee.QUEUEING&&r.createElement(Pr,{source:0===(null==i?void 0:i.queuePreceding)?Fr:Nr,interval:5e3}),c===ee.EXECUTING&&r.createElement(Pr,{source:Rr,interval:3e3}),r.createElement(Lr,{question:i,chartData:(null==i?void 0:i.chart)??void 0,chartError:Z,result:g,fields:null==i||null==(o=i.result)?void 0:o.fields,controlsContainer:m}),r.createElement(y.Z,{height:"16px"}))})),Cr=Ar,Ir=(0,x.ZP)("img")`
  height: 18px;
  vertical-align: text-bottom;
  margin-right: 4px;
`;function kr(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const Tr=(0,x.ZP)("span")`
  color: #B0B8FF;
`;function Lr(e){let{question:t,chartData:n,chartError:a,fields:o,result:i,controlsContainer:c}=e;const[s,u]=(0,r.useState)("visualization"),d=(0,r.useRef)("visualization");(0,r.useEffect)((()=>{u(d.current)}),[n]);const m=(e,t)=>{(0,l.GC)(t)&&u(t)},h=(0,N.Z)((e=>{d.current=e?"raw":"visualization"})),g=(0,N.Z)((()=>{d.current="visualization"}));return(0,r.useMemo)((()=>{const e=function(e,t){return void 0===e&&(e=!1),void 0===t&&(t=!1),r.createElement($n,{severity:"warning",sx:e?{mb:2}:void 0},r.createElement(at.Z,{variant:"body1"},"Oh no, visualization didn't work.",r.createElement("br",null),"You can still check your results using the table."))};if((0,l.Rw)(t))return null;const u=Fn(t);if((0,l.Rw)(i))return(0,l.nf)(a)?e(!1,!0):null;const d=()=>r.createElement(r.Fragment,null,r.createElement(Ke.Z,{direction:"row",justifyContent:"center",alignItems:"center",flexWrap:"wrap",spacing:.5,py:1,mt:2,fontSize:"inherit",bgcolor:"#323140"},r.createElement(at.Z,{variant:"body1",mr:2},"Do you like the result?"),r.createElement(Xa,null)),r.createElement(jt.Z,{sx:{my:2}}),r.createElement(at.Z,{component:"div",variant:"body2",color:"#D1D1D1"},"\ud83e\udd14 Not exactly what you're looking for? Check out our ",r.createElement(ia,{anchor:"data-explorer-faq"},"FAQ")," for help. If the problem persists, please ",r.createElement(Et.Z,{href:u(),target:"_blank",rel:"noopener"},"report an issue")," to us.")),p=()=>r.createElement(r.Fragment,null,r.createElement(Dr,null,r.createElement(La,{chartName:"Table",title:"",data:i,fields:o})),d());if((0,l.Rw)(n))return(0,l.nf)(a)?r.createElement(r.Fragment,null,e(!0),p()):null;const E=()=>r.createElement(r.Fragment,null,r.createElement(Dr,null,r.createElement(Ha,(0,rn.Z)({},n,{data:i,fields:o,onPrepared:h,onExit:g}))),d());return(0,l.nf)(a)?r.createElement(r.Fragment,null,e(!0),p()):"Table"===n.chartName?E():r.createElement(r.Fragment,null,r.createElement(pa.Z,{container:c},r.createElement(Mr,{className:"chart-controls"},r.createElement(fa.Z,{size:"small",value:s,onChange:m,exclusive:!0,color:"primary"},r.createElement(Ea.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},r.createElement(da.Z,{fontSize:"small"})),r.createElement(Ea.Z,{value:"raw",size:"small",sx:{padding:"5px"}},r.createElement(ma.Z,{fontSize:"small"}))))),r.createElement(ha.ZP,{value:s},r.createElement(Gr,{value:"visualization"},E()),r.createElement(Gr,{value:"raw"},p())))}),[s,n,a,i,o,c])}const Nr=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? - 17 types!","GitHub generates over 4 million new events each day. We synchronize with them in real time and insert updates in milliseconds.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],Fr=["Almost there! Can't wait to see your result!"],Rr=[r.createElement(r.Fragment,null,"Querying ",r.createElement("b",null,"5+ billion")," rows of GitHub data..."),r.createElement(r.Fragment,null,"We stay in sync with GitHub event data for ",r.createElement("b",null,"real-time")," insights!"),r.createElement(r.Fragment,null,"We can handle ",r.createElement("b",null,"complex queries")," with a powerful database, even those generated by AI."),r.createElement(r.Fragment,null,r.createElement("b",null,"\ud83d\udc40 Tips"),": Click ",r.createElement("b",null,"Show")," in the upper right corner to check the SQL query generated by AI.")],Pr=(0,x.ZP)((e=>{let{source:t,interval:n,prefix:a=r.createElement(A,{animated:!1}),...o}=e;const[l,i]=(0,r.useState)(0);return(0,ea.Z)((()=>{i((e=>(e+1)%t.length))}),n),r.createElement(nr.Z,(0,rn.Z)({component:rr},o),a??void 0,r.createElement(ar.Z,{key:l,timeout:400,classNames:"item"},r.createElement(or,null,t[l])))}))`
  min-height: 42px;
  min-width: 1px;
`,Mr=(0,x.ZP)("div")`
  display: inline-flex;
...
`,Dr=(0,x.ZP)("div")`
  position: relative;
`;var _r=n(45989);const $r=[["#FFBCA7",2.21],["#DAA3D8",30.93],["#B587FF",67.95],["#6B7AFF",103.3]],zr=e=>{let{size:t,sx:a}=e;return r.createElement(r.Fragment,null,r.createElement(bt,{as:Or,sx:a,stops:$r,deg:90,content:"result_bottom"},r.createElement(Br,null,"Try other dataset"),r.createElement(Ur,null,r.createElement(Qr,null,r.createElement(nn,null)),"Import NOW!"),r.createElement(Hr,{width:"304",src:n(74040).Z,alt:"image"}),r.createElement(Vr,null),r.createElement(Kr,null,"Chat2Query on",r.createElement(Wr,{src:"/img/tidb-cloud-logo-o.png",alt:"TiDB Cloud Logo"}))))},Br=(0,x.ZP)("div")`
  font-style: normal;
  font-weight: 600;
  font-size: 32px;
  line-height: 150.02%;
...
`,Co=(0,x.ZP)("div")`
  ...
  margin-top: 12px;
  vertical-align: middle;
`,Io=(0,r.forwardRef)(((e,t)=>r.createElement(ko,(0,rn.Z)({ref:t},e),r.createElement(jt.Z,{sx:{my:2}},"Get to know our data inside and out"),r.createElement(To,null,r.createElement(xo,null),r.createElement(zr,null))))),ko=(0,x.ZP)("section")`
  margin-top: 16px;
...
`;function Lo(e){let{onResultEnter:t,onResultExit:n,onResultEntered:a,onResultExited:o}=e;const{question:i,phase:c,error:s}=le(),[u,d]=(0,r.useState)(!1),[h,g]=(0,r.useState)(!1);(0,r.useEffect)((()=>{g(!1)}),[null==i?void 0:i.id]);const p=(0,r.useMemo)((()=>{const e=No.has(c);return!u&&e?i:void 0}),[u,c,i]),E=(0,r.useMemo)((()=>!!h&&(!!Fo.has(c)||(0,l.nf)(i)&&ce(i))),[h,c,i]),f=(0,m.Z)((()=>{null==t||t(null==p?void 0:p.id)})),v=(0,m.Z)((()=>{null==a||a(null==p?void 0:p.id),(0,l.nf)(p)&&g(!0)})),y=(0,m.Z)((()=>{null==n||n(null==p?void 0:p.id),(0,l.nf)(p)&&g(!1)})),b=(0,m.Z)((()=>{null==o||o(null==p?void 0:p.id)})),x=(0,m.Z)((()=>{d(!0)})),Z=(0,m.Z)((()=>{d(!1)})),w=(0,m.Z)((()=>{c!==ee.EXECUTE_FAILED&&g(!1)})),S=(0,m.Z)((()=>{c!==ee.EXECUTE_FAILED&&g(!0)}));return r.createElement(r.Fragment,null,r.createElement(sa,{question:i,phase:c,error:s,onPromptsStart:x,onPromptsReady:Z,onErrorMessageStart:w,onErrorMessageReady:S}),r.createElement(_r.Z,{mode:"out-in"},r.createElement(Xt.Z,{key:`result-${(null==p?void 0:p.id)??""}`,onEnter:f,onEntered:v,onExit:y,onExited:b},r.createElement(Cr,{style:{transformOrigin:"top center"},question:p,phase:c,error:s}))),r.createElement(Xt.Z,{in:E,unmountOnExit:!0},r.createElement(Io,null)))}const No=new Set([ee.CREATED,ee.QUEUEING,ee.EXECUTING,ee.EXECUTE_FAILED,ee.VISUALIZE_FAILED,ee.UNKNOWN_ERROR,ee.READY,ee.SUMMARIZING]),Fo=new Set([ee.VALIDATE_SQL_FAILED,ee.GENERATE_SQL_FAILED,ee.EXECUTE_FAILED,ee.CREATE_FAILED]);function Ro(e){let{onChange:t,value:n}=e;const{data:a=[]}=(0,Ot.ZP)("explore-tags",{fetcher:d,revalidateOnFocus:!1,revalidateOnReconnect:!1});return r.createElement(Do,null,r.createElement(Mo,null,r.createElement(Go,{color:"#ccc",className:(0,an.Z)({[Po.active]:null==n}),onClick:e=>{null==t||t(e,null)}},"All"),r.createElement(qo,{orientation:"vertical",flexItem:!0}),a.map((e=>r.createElement(Go,{key:e.id,color:e.color,className:(0,an.Z)({[Po.active]:e.id===(null==n?void 0:n.id)}),onClick:n=>{null==t||t(n,e)}},e.label)))))}const Po=(0,en.Z)("TagItem",["active"]),Mo=(0,x.ZP)("div")`
  display: flex;
  flex-wrap: wrap;
  margin-right: -16px;
  margin-bottom: -12px;
`,qo=(0,x.ZP)(jt.Z)`
  margin-bottom: 12px;
  margin-right: 16px;
`,Go=(0,x.ZP)("span",{shouldForwardProp:e=>"color"!==e})`
  display: inline-block;
  color: ${e=>{let{color:t}=e;return t}};
  background-color: ${e=>{let{color:t}=e;return(0,rt.Fq)(t,.1)}};
  border: 1px solid ${e=>{let{color:t}=e;return(0,rt.Fq)(t,.3)}};
...
`,Do=(0,x.ZP)("div")`
  margin-bottom: 16px;
`;var _o=n(32440),$o=n(91680);function zo(e){let{n:t,tagId:n}=e;const{data:a=[],loading:o}=Qt(!1,t,n),[l,i]=(0,r.useState)(!1),[c,s]=(0,r.useState)(!1);(0,r.useEffect)((()=>{s(a.length>20)}),[a]);const u=(0,r.useMemo)((()=>l?a:a.slice(0,20)),[a,l]),d=(0,N.Z)((()=>{i(!0)})),m=(0,N.Z)((()=>{Cn("explore-questions-list",!1)(),i(!1)}));return r.createElement(Bo,{id:"explore-questions-list"},r.createElement(Ht,{n:t,disabled:o,questions:u,variant:"text",questionPrefix:r.createElement(_o.Z,{sx:{color:"#959595",verticalAlign:"text-bottom"},color:"inherit",fontSize:"inherit"}),showTags:!0}),!l&&c&&r.createElement(jt.Z,null,r.createElement(Jn.Z,{variant:"text",color:"inherit",onClick:d},"See More")),l&&c&&r.createElement(jt.Z,null,r.createElement(T.Z,{color:"inherit",onClick:m},r.createElement($o.Z,null))))}const Bo=(0,x.ZP)("div")`
  scroll-margin: 140px;
`,Oo=[{question:"How diverse is django's community (by coders' distribution)",questionId:"75404c1b-790f-421c-b530-49b6d336290d",imageUrl:n(64731).Z,tags:[{id:2,label:"Repositories",color:"#a3fcc8",sort:2,createdAt:"2023-01-19T02:36:34.000+00:00"}]},{question:"Summary of @gvanrossum's contribution by event type in 2022",questionId:"8ff46822-4637-4632-8306-81e3e28333d2",imageUrl:n(94486).Z,tags:[{id:1,label:"Developers",color:"#f2ac99",sort:1,createdAt:"2023-01-19T02:36:34.000+00:00"}]}];function Uo(){const[e,t]=(0,r.useState)(null),n=(0,N.Z)(((e,n)=>{t(n)}));return r.createElement(Nt.ZP,{container:!0,spacing:4},r.createElement(Nt.ZP,{item:!0,xs:12,md:5,lg:4},r.createElement(at.Z,{variant:"h3",fontSize:16,mb:2},"\ud83d\udca1 Popular questions"),Oo.map(((e,t)=>r.createElement(Gt,(0,rn.Z)({key:t},e)))),r.createElement(mn,{sx:{mt:2},utmContent:"home_left"})),r.createElement(Nt.ZP,{item:!0,xs:12,md:7,lg:8},r.createElement(Ro,{value:e,onChange:n}),r.createElement(y.Z,null,r.createElement(zo,{n:100,tagId:(null==e?void 0:e.id)??void 0}))))}function Qo(e){const{marginTop:t,marginBottom:n}=getComputedStyle(e);return e.offsetHeight+parseFloat(t)+parseFloat(n)}function Ho(e){let{state:t,transitionDelay:n=0,transitionDuration:a=400,offset:o=120,direction:i="up",revert:c=!1,children:s}=e;const u=(0,r.useRef)(null),d=(0,r.useRef)(null),[m,h]=(0,r.useState)();(0,r.useEffect)((()=>{if(2!==s.length)throw new Error("SwitchLayout should have exactly two children");if((0,l.Rw)(s[0].key)||(0,l.Rw)(s[1].key))throw new Error("SwitchLayout's children must have keys")}),[]);const g=(0,N.Z)((()=>{(0,l.nf)(u.current)&&h(Qo(u.current))})),p=(0,N.Z)((()=>{(0,l.nf)(d.current)&&h(Qo(d.current))})),E=(0,N.Z)((()=>{h(void 0)})),f=(0,N.Z)((()=>{(0,l.nf)(d.current)&&h(Qo(d.current))})),v=(0,N.Z)((()=>{(0,l.nf)(u.current)&&h(Qo(u.current))})),y=(0,N.Z)((()=>{h(void 0)})),b=n+a;return r.createElement(Vo,{offset:o,style:{height:m},duration:a,delay:n},r.createElement(ye.ZP,{key:s[0].key,in:t===s[0].key,timeout:b,unmountOnExit:!0,onExit:g,onExiting:p,onExited:E},(e=>r.createElement(Wo,{ref:u,className:`SwitchItem-${i} SwitchItem-${e}`,duration:a,delay:n,offset:o},s[0]))),r.createElement(ye.ZP,{key:s[1].key,in:t===s[1].key,timeout:b,unmountOnExit:!0,onExit:f,onExiting:v,onExited:y},(e=>r.createElement(Wo,{ref:d,className:`SwitchItem-${c?"up"===i?"down":"up":i} SwitchItem-${e}`,duration:a,delay:n,offset:o},s[1]))))}const Vo=(0,x.ZP)("div",{name:"SwitchLayoutContainer",shouldForwardProp:e=>!["duration","delay","offset"].includes(String(e))})`
  position: relative;
  transition: ${e=>{let{theme:t,duration:n,delay:a}=e;return t.transitions.create("height",{duration:n,delay:a})}};
`,Wo=(0,x.ZP)("div",{name:"SwitchItem",shouldForwardProp:e=>!["offset","duration","delay"].includes(String(e))})`
...
`;var Ko=n(76992),Yo=n(47028),jo=n(29618),Xo=n(21309),Jo=n(95398),el=n(77745),tl=n(22841),nl=n(55118),al=n(67836),rl=n(31812),ol=n(4707),ll=n(26452),il=n(78046);function cl(){const[e,t]=(0,r.useState)(!1),{question:n,recommend:a,updateTags:i}=le(),{data:c=[],isValidating:s}=(0,Ot.ZP)("explore-tags",{fetcher:d,revalidateOnFocus:!1,revalidateOnReconnect:!1}),{data:u,isValidating:h,mutate:g}=(0,Ot.ZP)((0,l.nf)(n)?[n.id,"question:tags"]:void 0,{fetcher:async e=>await async function(e){return await o.po.get(`/explorer/questions/${e}/tags`)}(e)}),[p,E]=(0,r.useState)(u??[]),{run:f,loading:v}=(0,ja.c)({ids:p.map((e=>e.id))},i,"admin-settings");(0,r.useEffect)((()=>{E((u??[]).map((e=>c.find((t=>t.id===e.id))??e)))}),[u]);const y=(0,m.Z)((()=>{t(!1)}));(0,r.useEffect)((()=>{if((0,l.nf)(n)){const e=e=>{"1"===e.key&&e.ctrlKey&&t(!0)};return window.addEventListener("keypress",e,{passive:!0}),()=>{window.removeEventListener("keypress",e)}}}),[n]);const b=(0,m.Z)(((e,t)=>{a(t).then((async()=>await g()))}));return n?r.createElement(ir.Z,{open:e,onClose:y,maxWidth:"md",fullWidth:!0},r.createElement(el.Z,null,"Question Settings"),r.createElement(Jo.Z,null,r.createElement(dl,null,r.createElement(tl.Z,{disabled:(0,l.Rw)(n.recommended),control:r.createElement(nl.Z,{size:"small",checked:n.recommended,onChange:b,name:"Recommend"}),label:"Recommend"})),r.createElement(dl,null,r.createElement(Ke.Z,{spacing:2,direction:"row"},r.createElement(Xo.Z,{sx:{flex:1},multiple:!0,size:"small",disabled:s||h||v,value:p,onChange:(e,t)=>E(t),options:c,getOptionLabel:e=>e.label,renderInput:e=>r.createElement(al.Z,(0,rn.Z)({},e,{label:"Tags",variant:"standard"})),loading:s||h}),r.createElement(rl.Z,{loading:v||s||h,onClick:f},"UPDATE TAGS"))),r.createElement(dl,null,r.createElement(Ko.Z,null,r.createElement(jo.Z,null,"DEBUG INFO"),r.createElement(Yo.Z,null,r.createElement(sl,{question:n})))))):r.createElement(r.Fragment,null)}function sl(e){let{question:t}=e;return r.createElement(ol.Z,{disableSelection:!0,defaultCollapseIcon:r.createElement($.Z,null),defaultExpandIcon:r.createElement(il.Z,null)},Object.entries(t).map((e=>{let[t,n]=e;return r.createElement(ul,{key:t,label:t,value:n,path:[t]})})))}function ul(e){let{label:t,value:n,path:a}=e;const o=a.join(".");return(0,l.Rw)(n)?r.createElement(ll.Z,{nodeId:o,label:r.createElement(r.Fragment,null,r.createElement(ml,null,t,": "),r.createElement(pl,null,"null"))}):"object"==typeof n?n instanceof Array?r.createElement(ll.Z,{nodeId:o,label:r.createElement(ml,null,t,": ")},n.map(((e,t)=>r.createElement(ul,{key:t,label:`${t}`,value:e,path:a.concat(t)})))):r.createElement(ll.Z,{nodeId:o,label:r.createElement(ml,null,t,": ")},Object.entries(n).map((e=>{let[t,n]=e;return r.createElement(ul,{key:t,label:t,value:n,path:a.concat(t)})}))):"number"==typeof n?r.createElement(ll.Z,{nodeId:o,label:r.createElement(r.Fragment,null,r.createElement(ml,null,t,": "),r.createElement(gl,null,n))}):"boolean"==typeof n?r.createElement(ll.Z,{nodeId:o,label:r.createElement(r.Fragment,null,r.createElement(ml,null,t,": "),r.createElement(pl,null,String(n)))}):r.createElement(ll.Z,{nodeId:o,label:r.createElement(r.Fragment,null,r.createElement(ml,null,t,": "),r.createElement(hl,null,n))})}const dl=(0,x.ZP)("div")`
  margin-top: 24px;
`,ml=(0,x.ZP)("span")`
  font-weight: bold;
  color: #9876AA;
