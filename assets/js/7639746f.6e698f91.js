...
`,xa=o.createElement(ba,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Te.Z,null)),wa=o.createElement(va,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(ma.Z,{fontSize:"inherit"}));var Sa=n(77331);function Za(){const{question:e}=b(),[t,n]=(0,o.useState)(!1);(0,o.useEffect)((()=>{n(!1)}),[null==e?void 0:e.id]);const a=(0,u.Z)((e=>()=>{e(),n(!0)}));return o.createElement(Ia,null,o.createElement(Ke,{variant:"text",n:4,title:(e,t)=>o.createElement(Ne.Z,{variant:"h3",mb:0,fontSize:16},"\ud83d\udca1 Get inspired",o.createElement(ne.Z,{onClick:a(e),disabled:t},o.createElement(Pe.Z,{fontSize:"inherit"})))}),t&&o.createElement(o.Fragment,null,o.createElement(Ft.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(Ca,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(Sa.Z,{color:"inherit"})))))}const Ia=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Ca=(0,w.ZP)(De.Z)`
  display: inline-flex;
...
`;var Aa=n(5299),ka=n(63675),Na=n(30120),Ma=n(25425),Pa=n(7449);const La=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,ka.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>Na.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,u.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(Na.ou.now()))??[Na.ou.now()])))})),c=(0,S.Z)((()=>{a(!1)}));return(0,Pa.h)(t,{show:i}),o.createElement(Tt.Z,null,o.createElement(Ma.Z,{direction:"left",in:n},o.createElement(Ta,null,o.createElement(Ra,null),o.createElement(Ga,null),o.createElement(Fa,null,o.createElement(un.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Check out our ",o.createElement(De.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"tutorial"),", if you want to try AI-generated SQL for any other dataset."),o.createElement(Da,{size:"small",onClick:c},o.createElement(re.Z,null))))))})),Ta=(0,w.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
