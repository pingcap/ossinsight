...
`,Ge=(0,x.ZP)("div",{shouldForwardProp:e=>"display"!==e})`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Lt=(0,x.ZP)(kt,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
...
`,Ia=(0,x.ZP)("table")`
  ...
  margin: auto;
  width: max-content;
`;var ka=n(74446),Ta=n(75559),La=n(40172);const Na=(0,x.ZP)("div")`
  height: 100%;
...
`,Ar=(0,x.ZP)("div")`
  position: relative;
`;var Cr=n(45989);const Ir=[["#FFBCA7",2.21],["#DAA3D8",30.93],["#B587FF",67.95],["#6B7AFF",103.3]],kr=e=>{let{size:t,sx:a}=e;return r.createElement(r.Fragment,null,r.createElement(gt,{as:Lr,sx:a,stops:Ir,deg:90,content:"result_bottom"},r.createElement(Tr,null,"Try other dataset"),r.createElement(Nr,null,r.createElement(Fr,null,r.createElement(Kt,null)),"Import NOW!"),r.createElement(Rr,{width:"304",src:n(74040).Z,alt:"image"}),r.createElement(Mr,null),r.createElement(qr,null,"Chat2Query on",r.createElement(Pr,{src:"/img/tidb-cloud-logo-o.png",alt:"TiDB Cloud Logo"}))))},Tr=(0,x.ZP)("div")`
  font-style: normal;
  font-weight: 600;
  font-size: 32px;
  line-height: 150.02%;
