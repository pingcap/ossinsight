...
`,ze=(0,w.ZP)(De,{name:"HighlightButton-Background"})`
...
`;function qt(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,d.uW)(a)?a.map((e=>({name:e}))):(0,d.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(_t,null,o.createElement(Ht,{className:"clearTable"},o.createElement("thead",null,(0,d.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const _t=(0,w.ZP)("div")`
  overflow: scroll;
`,Ht=(0,w.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var Wt=n(66284);function Qt(e){return/date|time|year|month/.test(e)}function Vt(e){return"number"==typeof e?e>=1970&&e<2100:Vt(Number(e))}function Kt(e,t){return e.map((e=>{let n=e[t];return Vt(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function Yt(e,t){return(0,d.YN)(t,(e=>!(0,d.Rw)(e)&&(e instanceof Array?e.length>0&&(0,d.YN)(e,d.GC):(0,d.GC)(e))))?e.filter((e=>(0,d.YN)(t,(e=>t=>"string"==typeof t?(0,d.nf)(e[t]):(0,d.YN)(t,(t=>(0,d.nf)(e[t]))))(e)))):[]}var Jt=n(44731),Xt=n(85214),jt=n(81284),en=n(19594),tn=n(95309),nn=n(61702);var an=n(49837),on=n(91359),rn=n(45344);var ln=n(74446),cn=n(75559),sn=n(40172);const un=(0,w.ZP)("div")`
  height: 100%;
`;function dn(e){let{title:t}=e;const{question:n}=b(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return ke("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(Ke,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const mn={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=Qt(a);l=e?Kt(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(Wt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const{options:i,height:c}=(0,o.useMemo)((()=>{const e=Qt(a);l=e?Kt(l,a):l;const t=!e,o=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:t?e:a,y:t?a:e}}:e.map(o)};return{options:{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:o(r),title:{text:n},[t?"yAxis":"xAxis"]:{type:e?"time":"category",inverse:t},[t?"xAxis":"yAxis"]:{type:"value",position:t?"top":void 0},animationDuration:2e3},height:Math.max(t?40*l.length:400,400)}}),[t,n,a,r,l]);return o.createElement(Wt.Z,{theme:"dark",style:{height:c},opts:{height:c},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",top:36,name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(Wt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(Xt.Z,null,r.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(tn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(en.Z,null,o.createElement(Jt.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(nn.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(Xt.Z,null,r.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(tn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(en.Z,null,o.createElement(Jt.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(nn.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:qt,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if(1===l.length&&1===l.length&&(0,d.Rw)(l[0][a])){const e=l[0][r];return o.createElement(an.Z,null,o.createElement(on.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Ne.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},l[0][a]??n),(0,d.z0)(e)?o.createElement(rn.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return(0,d.N6)(a)?o.createElement(o.Fragment,null,o.createElement(Ne.Z,{variant:"h4"},n),o.createElement(Re.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Re.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(an.Z,{sx:{p:2}},o.createElement(Ne.Z,{variant:"subtitle1"},e[a]),o.createElement(Ne.Z,{variant:"body2",color:"#7c7c7c"},e[r]))))))):o.createElement(Xt.Z,null,l.map(((e,t)=>o.createElement(jt.ZP,{key:t},o.createElement(an.Z,{sx:{p:4}},o.createElement(nn.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),u=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,ln.$)(e[t]),{long:o,lat:r}=(0,ln.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,d.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=u[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,cn.Mm)(),dataset:[{id:"top1",source:u.slice(0,1)},{id:"rest",source:u.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=u[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,u]);return(0,o.useEffect)((()=>{if((0,d.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(sn.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(un,{ref:c},o.createElement(Wt.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function gn(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=mn[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,qe.wE)(e)]),a=Yt(e.data,n);let r,l;return(0,d.Rw)(t)&&(r=o.createElement(dn,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(tt,null):a.length>0?(0,d.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(dn,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var pn=n(91693),hn=n(96942),fn=n(45670),En=n(55050),yn=n(89747),bn=n(76743);function vn(e){let{loading:t=!1,children:n}=e;return o.createElement(xn,{elevation:0},o.createElement(on.Z,null,o.createElement(Ne.Z,{variant:"h4",display:"flex",alignItems:"center",fontSize:16,fontFamily:"monospace"},o.createElement(wn,null),o.createElement(Sn,null,"Instant insights")),o.createElement(Ne.Z,{variant:"body1",fontSize:14,fontFamily:"monospace",mt:2},t?o.createElement(o.Fragment,null,o.createElement(Te.Z,{variant:"text",width:"61%"}),o.createElement(Te.Z,{variant:"text",width:"31%"})):n)))}const xn=(0,w.ZP)(an.Z)`
...
`,Sn=(0,w.ZP)("span")`
  margin-left: 12px;
`;var Zn=n(21972),In=n(46895),Cn=n(78667),An=n(49185),Nn=n(87385),kn=n(37332),Mn=n(70431),Pn=n(44276),Ln=n(1969);function Rn(e){let{url:t,title:n,summary:a,hashtags:r}=e;const{showTips:l}=I(),i=(0,u.Z)((e=>{l(),window.open(e,"_blank")}));return o.createElement(Gn,null,o.createElement(Zn.Z,{ariaLabel:"share",sx:{display:"inline-block",position:"absolute",right:0,top:0,[`.${Cn.Z.actions}`]:{width:64,display:"flex",flexDirection:"column",alignItems:"flex-end"}},icon:o.createElement("span",null,"Share",o.createElement(An.Z,{fontSize:"inherit"})),FabProps:Tn},o.createElement(In.Z,{sx:{overflow:"hidden"},icon:o.createElement(Nn.Z,null),FabProps:Fn,onClick:(0,S.Z)((()=>i((0,Ln.PE)(t,{title:n,hashtags:r}))))}),o.createElement(In.Z,{sx:{overflow:"hidden"},icon:o.createElement(kn.Z,null),FabProps:Fn,onClick:(0,S.Z)((()=>i((0,Ln.BE)(t,{title:n,summary:a}))))}),o.createElement(In.Z,{sx:{overflow:"hidden"},icon:o.createElement(Mn.Z,null),FabProps:Fn,onClick:(0,S.Z)((()=>i((0,Ln.$Z)(t,{title:n}))))}),o.createElement(In.Z,{sx:{overflow:"hidden"},icon:o.createElement(Pn.Z,null),FabProps:Fn,onClick:(0,S.Z)((()=>i((0,Ln.OA)(t,{title:n}))))})))}const Tn={color:"inherit",disableRipple:!0,sx:{fontFamily:"var(--ifm-heading-font-family)",textTransform:"unset",fontSize:16,fontWeight:"normal",width:68,height:32,minHeight:32,background:"none",boxShadow:"none !important",pr:.5,"> span":{display:"inline-flex",gap:.5,alignItems:"center"},"&:hover, &:active":{background:"none"}}},Fn={sx:{width:32,height:32,minHeight:32,borderRadius:16,mx:0,overflow:"hidden"}},Gn=(0,w.ZP)("div")`
  display: inline-block;
  position: relative;
  width: 64px;
  height: 32px;
  line-height: 32px;
`;function Dn(){var e,t,n,a;const{question:r,error:l,phase:i}=b(),{search:s}=I(),[u,m]=(0,o.useState)(null),g=null==r||null==(e=r.result)?void 0:e.rows,h=(0,o.useMemo)((()=>{switch(i){case p.CREATED:case p.QUEUEING:case p.EXECUTING:return"loading";case p.EXECUTE_FAILED:case p.VISUALIZE_FAILED:case p.UNKNOWN_ERROR:return"error";case p.READY:case p.SUMMARIZING:return"success";default:return"pending"}}),[i]),f=(0,o.useMemo)((()=>{var e;switch(i){case p.CREATED:return"Pending...";case p.QUEUEING:return`${(null==r?void 0:r.queuePreceding)??NaN} requests ahead`;case p.EXECUTING:return"Running SQL...";case p.EXECUTE_FAILED:return"Failed to execute SQL";case p.UNKNOWN_ERROR:return"Unknown error";case p.VISUALIZE_FAILED:case p.READY:case p.SUMMARIZING:return o.createElement(o.Fragment,null,`${(null==r||null==(e=r.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==r?void 0:r.spent)??"NaN"} seconds`,function(e){if((0,d.nf)(e)&&!(0,d.yD)(e.engines))return o.createElement(o.Fragment,null,", Running on",o.createElement(zn,null,e.engines.map($n).join(", ")),o.createElement(Nt,null,"All queries to 5 billion rows of GitHub event data are running on ONE TiDB server.",o.createElement("br",null),o.createElement("a",{href:"https://docs.pingcap.com/tidb/stable/dev-guide-hybrid-oltp-and-olap-queries",target:"_blank",rel:"noreferrer"},"TiDB optimizer")," intelligently determines whether to use a row-based (OLTP-friendly) or columnar (OLAP-friendly) storage engine."));return null}(r));default:return"pending"}}),[r,i]),{url:E,title:y,hashtags:v}=(0,o.useMemo)((()=>{var e;if((0,d.Rw)(r))return{url:"https://ossinsight.io/explore",title:"Data Explorer",hashtags:[]};let t;const n=`${s} | OSSInsight Data Explorer`,a=function(){const e=new Set,t=[];for(var n=arguments.length,a=new Array(n),o=0;o<n;o++)a[o]=arguments[o];return a.forEach((n=>{for(const a of n)e.has(a)||(e.add(a),t.push(a))})),t}((null==(e=r.answerSummary)?void 0:e.hashtags)??[],["OpenSource","OpenAI","TiDBCloud"]);return t="undefined"==typeof location?(0,d.GC)(r.id)?`https://ossinsight.io/explore?id=${r.id}`:"https://ossinsight.io/explore":location.href,{url:t,title:n,hashtags:a}}),[r,s]),x=(0,o.useMemo)((()=>{if("error"===h)return l}),[h,l]),w=(0,o.useMemo)((()=>{if(i===p.VISUALIZE_FAILED)return l}),[i,l]);return o.createElement(mt,{status:h,title:f,extra:o.createElement(Vn,null,o.createElement("span",{ref:m}),o.createElement(Rn,{url:E,title:y,summary:null==r||null==(t=r.answerSummary)?void 0:t.content,hashtags:v})),error:x,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},((0,d.nf)(null==r?void 0:r.answerSummary)||(null==r?void 0:r.status)===c.Summarizing)&&o.createElement(vn,{loading:(null==r?void 0:r.status)===c.Summarizing},null==r||null==(n=r.answerSummary)?void 0:n.content),i===p.QUEUEING&&o.createElement(_n,{source:0===(null==r?void 0:r.queuePreceding)?Un:On,interval:5e3}),i===p.EXECUTING&&o.createElement(_n,{source:qn,interval:3e3}),o.createElement(Bn,{chartData:(null==r?void 0:r.chart)??void 0,chartError:w,result:g,fields:null==r||null==(a=r.result)?void 0:a.fields,controlsContainer:u}))}function $n(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const zn=(0,w.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function Bn(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization");(0,o.useEffect)((()=>{c("visualization")}),[t]);const s=(e,t)=>{(0,d.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,Ce.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(nt,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,d.Rw)(r))return(0,d.nf)(n)?c(!1,!0):null;const u=()=>o.createElement(Ne.Z,{component:"div",variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Not exactly what you're looking for?",o.createElement("ul",null,o.createElement("li",null,"Try specifying the repo path or user id(NOT name) to help AI understand your question better. For more tips, check out our FAQ."),o.createElement("li",null,"AI-generated SQL is still a work in progress and may have limitations"),o.createElement("li",null,"If you Find answers in your own data using natural language."))),m=()=>o.createElement(o.Fragment,null,o.createElement(Yn,null,o.createElement(qt,{chartName:"Table",title:"",data:r,fields:a}),o.createElement(zt,null)),u());if((0,d.Rw)(t))return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):null;const g=()=>o.createElement(o.Fragment,null,o.createElement(Yn,null,o.createElement(gn,(0,It.Z)({},t,{data:r,fields:a})),o.createElement(zt,null)),u());return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):"Table"===t.chartName?g():o.createElement(o.Fragment,null,o.createElement(kt.Z,{container:l},o.createElement(Qn,{className:"chart-controls"},o.createElement(Pt.Z,{size:"small",value:i,onChange:s,exclusive:!0,color:"primary"},o.createElement(Mt.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(pn.Z,{fontSize:"small"})),o.createElement(Mt.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(hn.Z,{fontSize:"small"}))))),o.createElement(fn.ZP,{value:i},o.createElement(Kn,{value:"visualization"},g()),o.createElement(Kn,{value:"raw"},m())))}),[i,t,n,r,a])}const On=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? 17.","GitHub accumulates over 4 million new events each day. We synchronize these data in real time.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],Un=["Almost there! Can't wait to see your result!"],qn=["GitHub has an incredible 5+ billion rows of event data waiting for you to explore.","Perhaps AI generates a complex SQL.","Are you curious about the complex SQL generated by AI?"],_n=e=>{let{source:t,interval:n}=e;const[a,r]=(0,o.useState)(0);return(0,vt.Z)((()=>{r((e=>(e+1)%t.length))}),n),o.createElement(yn.Z,{component:Hn},o.createElement(ot,{animated:!1}),o.createElement(bn.Z,{key:a,timeout:400,classNames:"item"},o.createElement(Wn,null,t[a])))},Hn=(0,w.ZP)("span")`
  position: relative;
  display: block;
  min-height: 42px;
  min-width: 1px;
...
`,fa=o.createElement(pa,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Le.Z,null)),Ea=o.createElement(ha,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(ia.Z,{fontSize:"inherit"}));var ya=n(77331),ba=n(27952);function va(){const{question:e}=b(),[t,n]=(0,o.useState)(!1);(0,o.useEffect)((()=>{n(!1)}),[null==e?void 0:e.id]);const a=(0,u.Z)((e=>()=>{e(),n(!0)}));return o.createElement(wa,null,o.createElement(Ve,{variant:"text",n:4,title:(e,t)=>o.createElement(Ne.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(xa,null),"Get inspired",o.createElement(ne.Z,{onClick:a(e),disabled:t},o.createElement(Me.Z,{fontSize:"inherit"})))}),t&&o.createElement(o.Fragment,null,o.createElement(Lt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(Za,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(ya.Z,{color:"inherit"})))))}function xa(){return o.createElement(o.Fragment,null,_e(3).map((e=>o.createElement(Sa,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const wa=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Sa=(0,w.ZP)(ba.Z)`
  vertical-align: text-bottom;
...
`;var Ia=n(5299),Ca=n(63675),Aa=n(30120),Na=n(25425),ka=n(7449);const Ma=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,Ca.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>Aa.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,u.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(Aa.ou.now()))??[Aa.ou.now()])))})),c=(0,S.Z)((()=>{a(!1)}));return(0,ka.h)(t,{show:i}),o.createElement(kt.Z,null,o.createElement(Na.Z,{direction:"left",in:n},o.createElement(Pa,null,o.createElement(La,null),o.createElement(Ra,null),o.createElement(Ta,null,o.createElement(on.Z,null,"\ud83d\udc97 Thank you for enjoying our answers. How about continue to ",o.createElement(Ge.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"explore with your own dataset?")),o.createElement(Fa,{size:"small",onClick:c},o.createElement(re.Z,null))))))})),Pa=(0,w.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
