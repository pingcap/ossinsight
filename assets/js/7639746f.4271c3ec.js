...
`,M=(0,w.ZP)(A)`
  ...
  overflow: hidden;
`;var L=n(98885),P=n(8410);const F=400;function R(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),d=(0,o.useRef)(null),u=(0,o.useRef)(null),m=(0,P.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??32),[null==m?void 0:m.height]);return o.createElement(o.Fragment,null,o.createElement(L.ZP,{nodeRef:s,in:c,timeout:F},(e=>o.createElement(k,{ref:s,className:`Header-${e}`,height:g},n))),o.createElement(T,null,o.createElement(L.ZP,{nodeRef:d,in:i,timeout:F},(e=>o.createElement(G,{ref:d,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:u,in:i,timeout:F,unmountOnExit:!0},(e=>o.createElement(D,{ref:u,className:`Side-${e}`},a)))),o.createElement(B,null,l&&r))}const T=(0,w.ZP)("div",{name:"Container"})`
...
`,k=(0,w.ZP)("div",{name:"Header",shouldForwardProp:e=>"height"!==e})`
  opacity: 0;
  margin-top: -${e=>{let{height:t}=e;return t+32}}px;
  margin-bottom: ${32}px;
  transition: ${e=>{let{theme:t}=e;return t.transitions.create(["margin","opacity"],{duration:F})}};

  ${O("Header",!0)} {
    opacity: 1;
    margin-top: 0;
  }
`,G=(0,w.ZP)("div",{name:"Main"})`
...
`,J=(0,w.ZP)("p")`
  color: #7C7C7C;
  margin: 0;
`;var j=n(80562),ee=n(75345),te=n(9144),ne=n(95537),ae=n(63871),oe=n(89022);function re(e){let{value:t,onChange:n,onAction:a,onClear:r,disableInput:l=!1,disableAction:i=!1,disableClear:c=!1,clearState:s}=e;const d=(0,o.useRef)(null),{isLoading:u,isAuthenticated:g}=(0,m.D3)(),h=(0,S.Z)((e=>{n(e.target.value)})),p=(0,S.Z)((e=>{"Enter"===e.key&&(i||null==a||a())}));return o.createElement(o.Fragment,null,o.createElement(le,{fullWidth:!0,disabled:u&&!g||l,ref:d,value:t,onChange:h,onKeyDown:p,placeholder:"Type any question here, or choose one below",endAdornment:o.createElement(te.Z,{direction:"row",gap:1},!i&&o.createElement(ie,{color:"inherit",onClick:a,disabled:i},o.createElement(ae.Z,null)),o.createElement(ie,{color:"stop"===s?"error":"inherit",onClick:r,disabled:c},"stop"===s?o.createElement(oe.Z,null):o.createElement(ne.Z,null)))}))}const le=(0,w.ZP)(ee.ZP)`
...
`;function ce(e){const{marginTop:t,marginBottom:n}=getComputedStyle(e);return e.offsetHeight+parseFloat(t)+parseFloat(n)}function se(e){let{state:t,transitionDelay:n=0,transitionDuration:a=400,offset:r=120,direction:l="up",revert:i=!1,children:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),[m,g]=(0,o.useState)();(0,o.useEffect)((()=>{if(2!==c.length)throw new Error("SwitchLayout should have exactly two children");if((0,d.Rw)(c[0].key)||(0,d.Rw)(c[1].key))throw new Error("SwitchLayout's children must have keys")}),[]);const h=(0,S.Z)((()=>{(0,d.nf)(s.current)&&g(ce(s.current))})),p=(0,S.Z)((()=>{(0,d.nf)(u.current)&&g(ce(u.current))})),f=(0,S.Z)((()=>{g(void 0)})),E=(0,S.Z)((()=>{(0,d.nf)(u.current)&&g(ce(u.current))})),y=(0,S.Z)((()=>{(0,d.nf)(s.current)&&g(ce(s.current))})),b=(0,S.Z)((()=>{g(void 0)})),v=n+a;return o.createElement(de,{offset:r,style:{height:m},duration:a,delay:n},o.createElement(L.ZP,{key:c[0].key,in:t===c[0].key,timeout:v,unmountOnExit:!0,onExit:h,onExiting:p,onExited:f},(e=>o.createElement(ue,{ref:s,className:`SwitchItem-${l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[0]))),o.createElement(L.ZP,{key:c[1].key,in:t===c[1].key,timeout:v,unmountOnExit:!0,onExit:E,onExiting:y,onExited:b},(e=>o.createElement(ue,{ref:u,className:`SwitchItem-${i?"up"===l?"down":"up":l} SwitchItem-${e}`,duration:a,delay:n,offset:r},c[1]))))}const de=(0,w.ZP)("div",{name:"SwitchLayoutContainer",shouldForwardProp:e=>!["duration","delay","offset"].includes(String(e))})`
  position: relative;
  transition: ${e=>{let{theme:t,duration:n,delay:a}=e;return t.transitions.create("height",{duration:n,delay:a})}};
`,ue=(0,w.ZP)("div",{name:"SwitchItem",shouldForwardProp:e=>!["offset","duration","delay"].includes(String(e))})`
...
`;var me=n(87462),ge=n(36782),he=n(74065),pe=n(47028),fe=n(29618),Ee=n(70754),ye=n(70918),be=n(70983),ve=n(96812),xe=n(6571),we=n(47135),Se=n(19604),Ze=n(29630);function Ce(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Ie=n(54566),Ae=n(21039),Ne=n(23147),Me=n(79072),Le=n(91655),Pe=n(50522),Fe=n(39960);const Re=(0,w.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Te=(0,w.ZP)(Pe.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,ke=(0,w.ZP)(Re,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`;(0,w.ZP)(Te,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,ke.withComponent(Pe.Z),ke.withComponent(Fe.Z);function Ge(e){let{question:t,variant:n="card",disabled:a}=e;const{handleSelect:r}=(0,o.useContext)(Z),l=(0,S.Z)((()=>{"string"==typeof t&&r(t)}));switch(n){case"recommended-card":return o.createElement(Re,null,o.createElement(Te,{onClick:l,disabled:a},t),o.createElement(Be,null,"\u2728"));case"card":return o.createElement(Te,{onClick:l,disabled:a},t);default:return o.createElement(De,{disableRipple:!0,disableTouchRipple:!0,onClick:l,disabled:a},t)}}const De=(0,w.ZP)(Pe.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`,Be=(0,w.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`;var Oe=n(8100);function $e(e){const t=new Array(e);for(let n=0;n<e;n++)t[n]=n;return t}function Ue(e,t){const{data:n,isValidating:a,mutate:r}=(0,Oe.ZP)([e,t,"data-explorer-recommend-question"],{fetcher:async(e,t)=>await async function(e,t){return await i.po.get("/explorer/questions/recommend",{params:{aiGenerated:e,n:t}})}(e,t),shouldRetryOnError:!1,revalidateIfStale:!1,revalidateOnReconnect:!1,revalidateOnFocus:!1});return{data:n,loading:a,reload:(0,o.useMemo)((()=>()=>{r(void 0,{revalidate:!0}).catch(console.error)}),[])}}function ze(e){let{variant:t,disabled:n,questions:a,n:r}=e;const l=0===a.length?(()=>{const e=e=>o.createElement(Ge,{key:e,variant:t,question:"text"===t?o.createElement(Le.Z,{width:"230px"}):o.createElement(o.Fragment,null,o.createElement(Le.Z,{width:"100%"}),o.createElement(Le.Z,{width:"61%"})),disabled:!0});return"text"===t?$e(r).map(e):$e(r).map((t=>o.createElement(Me.ZP,{item:!0,xs:12,md:4,key:t,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t))))})():(()=>{const e=(e,a)=>o.createElement(Ge,{key:a,variant:t,question:e.title,disabled:n});return"text"===t?a.map(e):a.map(((t,n)=>o.createElement(Me.ZP,{item:!0,xs:12,md:4,key:t.hash,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t,n))))})();return"text"===t?o.createElement(v.Z,null,l):o.createElement(Me.ZP,{container:!0,spacing:2},l)}function qe(e){let{aiGenerated:t=!1,n:n,disabled:a=!1,title:r,variant:l}=e;const{data:i=[],reload:c,loading:s}=Ue(t,n);return o.createElement(o.Fragment,null,(null==r?void 0:r(c,s))??null,o.createElement(ze,{n:n,questions:i,disabled:a,variant:l??(t?"recommended-card":"card")}))}function _e(e){let{severity:t,sx:n,children:a,createIssueUrl:r=(()=>Ce("pingcap/ossinsight")),showSuggestions:l}=e;const i=(0,S.Z)((()=>{var e;null==(e=document.getElementById("data-explorer-faq"))||e.scrollIntoView({behavior:"smooth"})})),c=(0,S.Z)((()=>{window.open(r(),"_blank")}));return o.createElement(o.Fragment,null,o.createElement(He,{sx:n,variant:"outlined",severity:t},o.createElement(Ze.Z,{variant:"body1"},a),o.createElement(te.Z,{direction:"row",spacing:2,mt:2},o.createElement(Ve,{onClick:i},o.createElement(Ae.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"See faq")),o.createElement(Ve,{onClick:c},o.createElement(Ne.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"Feedback")))),l&&o.createElement(We,null,o.createElement(qe,{title:(e,t)=>o.createElement(v.Z,{component:"p",m:0,mt:2,height:"40px"},"How about try other questions? ",o.createElement(j.Z,{onClick:e,disabled:t},o.createElement(Ie.Z,null))),n:5,variant:"text"})))}const He=(0,w.ZP)(Se.Z)`
  background: #18191A;
...
`;function Ke(e){void 0===e&&(e="");try{return(0,ge.WU)(e,{language:"mysql"})}catch{return e}}function Qe(){const{question:e}=y(),t=(0,o.useMemo)((()=>()=>Ce("pingcap/ossinsight",{title:`Empty result from question ${(null==e?void 0:e.id)??""}`,labels:"area/data-explorer",body:`\nHi, The result of [question](https://ossinsight.io/explore/?id=${(null==e?void 0:e.id)??""}) is empty\nThe title is: **${(null==e?void 0:e.title)??""}**\n\nGenerated SQL is:\n\`\`\`mysql\n${Ke(null==e?void 0:e.querySQL)}\n\`\`\` \n      `})),[e]);return o.createElement(_e,{severity:"info",createIssueUrl:t,showSuggestions:!0},"This question has no results.")}function Ye(e){let{severity:t,title:n,prompt:a,sx:r,error:l,showSuggestions:i}=e;const{question:c}=y();return o.createElement(_e,{severity:t,sx:r,createIssueUrl:()=>Ce("pingcap/ossinsight",{title:`${n} for question ${(null==c?void 0:c.id)??""}`,body:`\n${a} [question](https://ossinsight.io/explore?id=${(null==c?void 0:c.id)??""})\n\n## Question title\n**${(null==c?void 0:c.title)??""}**\n\n## Error message\n${l}\n${(0,d.nf)(null==c?void 0:c.querySQL)?`\n## Generated SQL\n\`\`\`mysql\n${Ke(null==c?void 0:c.querySQL)}\n\`\`\`\n`:""}\n${(0,d.nf)(null==c?void 0:c.chart)?`\n## Chart info\n\`\`\`json\n${JSON.stringify(null==c?void 0:c.chart,void 0,2)}\n\`\`\`\n`:""}\n`,labels:"area/data-explorer,type/bug"}),showSuggestions:i&&!(0,we.X_)(l,429)},n,": ",l)}function Xe(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:l,errorWithChildren:i=!1,children:c,errorPrompt:s,errorTitle:u}=e;const[m,g]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":g(!1);break;case"error":g(!0)}}),[t]);const h=!0===a,p=(0,S.Z)(((e,t)=>{h||g(t)}));return o.createElement(Je,{className:"pending"===t?"pending":(0,d.Rw)(l)?t:"error",elevation:1},o.createElement(je,{expanded:!!h||m,defaultExpanded:a,elevation:0,onChange:p},o.createElement(et,{alwaysOpen:h,expandIcon:(0,d.X0)(a)&&o.createElement(xe.Z,null),disabled:"loading"===t},o.createElement(tt,null,"loading"===t?o.createElement(Ee.Z,{size:16}):"success"===t&&(0,d.Rw)(l)?o.createElement(be.Z,{color:"success",fontSize:"inherit"}):o.createElement(ve.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(at,null,n),(0,d.N6)(r)?o.createElement(o.Fragment,null,o.createElement(ot,null),o.createElement(nt,null,"auto"===r?m?"Hide":"Show":r)):void 0)),o.createElement(pe.Z,null,i?(0,d.Rw)(l)?c:o.createElement(o.Fragment,null,o.createElement(Ye,{title:u,prompt:s,error:(0,we.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}),c):(0,d.Rw)(l)?c:o.createElement(Ye,{title:u,prompt:s,error:(0,we.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}))))}const Je=(0,w.ZP)(ye.Z)`
...
`,je=(0,w.ZP)(he.Z)`
  ...
  padding: 4px 8px;
`,et=(0,w.ZP)(fe.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
...
`,ot=(0,w.ZP)("span")`
  flex: 1;
`;var rt=n(14850),lt=n(66284);function it(e){return"number"==typeof e?e>=1970&&e<2100:it(Number(e))}function ct(e,t){return e.map((e=>{let n=e[t];return it(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function st(e,t){return(0,d.YN)(t,(e=>!(0,d.Rw)(e)&&(e instanceof Array?e.length>0&&(0,d.YN)(e,d.GC):(0,d.GC)(e))))?e.filter((e=>(0,d.YN)(t,(e=>t=>"string"==typeof t?(0,d.nf)(e[t]):(0,d.YN)(t,(t=>(0,d.nf)(e[t]))))(e)))):[]}var dt=n(60338),ut=n(68023),mt=n(33989),gt=n(31281),ht=n(8690),pt=n(27240),ft=n(76395);(0,ut.D)([mt.N,gt.N,ht.N,pt.N,ft.N]);var Et=n(44731),yt=n(85214),bt=n(81284),vt=n(19594),xt=n(95309),wt=n(61702);function St(e){let{title:t,data:n,columns:a,fields:r}=e;const l=(0,o.useMemo)((()=>(0,d.uW)(a)?a.map((e=>({name:e}))):(0,d.nf)(r)?r:n.length>0?Object.keys(n[0]).map((e=>({name:e}))):[{name:""}]),[n,a,r]);return o.createElement(Zt,null,o.createElement(Ct,{className:"clearTable"},o.createElement("thead",null,(0,d.GC)(t)&&o.createElement("tr",null,o.createElement("th",{colSpan:l.length,align:"center"},t)),o.createElement("tr",null,l.map((e=>{let{name:t}=e;return o.createElement("th",{key:t},t)})))),o.createElement("tbody",null,n.map(((e,t)=>o.createElement("tr",{key:t},l.map((t=>{let{name:n}=t;return o.createElement("td",{key:n},e[n])}))))))))}const Zt=(0,w.ZP)("div")`
  overflow: scroll;
`,Ct=(0,w.ZP)("table")`
  font-size: 12px;
  display: table;
  min-width: 100%;
`;var It=n(49837),At=n(91359),Nt=n(45344);var Mt=n(74446),Lt=n(75559),Pt=n(40172);const Ft=(0,w.ZP)("div")`
  height: 100%;
`;function Rt(e){let{title:t}=e;const{question:n}=y(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return Ce("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(_e,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const Tt={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=/date|time|year|month/.test(a);l=e?ct(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(lt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=/date|time|year|month/.test(a);l=e?ct(l,a):l;const t=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:a,y:e}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(lt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(dt.ZP,{height:400,option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(yt.Z,null,r.map(((e,t)=>o.createElement(bt.ZP,{key:t},o.createElement(xt.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(vt.Z,null,o.createElement(Et.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(wt.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(yt.Z,null,r.map(((e,t)=>o.createElement(bt.ZP,{key:t},o.createElement(xt.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(vt.Z,null,o.createElement(Et.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(wt.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:St,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if((0,d.N6)(a)){if(1===l.length&&(0,d.Rw)(l[0][a])){const e=l[0][r];return o.createElement(It.Z,null,o.createElement(At.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Ze.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},n),(0,d.z0)(e)?o.createElement(Nt.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return o.createElement(o.Fragment,null,o.createElement(Ze.Z,{variant:"h4"},n),o.createElement(Me.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Me.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(It.Z,{sx:{p:2}},o.createElement(Ze.Z,{variant:"subtitle1"},e[a]),o.createElement(Ze.Z,{variant:"body2",color:"#7c7c7c"},e[r])))))))}return o.createElement(yt.Z,null,l.map(((e,t)=>o.createElement(bt.ZP,{key:t},o.createElement(It.Z,{sx:{p:4}},o.createElement(wt.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),u=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,Mt.$)(e[t]),{long:o,lat:r}=(0,Mt.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,d.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=u[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,Lt.Mm)(),dataset:[{id:"top1",source:u.slice(0,1)},{id:"rest",source:u.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=u[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,u]);return(0,o.useEffect)((()=>{if((0,d.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(Pt.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(Ft,{ref:c},o.createElement(lt.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function kt(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=Tt[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,Oe.wE)(e)]),a=st(e.data,n);let r,l;return(0,d.Rw)(t)&&(r=o.createElement(Rt,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(Qe,null):a.length>0?(0,d.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(Rt,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var Gt=n(44373),Dt=n(78385),Bt=n(87054),Ot=n(85390),$t=n(45670),Ut=n(55050),zt=n(91693),qt=n(96942),_t=n(36804),Ht=n(88784);function Wt(e){let{children:t}=e;return o.createElement(Ht.Z,{title:t},o.createElement(j.Z,null,o.createElement(_t.Z,{fontSize:"inherit"})))}var Vt=n(1969),Kt=n(64232);function Qt(e){return o.createElement(Yt,(0,me.Z)({target:"_blank"},e),"Share",o.createElement(Xt,null))}const Yt=(0,w.ZP)("a")`
  display: inline-flex;
  align-items: center;
  opacity: 0.8;
...
`,Xt=(0,w.ZP)(Kt.Z)`
  margin-left: 4px;
  color: #1D9BF0;
`;function Jt(e){let{align:t="left",sx:n}=e;return o.createElement(jt,{align:t,sx:n},"Powered by ",o.createElement("a",{href:"https://openai.com/",target:"_blank",rel:"noreferrer"},"OpenAI")," & ",o.createElement("a",{href:"https://www.pingcap.com/tidb-cloud/",target:"_blank",rel:"noreferrer"},"TiDB Cloud"))}const jt=(0,w.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`;function en(e){var t,n;let{search:a}=e;const{question:r,error:l,phase:i}=y(),[c,s]=(0,o.useState)(null),u=(0,o.useMemo)((()=>{try{if((0,d.nf)(r))return(0,ge.WU)(r.querySQL,{language:"mysql"});var e;if(function(e){return!!((0,we.IZ)(e)&&(0,d.nf)(e.response)&&(0,d.nf)(e.response.data))&&"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL}(l))return(0,ge.WU)((null==(e=l.response)?void 0:e.data.querySQL)??"",{language:"mysql"})}catch(t){return(null==r?void 0:r.querySQL)??""}}),[r,l]),m=(0,o.useMemo)((()=>{switch(i){case g.NONE:return"pending";case g.LOADING:case g.CREATING:return"loading";case g.GENERATE_SQL_FAILED:case g.LOAD_FAILED:case g.CREATE_FAILED:return"error";default:return"success"}}),[i]),h=(0,o.useMemo)((()=>{switch(i){case g.NONE:return"";case g.LOADING:return"Loading question...";case g.CREATING:return"Generating SQL...";case g.LOAD_FAILED:return"Question not found";case g.GENERATE_SQL_FAILED:case g.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[i]),p=null==r||null==(t=r.result)?void 0:t.rows,f=(0,o.useMemo)((()=>{switch(i){case g.CREATED:case g.QUEUEING:case g.EXECUTING:return"loading";case g.EXECUTE_FAILED:case g.VISUALIZE_FAILED:case g.UNKNOWN_ERROR:return"error";case g.READY:return"success";default:return"pending"}}),[i]),E=(0,o.useMemo)((()=>{var e;switch(i){case g.CREATED:return"Pending...";case g.QUEUEING:return`Waiting execution in queue (currently in position ${(null==r?void 0:r.queuePreceding)??NaN})...`;case g.EXECUTING:return"Running SQL...";case g.EXECUTE_FAILED:return"Failed to execute SQL";case g.UNKNOWN_ERROR:return"Unknown error";case g.VISUALIZE_FAILED:case g.READY:return o.createElement(o.Fragment,null,`${(null==r||null==(e=r.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==r?void 0:r.spent)??"NaN"} seconds`,function(e){if((0,d.nf)(e)&&!(0,d.yD)(e.engines))return o.createElement(o.Fragment,null,", Running on",o.createElement(nn,null,e.engines.map(tn).join(", ")),o.createElement(Wt,null,o.createElement(Ze.Z,{variant:"body1"},o.createElement("b",null,"tikv"),": row storage engine",o.createElement("br",null),o.createElement("b",null,"tiflash"),": columnar storage engine"),o.createElement(Gt.Z,{orientation:"horizontal",sx:{my:1.5},light:!0}),o.createElement(Ze.Z,{variant:"body2"},"Intelligent query processing in ",o.createElement("a",null,"TiDB optimizer"),".")));return null}(r));default:return"pending"}}),[r,i]),b=(0,o.useMemo)((()=>{if((0,d.Rw)(r))return(0,Vt.PE)(location.href,{title:"OSSInsight Data Explorer",hashtags:["OpenSource","OpenAI","TiDBCloud"]});let e;return e="undefined"==typeof location?(0,d.GC)(r.id)?`https://ossinsight.io/explore?id=${r.id}`:"https://ossinsight.io/explore":(0,Vt.PE)(location.href,{title:`${a} | OSSInsight Data Explorer\n`,hashtags:["OpenSource","OpenAI","TiDBCloud"]}),e}),[r,a]),v=(0,o.useMemo)((()=>{if("error"===m)return l}),[m,l]),x=(0,o.useMemo)((()=>{if("error"===f)return l}),[f,l]),w=(0,o.useMemo)((()=>{if(i===g.VISUALIZE_FAILED)return l}),[i,l]);return o.createElement(o.Fragment,null,o.createElement(Xe,{status:m,title:h,extra:"auto",error:v,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for"},(0,d.N6)(u)&&o.createElement(rt.Z,{language:"sql"},u)),o.createElement(Xe,{status:f,title:E,extra:o.createElement(rn,null,o.createElement("span",{ref:s}),o.createElement(Qt,{href:b})),error:x,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},o.createElement(an,{chartData:(null==r?void 0:r.chart)??void 0,chartError:w,result:p,fields:null==r||null==(n=r.result)?void 0:n.fields,controlsContainer:c})),i===g.READY&&o.createElement(Jt,{sx:{mt:2}}))}function tn(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const nn=(0,w.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function an(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization");(0,o.useEffect)((()=>{c("visualization")}),[t]);const s=(e,t)=>{(0,d.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,we.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(Ye,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,d.Rw)(r))return(0,d.nf)(n)?c(!1,!0):null;const u=()=>o.createElement(Ze.Z,{variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Confused with this answer? Try to tiny your words and help the AI identify your question, for example, you can try to use \u2018@repo_name/user_name\u2019 to narrow down your query. If you have more questions about the accuracy of the answers, see FAQ here."),m=()=>o.createElement(o.Fragment,null,o.createElement(St,{chartName:"Table",title:"",data:r,fields:a}),u());if((0,d.Rw)(t))return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):null;const g=()=>o.createElement(o.Fragment,null,o.createElement(kt,(0,me.Z)({},t,{data:r,fields:a})),u());return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):"Table"===t.chartName?g():o.createElement(o.Fragment,null,o.createElement(Dt.Z,{container:l},o.createElement(on,{className:"chart-controls"},o.createElement(Ot.Z,{size:"small",value:i,onChange:s,exclusive:!0,color:"primary"},o.createElement(Bt.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(zt.Z,{fontSize:"small"})),o.createElement(Bt.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(qt.Z,{fontSize:"small"}))))),o.createElement($t.ZP,{value:i},o.createElement(ln,{value:"visualization"},g()),o.createElement(ln,{value:"raw"},m())))}),[i,t,n,r,a])}const on=(0,w.ZP)("div")`
  display: inline-flex;
...
`,Cn=o.createElement(Sn,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Ne.Z,null)),In=o.createElement(Zn,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(Kt.Z,{fontSize:"inherit"}));var An=n(27952),Nn=n(5299);function Mn(){return o.createElement(Pn,null,o.createElement(qe,{variant:"text",n:4,title:(e,t)=>o.createElement(Ze.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(Ln,null),"Get inspired",o.createElement(j.Z,{onClick:e,disabled:t},o.createElement(Ie.Z,{fontSize:"inherit"})))}),o.createElement(Gt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(v.Z,null,o.createElement(Rn,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(Nn.Z,{color:"inherit"})),o.createElement(Tn,null,"Get hands-on with your data Get hands-on with your data")))}function Ln(){return o.createElement(o.Fragment,null,$e(3).map((e=>o.createElement(Fn,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const Pn=(0,w.ZP)("div")`
  position: sticky;
  top: 92px;
`,Fn=(0,w.ZP)(An.Z)`
  vertical-align: text-bottom;
...
`,Tn=(0,w.ZP)("p")`
  margin-top: 8px;
  font-size: 12px;
`;function kn(){var e;const{question:t,loading:n,load:a,error:r,phase:l,reset:i,create:c}=f({pollInterval:2e3}),[s,u]=(0,b.ZP)("id",(0,b.Rc)(),!0),[m,p]=(0,o.useState)(""),y=!h.has(l),w=y||(0,d.oM)(m),I=(0,d.Rw)(null==t?void 0:t.id)&&!n,A=((null==t||null==(e=t.result)?void 0:e.rows.length)??0)>0;(0,o.useEffect)((()=>{(0,d.nf)(t)&&p(t.title)}),[null==t?void 0:t.title]),(0,o.useEffect)((()=>{(0,d.nf)(s)?a(s):M()}),[s]),(0,o.useEffect)((()=>{(0,d.nf)(null==t?void 0:t.id)&&u(null==t?void 0:t.id)}),[n,null==t?void 0:t.id]);const N=(0,S.Z)((()=>{y||c(m)})),M=(0,S.Z)((()=>{i(),p(""),u(void 0)})),L=(0,S.Z)((e=>{p(e),c(e)}));return o.createElement(E.Provider,{value:{phase:l,question:t,loading:n,error:r,create:c,load:a,reset:i}},o.createElement(Z.Provider,{value:{handleSelect:L}},o.createElement(C,null),o.createElement(x.Z,{maxWidth:"xl",sx:{pt:4}},o.createElement(R,{showSide:!I&&l===g.READY&&A,showHeader:I,showFooter:I,header:o.createElement(V,null),side:o.createElement(Mn,null),footer:o.createElement(v.Z,{mt:2},o.createElement(Jt,{align:"center"}),o.createElement(Gn,{to:"/blog/chat2query-tutorials",target:"_blank"},"\ud83e\uddd0 GitHub data is just the beginning. Uncover hidden insights in your OWN data!",o.createElement(Nn.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})))},o.createElement(re,{value:m,onChange:p,onAction:N,disableInput:y,disableClear:""===m,disableAction:w,onClear:M,clearState:y?"stop":void 0}),o.createElement(se,{state:I?"recommend":"execution",direction:I?"down":"up"},o.createElement(v.Z,{key:"execution",sx:{mt:1.5}},o.createElement(en,{search:m})),o.createElement(v.Z,{key:"recommend",sx:{mt:4}},o.createElement(cn,null))))),o.createElement(x.Z,{maxWidth:"lg",sx:{pb:8}},o.createElement(En,null))))}const Gn=(0,w.ZP)(Fe.Z)`
  display: block;
  text-align: center;
  color: white !important;
  text-decoration: none !important;
