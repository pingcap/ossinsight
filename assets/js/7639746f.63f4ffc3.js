...
`;var Se=n(14850),Ze=n(74065),Ce=n(47028),Ie=n(21945),Ae=n(70795),ke=n(70918),Ne=n(70983),Pe=n(96812),Me=n(6571),Te=n(47135),Le=n(19604),Fe=n(29630);function Re(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var Ge=n(54566),$e=n(21039),De=n(23147),qe=n(79072),Be=n(91655),ze=n(41796),Oe=n(50522),Ue=n(39960);const He=(0,S.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,_e=(0,S.ZP)(Oe.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.5;
  color: white;
...
`;function St(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:i,errorWithChildren:c=!1,errorMessage:s,children:u,errorPrompt:d,errorTitle:m,icon:g="default"}=e;const[p,h]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":h(!1);break;case"error":h(!0)}}),[t]);const f=(0,Z.Z)(((e,t)=>{E||h(t)})),E=!0===a,y=(0,l.N6)(r)&&"success"===t;return o.createElement(Zt,{className:"pending"===t?"pending":(0,l.Rw)(i)?t:"error",elevation:1},o.createElement(Ct,{expanded:!!E||p,defaultExpanded:a,elevation:0,onChange:f},o.createElement(It,{alwaysOpen:E,expandIcon:(0,l.X0)(a)&&"success"===t&&o.createElement(Me.Z,null),disabled:"loading"===t},o.createElement(At,null,"loading"===t?"bot"===g?o.createElement(pt,null):o.createElement(vt,{size:12}):"success"===t&&(0,l.Rw)(i)?o.createElement(Ne.Z,{color:"success",fontSize:"inherit"}):o.createElement(Pe.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(Nt,null,n),y&&o.createElement(o.Fragment,null,o.createElement(Pt,null),o.createElement(kt,null,"auto"===r?p?"Hide":"Show":r)))),o.createElement(Ce.Z,null,c?(0,l.Rw)(i)?u:o.createElement(o.Fragment,null,o.createElement(mt,{title:m,prompt:d,error:(0,Te.e$)(i),severity:"error",sx:{mb:1},showSuggestions:!0},s),u):(0,l.Rw)(i)?u:o.createElement(mt,{title:m,prompt:d,error:(0,Te.e$)(i),severity:"error",sx:{mb:1},showSuggestions:!0},s))))}const Zt=(0,S.ZP)(ke.Z)`
...
`,Ct=(0,S.ZP)(Ze.Z)`
  ...
  padding: 4px 8px;
`,It=(0,S.ZP)(Ie.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
  &.${Ae.Z.content} {
    margin-top: 4px;
    margin-bottom: 4px;
  }
...
`;function Wa(){return o.createElement(Va,null,o.createElement(at,{variant:"text",n:4,title:(e,t)=>o.createElement(Fe.Z,{variant:"h3",mb:0,fontSize:16},"\ud83d\udca1 Get inspired",o.createElement(oe.Z,{onClick:e,disabled:t},o.createElement(Ge.Z,{fontSize:"inherit"})))}),o.createElement(Ka,{to:"/explore/"},"> See more"),o.createElement(Ut.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(Da,{size:"small"}))}const Va=(0,S.ZP)("div")`
  position: sticky;
  top: 92px;
`,Ka=(0,S.ZP)(Ue.Z)`
  font-size: 14px;
`;var ja=n(63675),Ya=n(25425),Xa=n(7449);const Ja=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,ja.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>yn.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,d.Z)((()=>{})),c=(0,Z.Z)((()=>{a(!1)}));return(0,Xa.h)(t,{show:i}),o.createElement(Ht.Z,null,o.createElement(Ya.Z,{direction:"left",in:n},o.createElement(eo,null,o.createElement(to,null),o.createElement(no,null),o.createElement(ao,null,o.createElement(un.Z,null,"Glad you enjoy the exploration \ud83d\ude03 Try ",o.createElement(ve,null,"Chat2Query")," to empower your own data exploration."),o.createElement(oo,{size:"small",onClick:c},o.createElement(ie.Z,null))))))})),eo=(0,S.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
...
`,oo=(0,S.ZP)(oe.Z)`
  ...
  right: 8px;
  top: 8px;
`;function ro(e){let{onChange:t,value:n}=e;const{data:a=[]}=(0,Xe.ZP)("explore-tags",{fetcher:u,revalidateOnFocus:!1,revalidateOnReconnect:!1});return o.createElement(co,null,o.createElement(le.Z,{direction:"row",spacing:2,flexWrap:"nowrap",width:"max-content"},o.createElement(io,{color:"#ccc",className:(0,bt.Z)({[lo.active]:null==n}),onClick:e=>{null==t||t(e,null)}},"All"),o.createElement(Ut.Z,{orientation:"vertical",flexItem:!0}),a.map((e=>o.createElement(io,{key:e.id,color:e.color,className:(0,bt.Z)({[lo.active]:e.id===(null==n?void 0:n.id)}),onClick:n=>{null==t||t(n,e)}},e.label)))))}const lo=(0,Et.Z)("TagItem",["active"]),io=(0,S.ZP)("span",{shouldForwardProp:e=>"color"!==e})`
  display: inline-block;
  color: ${e=>{let{color:t}=e;return t}};
  background-color: ${e=>{let{color:t}=e;return(0,ze.Fq)(t,.1)}};
  border: 1px solid ${e=>{let{color:t}=e;return(0,ze.Fq)(t,.3)}};
