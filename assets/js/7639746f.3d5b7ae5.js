...
`;var k=n(19604),T=n(80562),N=n(69243),L=n(26432),F=n(96406);function P(e){let{content:t}=e;const[n,a]=(0,r.useState)(!1),o=(0,L.Z)((()=>{a(!1)})),i=(0,L.Z)((()=>{if((0,l.N6)(t)){if(t.includes("<b>")){const e=document.createElement("div");e.innerHTML=t,t=e.innerText}navigator.clipboard.writeText(t).catch(console.error),a(!0)}}));return r.createElement(r.Fragment,null,r.createElement(T.Z,{size:"small",onClick:i,sx:{ml:.5}},r.createElement(F.Z,{fontSize:"inherit"})),r.createElement(N.Z,{anchorOrigin:{vertical:"top",horizontal:"center"},open:n,onClose:o,autoHideDuration:3e3},r.createElement(k.Z,{severity:"info",onClose:o,sx:{width:"100%"}},"Copied!")))}function R(e,t){if("undefined"==typeof localStorage)return t;const n=localStorage.getItem(`ossinsight.explore.ai-message.${e}`);return n?parseInt(n):t}R("duration",600),R("delay",1800),R("sub-extra-delay",1200),i.Error,i.Cancel,i.Success,i.Summarizing,y.Z;function M(e){return e.flatMap((e=>[", ",e])).slice(1)}function G(e){return e.replace(/^No\s*\d+(:|.)?\s*/i,"")}function q(e,t){return"number"==typeof t?t:!0===e?t.enter??0:t.exit??0}(0,x.ZP)(b.Z,{shouldForwardProp:e=>"delay"!==e})`
...
`,Pe=(0,x.ZP)("img")`
  ...
  position: relative;
  top: -2px;
`;function Re(){const e=(0,Te.Z)(),{inView:t,ref:n}=(0,Ne.YD)(),a=(0,ke.Ox)(t&&e);return r.createElement(qe,null,r.createElement(De,null,r.createElement(Ge,null,r.createElement("span",{className:"nav-explore-icon"})),r.createElement(_e,null,"GitHub Data Explorer"),r.createElement(Me,null)),r.createElement($e,{ref:n},(e=>r.createElement(r.Fragment,null,"Explore ",r.createElement(Fe,{color:"#9197D0"},r.createElement(ze,{value:e,hasComma:!0,size:18}))," GitHub data with no SQL or plotting skills. Powered by ",r.createElement(Pe,{height:"16",alt:"tidb cloud logo",src:"/img/tidb-cloud-logo-t.svg"})))(a)))}const Me=(0,x.ZP)(Ie)`
  margin-left: 8px;
`,Ge=(0,x.ZP)("span")`
  display: inline-flex;
  width: 36px;
...
`;(0,x.ZP)(Tt,{name:"HighlightButton-Content"})`
  ...
  padding: 8px;
  max-width: max-content;
`,Nt.withComponent(It.Z),Nt.withComponent(ut.Z);function Lt(e){let{question:t,questionId:n,variant:a="card",imageUrl:o,prefix:i,tags:c,disabled:s}=e;const{gtagEvent:u}=(0,g.u)(),{handleSelect:d,handleSelectId:m}=(0,r.useContext)(oe),h=(0,L.Z)((()=>{u("click_template_question",{questionId:n??"",questionTitle:Gt(t)}),(0,l.GC)(n)?m(n):"string"==typeof t&&d(t)}));switch(a){case"recommended-card":return r.createElement(kt,null,r.createElement(Tt,{onClick:h,disabled:s},t),r.createElement(Pt,null,"\u2728"));case"card":return r.createElement(Tt,{onClick:h,disabled:s},t,null==c?void 0:c.map((e=>r.createElement(Rt,{key:e.id,color:e.color},e.label))),o&&r.createElement(Mt,{src:o,alt:"preview image"}));default:return r.createElement(Ft,{disableRipple:!0,disableTouchRipple:!0,onClick:h,disabled:s},i,t,null==c?void 0:c.map((e=>r.createElement(Rt,{key:e.id,color:e.color},e.label))))}}const Ft=(0,x.ZP)(It.Z,{name:"QuestionCard-Link"})`
  display: block;
  width: 100%;
  text-align: left;
  padding: 8px 0;
...
`,Pt=(0,x.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`,Rt=(0,x.ZP)("span",{shouldForwardProp:e=>"color"!==e})`
  display: inline-block;
  color: ${e=>{let{color:t}=e;return t}};
...
`,Ar=(0,x.ZP)("div")`
  position: relative;
`;var Cr=n(45989);const Ir=[["#FFBCA7",2.21],["#DAA3D8",30.93],["#B587FF",67.95],["#6B7AFF",103.3]],kr=e=>{let{size:t,sx:a}=e;return r.createElement(r.Fragment,null,r.createElement(gt,{as:Nr,sx:a,stops:Ir,deg:90,content:"result_bottom"},r.createElement(Tr,null,"Try other dataset"),r.createElement(Lr,null,r.createElement(Fr,null,r.createElement(Kt,null)),"Import NOW!"),r.createElement(Pr,{width:"304",src:n(74040).Z,alt:"image"}),r.createElement(Rr,null),r.createElement(Gr,null,"Chat2Query on",r.createElement(Mr,{src:"/img/tidb-cloud-logo-o.png",alt:"TiDB Cloud Logo"}))))},Tr=(0,x.ZP)("div")`
  font-style: normal;
  font-weight: 600;
  font-size: 32px;
  line-height: 150.02%;
