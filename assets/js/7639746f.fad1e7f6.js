...
`,Tt=r.createElement(It,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},r.createElement(gt.Z,null)),Lt=r.createElement(kt,{href:"https://twitter.com/OSSInsight",target:"_blank"},r.createElement(pt.Z,{fontSize:"inherit"}));var Nt=n(79072),Ft=n(91655),Pt=n(50522);const Rt=(0,x.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,Mt=(0,x.ZP)(Pt.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.5;
  color: white;
...
`,qt=(0,x.ZP)(Rt,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
...
`;(0,x.ZP)(Mt,{name:"HighlightButton-Content"})`
  ...
  padding: 8px;
  max-width: max-content;
`,qt.withComponent(Pt.Z),qt.withComponent(Et.Z);function Gt(e){let{question:t,questionId:n,variant:a="card",imageUrl:o,prefix:i,tags:c,disabled:s}=e;const{gtagEvent:u}=(0,g.u)(),{handleSelect:d,handleSelectId:m}=(0,r.useContext)(de),h=(0,N.Z)((()=>{u("click_template_question",{questionId:n??"",questionTitle:zt(t)}),(0,l.GC)(n)?m(n):"string"==typeof t&&d(t)}));switch(a){case"recommended-card":return r.createElement(Rt,null,r.createElement(Mt,{onClick:h,disabled:s},t),r.createElement(_t,null,"\u2728"));case"card":return r.createElement(Mt,{onClick:h,disabled:s},t,null==c?void 0:c.map((e=>r.createElement($t,{key:e.id,color:e.color},e.label))),o&&r.createElement(Ot,{src:o,alt:"preview image"}));default:return r.createElement(Dt,{disableRipple:!0,disableTouchRipple:!0,onClick:h,disabled:s},i,t,null==c?void 0:c.map((e=>r.createElement($t,{key:e.id,color:e.color},e.label))))}}const Dt=(0,x.ZP)(Pt.Z,{name:"QuestionCard-Link"})`
  display: block;
  width: 100%;
  text-align: left;
  padding: 8px 0;
...
`,Fa=(0,x.ZP)("table")`
  ...
  min-width: 100%;
  text-align: center;
`;var Pa=n(49837),Ra=n(91359);const Ma=(0,x.ZP)("span")`
  font-size: 16px;
  opacity: 0.3;
  margin-left: 4px;
`,qa=(0,x.ZP)("table")`
...
`;function lr(){const{question:e}=le();return"error"!==(null==e?void 0:e.status)&&"cancel"!==(null==e?void 0:e.status)?r.createElement(r.Fragment,null):e.errorType===c.QUERY_TIMEOUT?r.createElement(at.Z,{variant:"body1"},"Whoops! Query timed out. SQL may be too complex or incorrect.",r.createElement("br",null),"Optimize your question for effective SQL, or get ideas from ",r.createElement(Et.Z,{to:"/explore/"},"popular questions"),"."):r.createElement(at.Z,{variant:"body1"},"Oops, something wrong with the SQL query. SQL may be too complex or incorrect.",r.createElement("br",null),"Optimize your question for effective SQL, or get ideas from ",r.createElement(Et.Z,{to:"/explore/"},"popular questions"),".")}var ir=n(1890),cr=n(18661),sr=n(62348);function ur(e){let{question:t,open:n,onOpenChange:a}=e;const[o,l]=(0,r.useState)("plan"),i=(0,N.Z)((()=>{null==a||a(!1)})),c=(0,N.Z)(((e,t)=>{l("plan"===t?"plan":"sql")})),s=(0,r.useMemo)((()=>{try{return(0,Nn.WU)((null==t?void 0:t.querySQL)??"",{language:"mysql"})}catch{return(null==t?void 0:t.querySQL)??""}}),[null==t?void 0:t.querySQL]);return r.createElement(ir.Z,{open:n,onClose:i,maxWidth:"xl",fullWidth:!0},r.createElement(sr.Z,{onChange:c,value:o,sx:{mb:2}},r.createElement(cr.Z,{label:"Execution Plan",value:"plan"}),r.createElement(cr.Z,{label:"SQL",value:"sql"})),r.createElement(y.Z,{px:2},(()=>{if("plan"===o){var e;const n=["id","estRows","task","access object","operator info"];return r.createElement(y.Z,{sx:{overflowX:"scroll",color:"rgb(248, 248, 242)",backgroundColor:"rgb(40, 42, 54)",borderRadius:2,py:2},mb:2},r.createElement(y.Z,{display:"table",fontFamily:"monospace",fontSize:16,lineHeight:1,sx:{borderSpacing:"16px 0"}},r.createElement(y.Z,{display:"table-header-group"},r.createElement(y.Z,{display:"table-row"},n.map((e=>r.createElement(y.Z,{key:e,display:"table-cell"},e))))),r.createElement(y.Z,{display:"table-footer-group"},null==t||null==(e=t.plan)?void 0:e.map(((e,t)=>r.createElement(y.Z,{key:t,display:"table-row"},n.map((t=>r.createElement(y.Z,{key:t,display:"table-cell",whiteSpace:"pre"},e[t])))))))))}return r.createElement(xn.Z,{className:"language-sql"},s)})()))}function dr(e){let{question:t,children:n}=e;const[a,o]=(0,r.useState)(!1),l=(0,N.Z)((()=>{o(!0)}));return r.createElement(r.Fragment,null,r.createElement(Jn.Z,{variant:"text",size:"small",sx:{ml:1},onClick:l},n),r.createElement(ur,{open:a,onOpenChange:o,question:t}))}(0,x.ZP)(Pa.Z)`
...
`,Dr=(0,x.ZP)("div")`
  position: relative;
`;var _r=n(45989);const $r=[["#FFBCA7",2.21],["#DAA3D8",30.93],["#B587FF",67.95],["#6B7AFF",103.3]],Or=e=>{let{size:t,sx:a}=e;return r.createElement(r.Fragment,null,r.createElement(bt,{as:Br,sx:a,stops:$r,deg:90,content:"result_bottom"},r.createElement(zr,null,"Try other dataset"),r.createElement(Ur,null,r.createElement(Qr,null,r.createElement(nn,null)),"Import NOW!"),r.createElement(Hr,{width:"304",src:n(74040).Z,alt:"image"}),r.createElement(Vr,null),r.createElement(Kr,null,"Chat2Query on",r.createElement(Wr,{src:"/img/tidb-cloud-logo-o.png",alt:"TiDB Cloud Logo"}))))},zr=(0,x.ZP)("div")`
  font-style: normal;
  font-weight: 600;
  font-size: 32px;
  line-height: 150.02%;
...
`,Co=(0,x.ZP)("div")`
  ...
  margin-top: 12px;
  vertical-align: middle;
`,Io=(0,r.forwardRef)(((e,t)=>r.createElement(ko,(0,rn.Z)({ref:t},e),r.createElement(jt.Z,{sx:{my:2}},"Get to know our data inside and out"),r.createElement(To,null,r.createElement(xo,null),r.createElement(Or,null))))),ko=(0,x.ZP)("section")`
  margin-top: 16px;
