...
`,Tt=r.createElement(It,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},r.createElement(gt.Z,null)),Lt=r.createElement(kt,{href:"https://twitter.com/OSSInsight",target:"_blank"},r.createElement(pt.Z,{fontSize:"inherit"}));var Nt=n(86886),Ft=n(88078),Rt=n(49990);const Pt=(0,x.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
...
`,Fa=(0,x.ZP)("table")`
  ...
  min-width: 100%;
  text-align: center;
`;var Ra=n(66242),Pa=n(44267);const Ma=(0,x.ZP)("span")`
  font-size: 16px;
  opacity: 0.3;
  margin-left: 4px;
`,qa=(0,x.ZP)("table")`
