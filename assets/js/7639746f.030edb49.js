...
`;(0,w.ZP)($e,{name:"HighlightButton-Content"})`
  ...
  padding: 8px;
  max-width: max-content;
`,Be.withComponent(Ge.Z),Be.withComponent(Fe.Z);function ze(e){let{question:t,questionId:n,variant:a="card",prefix:r,disabled:l}=e;const{handleSelect:i,handleSelectId:c}=(0,o.useContext)(Z),s=(0,S.Z)((()=>{(0,d.GC)(n)?c(n):"string"==typeof t&&i(t)}));switch(a){case"recommended-card":return o.createElement(De,null,o.createElement($e,{onClick:s,disabled:l},t),o.createElement(Ue,null,"\u2728"));case"card":return o.createElement($e,{onClick:s,disabled:l},t);default:return o.createElement(Oe,{disableRipple:!0,disableTouchRipple:!0,onClick:s,disabled:l},r,t)}}const Oe=(0,w.ZP)(Ge.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
