...
`,Ee=(0,x.ZP)(ge)`
  ...
  overflow: hidden;
`;var fe=n(65582),ve=n(99200),ye=n(98885),be=n(93580);const xe=400;function Ze(e){let{children:t,header:n,side:a,showSide:o,showHeader:l}=e;const i=(0,r.useRef)(null),c=(0,be.Z)(i),s=(0,r.useMemo)((()=>(null==c?void 0:c.height)??0),[null==c?void 0:c.height]);return r.createElement(we,{maxWidth:"xl"},r.createElement(ye.ZP,{in:l,timeout:xe},(e=>r.createElement(r.Fragment,null,r.createElement(Ae,{ref:i,className:`Header-${e}`,height:s},n),r.createElement(Se,{className:`Body-header-${e}`,headerHeight:s},r.createElement(ve.Z,null,r.createElement(ye.ZP,{in:o,timeout:xe},(e=>r.createElement(Ce,{className:`Main-side-${e}`},t)))),r.createElement(ye.ZP,{in:o,timeout:xe,unmountOnExit:!0},(e=>r.createElement(Ie,{className:`Side-${e}`},function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),a=1;a<t;a++)n[a-1]=arguments[a];return e instanceof Function?e(...n):e}(a,(null==c?void 0:c.height)??0)))))))))}const we=(0,x.ZP)(fe.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,Tt=r.createElement(It,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},r.createElement(gt.Z,null)),Lt=r.createElement(kt,{href:"https://twitter.com/OSSInsight",target:"_blank"},r.createElement(pt.Z,{fontSize:"inherit"}));var Nt=n(86886),Ft=n(88078),Pt=n(49990);const Rt=(0,x.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
...
`,Fa=(0,x.ZP)("table")`
  ...
  min-width: 100%;
  text-align: center;
`;var Pa=n(66242),Ra=n(44267);const Ma=(0,x.ZP)("span")`
  font-size: 16px;
  opacity: 0.3;
  margin-left: 4px;
`,qa=(0,x.ZP)("table")`
