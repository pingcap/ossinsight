...
`,P=(0,S.ZP)(M)`
  ...
  overflow: hidden;
`;var L=n(98885),R=n(93580);const T=400;function G(e){let{children:t,header:n,side:a,footer:r,showFooter:l,showSide:i,showHeader:c}=e;const s=(0,o.useRef)(null),u=(0,o.useRef)(null),d=(0,o.useRef)(null),m=(0,R.Z)(s),g=(0,o.useMemo)((()=>(null==m?void 0:m.height)??0),[null==m?void 0:m.height]);return o.createElement(F,{maxWidth:"xl"},o.createElement(L.ZP,{nodeRef:s,in:c,timeout:T},(e=>o.createElement(o.Fragment,null,o.createElement($,{ref:s,className:`Header-${e}`,height:g},n),o.createElement(D,{className:`Body-header-${e}`,headerHeight:g},o.createElement(L.ZP,{nodeRef:u,in:i,timeout:T},(e=>o.createElement(B,{ref:u,className:`Main-side-${e}`},t))),o.createElement(L.ZP,{nodeRef:d,in:i,timeout:T,unmountOnExit:!0},(e=>o.createElement(z,{ref:d,className:`Side-${e}`},a))))))),o.createElement(O,null,l&&r))}const F=(0,S.ZP)(w.Z,{name:"Layout-Root"})`
  padding-top: 64px;
...
`,$=(0,S.ZP)("div",{name:"Layout-Header",shouldForwardProp:e=>"height"!==e})`
  opacity: 0.1;
...
`,te=(0,S.ZP)("p")`
  color: #7C7C7C;
  margin: 0;
`;var ne=n(80562),ae=n(75345),oe=n(9144),re=n(95537),le=n(63871),ie=n(89022);function ce(e){let{value:t,onChange:n,onAction:a,onClear:r,disableInput:l=!1,disableAction:i=!1,disableClear:c=!1,clearState:s}=e;const u=(0,o.useRef)(null),{isLoading:d,isAuthenticated:m}=(0,g.D3)(),h=(0,Z.Z)((e=>{n(e.target.value)})),p=(0,Z.Z)((e=>{"Enter"===e.key&&(i||null==a||a())}));return o.createElement(o.Fragment,null,o.createElement(se,{fullWidth:!0,disabled:d&&!m||l,ref:u,value:t,onChange:h,onKeyDown:p,placeholder:"Type any question here, or choose one below",endAdornment:o.createElement(oe.Z,{direction:"row",gap:1},!i&&o.createElement(ue,{color:"inherit",onClick:a,disabled:i},o.createElement(le.Z,null)),o.createElement(ue,{color:"stop"===s?"error":"inherit",onClick:r,disabled:c},"stop"===s?o.createElement(ie.Z,null):o.createElement(re.Z,null)))}))}const se=(0,S.ZP)(ae.ZP)`
...
`;function pe(e){let{align:t="left",sx:n}=e;return o.createElement(fe,{align:t,sx:n},"Powered by ",o.createElement("a",{href:"https://www.pingcap.com/tidb-cloud/",target:"_blank",rel:"noreferrer"},"TiDB Cloud"))}const fe=(0,S.ZP)("div",{shouldForwardProp:e=>"align"!==e})`
...
`;var Ee=n(14850),ye=n(74065),be=n(47028),ve=n(21945),xe=n(70795),we=n(70918),Se=n(70983),Ze=n(96812),Ie=n(6571),Ce=n(47135),Ae=n(19604),Ne=n(29630);function Me(e,t){void 0===t&&(t={});const n=new URL(`https://github.com/${e}/issues/new`);return Object.entries(t).forEach((e=>{let[t,a]=e;n.searchParams.set(t,a)})),n.toString()}var ke=n(54566),Pe=n(21039),Le=n(23147),Re=n(79072),Te=n(91655),Ge=n(50522),Fe=n(39960);const De=(0,S.ZP)("div",{name:"Highlight-Background"})`
  position: relative;
  background: linear-gradient(116.45deg, #595FEC 0%, rgba(200, 182, 252, 0.2) 96.73%);
  padding: 1px;
  border-radius: 7px;
  width: 100%;
`,$e=(0,S.ZP)(Ge.Z,{name:"Highlight-Content"})`
  display: block;
  font-size: 14px;
  line-height: 1.25;
...
`,Be=(0,S.ZP)(De,{name:"HighlightButton-Background"})`
  display: inline-block;
  border-radius: 17px;
  max-width: max-content;
  color: white !important;
  text-decoration: none !important;
`;(0,S.ZP)($e,{name:"HighlightButton-Content"})`
  display: flex;
  border-radius: 16px;
  align-items: center;
  padding: 8px;
  max-width: max-content;
`,Be.withComponent(Ge.Z),Be.withComponent(Fe.Z);function ze(e){let{question:t,variant:n="card",disabled:a}=e;const{handleSelect:r}=(0,o.useContext)(I),l=(0,Z.Z)((()=>{"string"==typeof t&&r(t)}));switch(n){case"recommended-card":return o.createElement(De,null,o.createElement($e,{onClick:l,disabled:a},t),o.createElement(Ue,null,"\u2728"));case"card":return o.createElement($e,{onClick:l,disabled:a},t);default:return o.createElement(Oe,{disableRipple:!0,disableTouchRipple:!0,onClick:l,disabled:a},t)}}const Oe=(0,S.ZP)(Ge.Z,{name:"QuestionCard-Link"})`
  display: block;
  text-align: left;
  padding: 8px 0;
  font-size: 14px;
...
`,Ue=(0,S.ZP)("span")`
  ...
  bottom: 5px;
  font-size: 12px;
`;var qe=n(8100);function _e(e){const t=new Array(e);for(let n=0;n<e;n++)t[n]=n;return t}function He(e,t){if(0!==e.length&&(1!==e.length||!(0,d.nf)(t)||0!==t))for(;;){const n=Math.floor((Math.random()-1e-5)*e.length);if(n!==t)return e[n]}}function We(e,t){const{data:n,isValidating:a,mutate:r}=(0,qe.ZP)([e,t,"data-explorer-recommend-question"],{fetcher:async(e,t)=>await async function(e,t){return await i.po.get("/explorer/questions/recommend",{params:{aiGenerated:e,n:t}})}(e,t),shouldRetryOnError:!1,revalidateIfStale:!1,revalidateOnReconnect:!1,revalidateOnFocus:!1});return{data:n,loading:a,reload:(0,o.useMemo)((()=>()=>{r(void 0,{revalidate:!0}).catch(console.error)}),[])}}function Qe(e){let{variant:t,disabled:n,questions:a,n:r}=e;const l=0===a.length?(()=>{const e=e=>o.createElement(ze,{key:e,variant:t,question:"text"===t?o.createElement(Te.Z,{width:"230px"}):o.createElement(o.Fragment,null,o.createElement(Te.Z,{width:"100%"}),o.createElement(Te.Z,{width:"61%"})),disabled:!0});return"text"===t?_e(r).map(e):_e(r).map((t=>o.createElement(Re.ZP,{item:!0,xs:12,md:4,key:t,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t))))})():(()=>{const e=(e,a)=>o.createElement(ze,{key:a,variant:t,question:e.title,disabled:n});return"text"===t?a.map(e):a.map(((t,n)=>o.createElement(Re.ZP,{item:!0,xs:12,md:4,key:t.hash,display:"flex",alignItems:"stretch",justifyContent:"stretch"},e(t,n))))})();return"text"===t?o.createElement(x.Z,null,l):o.createElement(Re.ZP,{container:!0,spacing:2},l)}function Ve(e){let{aiGenerated:t=!1,n:n,disabled:a=!1,title:r,variant:l}=e;const{data:i=[],reload:c,loading:s}=We(t,n);return o.createElement(o.Fragment,null,(null==r?void 0:r(c,s))??null,o.createElement(Qe,{n:n,questions:i,disabled:a,variant:l??(t?"recommended-card":"card")}))}function Ke(e){let{severity:t,sx:n,children:a,createIssueUrl:r=(()=>Me("pingcap/ossinsight")),showSuggestions:l}=e;const i=(0,Z.Z)((()=>{var e;null==(e=document.getElementById("data-explorer-faq"))||e.scrollIntoView({behavior:"smooth"})})),c=(0,Z.Z)((()=>{window.open(r(),"_blank")}));return o.createElement(o.Fragment,null,o.createElement(Ye,{sx:n,variant:"outlined",severity:t},o.createElement(Ne.Z,{variant:"body1"},a),o.createElement(oe.Z,{direction:"row",spacing:2,mt:2},o.createElement(Xe,{onClick:i},o.createElement(Pe.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"See faq")),o.createElement(Xe,{onClick:c},o.createElement(Le.Z,{fontSize:"inherit",sx:{mr:.5}}),o.createElement("span",null,"Feedback")))),l&&o.createElement(Je,null,o.createElement(Ve,{title:(e,t)=>o.createElement(x.Z,{component:"p",m:0,mt:2,height:"40px"},"How about try other questions? ",o.createElement(ne.Z,{onClick:e,disabled:t},o.createElement(ke.Z,null))),n:5,variant:"text"})))}const Ye=(0,S.ZP)(Ae.Z)`
  background: #18191A;
...
`;var je=n(36782);function et(e){void 0===e&&(e="");try{return(0,je.WU)(e,{language:"mysql"})}catch{return e}}function tt(){const{question:e}=b(),t=(0,o.useMemo)((()=>()=>Me("pingcap/ossinsight",{title:`Empty result from question ${(null==e?void 0:e.id)??""}`,labels:"area/data-explorer",body:`\nHi, The result of [question](https://ossinsight.io/explore/?id=${(null==e?void 0:e.id)??""}) is empty\nThe title is: **${(null==e?void 0:e.title)??""}**\n\nGenerated SQL is:\n\`\`\`mysql\n${et(null==e?void 0:e.querySQL)}\n\`\`\` \n      `})),[e]);return o.createElement(Ke,{severity:"info",createIssueUrl:t,showSuggestions:!0},"This question has no results.")}function nt(e){let{severity:t,title:n,prompt:a,sx:r,error:l,showSuggestions:i}=e;const{question:c}=b();return o.createElement(Ke,{severity:t,sx:r,createIssueUrl:()=>Me("pingcap/ossinsight",{title:`${n} for question ${(null==c?void 0:c.id)??""}`,body:`\n${a} [question](https://ossinsight.io/explore?id=${(null==c?void 0:c.id)??""})\n\n## Question title\n**${(null==c?void 0:c.title)??""}**\n\n## Error message\n${l}\n${(0,d.nf)(null==c?void 0:c.querySQL)?`\n## Generated SQL\n\`\`\`mysql\n${et(null==c?void 0:c.querySQL)}\n\`\`\`\n`:""}\n${(0,d.nf)(null==c?void 0:c.chart)?`\n## Chart info\n\`\`\`json\n${JSON.stringify(null==c?void 0:c.chart,void 0,2)}\n\`\`\`\n`:""}\n`,labels:"area/data-explorer,type/bug"}),showSuggestions:i&&!(0,Ce.X_)(l,429)},n,": ",l)}var at=n(70917);function ot(){return o.createElement(lt,{size:16})}const rt=at.F4`
  0% {
...
`,dt=(0,S.ZP)("span",{name:"RippleDot",shouldForwardProp:e=>"size"!==e})`
  display: inline-block;
  position: relative;
...
`;function mt(e){let{status:t,title:n,defaultExpanded:a,extra:r,error:l,errorWithChildren:i=!1,children:c,errorPrompt:s,errorTitle:u,icon:m="default"}=e;const[g,h]=(0,o.useState)(!1);(0,o.useEffect)((()=>{switch(t){case"loading":h(!1);break;case"error":h(!0)}}),[t]);const p=(0,Z.Z)(((e,t)=>{f||h(t)})),f=!0===a,E=(0,d.N6)(r)&&"success"===t;return o.createElement(gt,{className:"pending"===t?"pending":(0,d.Rw)(l)?t:"error",elevation:1},o.createElement(ht,{expanded:!!f||g,defaultExpanded:a,elevation:0,onChange:p},o.createElement(pt,{alwaysOpen:f,expandIcon:(0,d.X0)(a)&&"success"===t&&o.createElement(Ie.Z,null),disabled:"loading"===t},o.createElement(ft,null,"loading"===t?"bot"===m?o.createElement(ot,null):o.createElement(st,{size:12}):"success"===t&&(0,d.Rw)(l)?o.createElement(Se.Z,{color:"success",fontSize:"inherit"}):o.createElement(Ze.Z,{color:"disabled",fontSize:"inherit"}),o.createElement(yt,null,n),E&&o.createElement(o.Fragment,null,o.createElement(bt,null),o.createElement(Et,null,"auto"===r?g?"Hide":"Show":r)))),o.createElement(be.Z,null,i?(0,d.Rw)(l)?c:o.createElement(o.Fragment,null,o.createElement(nt,{title:u,prompt:s,error:(0,Ce.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}),c):(0,d.Rw)(l)?c:o.createElement(nt,{title:u,prompt:s,error:(0,Ce.e$)(l),severity:"error",sx:{mb:1},showSuggestions:!0}))))}const gt=(0,S.ZP)(we.Z)`
...
`,ht=(0,S.ZP)(ye.Z)`
  ...
  padding: 4px 8px;
`,pt=(0,S.ZP)(ve.Z,{shouldForwardProp:e=>"alwaysOpen"!==e})`
  &.${xe.Z.content} {
    margin-top: 4px;
    margin-bottom: 4px;
  }
...
`,bt=(0,S.ZP)("span")`
  flex: 1;
`;var vt=n(18629);function xt(){const{question:e,error:t,phase:n}=b(),a=(0,o.useMemo)((()=>{try{if((0,d.nf)(e))return(0,je.WU)(e.querySQL,{language:"mysql"});var n;if(function(e){if((0,Ce.IZ)(e)&&(0,d.nf)(e.response)&&(0,d.nf)(e.response.data))return"string"==typeof e.response.data.message&&"string"==typeof e.response.data.querySQL;return!1}(t))return(0,je.WU)((null==(n=t.response)?void 0:n.data.querySQL)??"",{language:"mysql"})}catch(a){return(null==e?void 0:e.querySQL)??""}}),[e,t]),r=(0,o.useMemo)((()=>{switch(n){case h.NONE:return"pending";case h.LOADING:case h.CREATING:case h.GENERATING_SQL:return"loading";case h.GENERATE_SQL_FAILED:case h.LOAD_FAILED:case h.CREATE_FAILED:return"error";default:return"success"}}),[n]),l=(0,o.useMemo)((()=>{switch(n){case h.NONE:return"";case h.LOADING:return"Loading question...";case h.CREATING:return"Creating question...";case h.GENERATING_SQL:return o.createElement(St,null);case h.LOAD_FAILED:return"Question not found";case h.GENERATE_SQL_FAILED:case h.CREATE_FAILED:return"Failed to generate SQL";default:return"Generated SQL"}}),[n]),i=(0,o.useMemo)((()=>{if("error"===r)return t}),[r,t]),c=n===h.CREATED||n===h.GENERATING_SQL;return o.createElement(mt,{status:r,title:l,icon:c?"bot":"default",extra:"auto",error:i,errorWithChildren:!0,errorTitle:"Failed to generate SQL",errorPrompt:"Hi, it's failed to generate SQL for"},(0,d.N6)(a)&&o.createElement(Ee.Z,{language:"sql"},a))}const wt=[["Great question!","Interesting question!","Awesome question!","You asked a winner!"],["Thinking...","Brain busting!","Creating SQL..."],["Tough, but still trying...","Hard, but persevering.","Tough, but forging ahead...","Challenging, but still striving...","Struggling, but pushing on..."],["Mastering the art of turning words into SQL magic\u2026","Gaining knowledge from your input...","Learning from your question...","Getting smarter with your input..."],["Making every effort!","Working my hardest","Trying my best...","Striving for greatness...","Trying my best..."],["Almost there\u2026","Almost done...","Just a second!"]];function St(){const e=(0,o.useRef)({group:0}),[t,n]=(0,o.useState)((()=>He(wt[0])));return(0,vt.Z)((()=>{let{group:t}=e.current;t<5?t+=1:t=4,n(He(wt[t])),e.current.group=t}),3e3),(0,d.nf)(t)?o.createElement(Zt,{prompt:t}):o.createElement(o.Fragment,null,"Generating SQL...")}function Zt(e){let{prompt:t,avgInterval:n=80,maxDiff:a=50}=e;const[r,l,i]=function(e){const[t,n]=(0,o.useState)(e),a=(0,o.useRef)(t);return(0,o.useEffect)((()=>{a.current=t}),[t]),[t,n,a]}(0);return(0,o.useEffect)((()=>{let e;return l(0),function o(){e=setTimeout((()=>{i.current>=t.length?clearTimeout(e):(l((e=>e+1)),o())}),n+(.5-Math.random())*a)}(),()=>{clearTimeout(e)}}),[t]),o.createElement(o.Fragment,null,t.slice(0,r),t.length!==r)}var It=n(87462),Ct=n(64232);function At(e){const{showTips:t}=C();return o.createElement(Nt,(0,It.Z)({target:"_blank",onClick:t},e),"Share",o.createElement(Mt,null))}const Nt=(0,S.ZP)("a")`
  display: inline-flex;
  align-items: center;
  opacity: 0.8;
...
`,Mt=(0,S.ZP)(Ct.Z)`
  margin-left: 4px;
  color: #1D9BF0;
`;var kt=n(1969),Pt=n(36804),Lt=n(88784);function Rt(e){let{children:t}=e;return o.createElement(Lt.Z,{title:t},o.createElement(ne.Z,null,o.createElement(Pt.Z,{fontSize:"inherit"})))}var Tt=n(44373),Gt=n(78385),Ft=n(87054),Dt=n(85390),$t=n(4316),Bt=n(95764),zt=n(85753),Ot=n(98628),Ut=n(4882),qt=n(71406);function _t(){const{showTips:e}=C(),{question:t}=b(),{loading:n,setAsyncData:a}=(0,Ut.P)(void 0),r=(0,qt.Gb)(),{isAuthenticated:l}=(0,g.D3)(),{data:c,mutate:u}=(0,qe.ZP)(l&&(0,d.nf)(t)?[t.id,"question-feedback"]:void 0,{fetcher:async e=>await r().then((async t=>await async function(e,t){return await i.po.get(`/explorer/questions/${e}/feedback`,{oToken:t})}(e,t))).then((e=>(0,d.uW)(e)?Boolean(e[0].satisfied):void 0)),errorRetryCount:0}),m=(0,Z.Z)((()=>{(0,d.Rw)(t)||(a(r().then((async e=>await s(t.id,{satisfied:!0},e).finally((()=>{u(!0)}))))),e())})),h=(0,Z.Z)((()=>{(0,d.Rw)(t)||a(r().then((async e=>await s(t.id,{satisfied:!1},e).finally((()=>{u(!0)})))))}));return o.createElement(Ht,null,o.createElement(Wt,{disabled:!0===c||n,onClick:m},!0===c?o.createElement(zt.Z,{color:"primary",fontSize:"inherit"}):o.createElement(Ot.Z,{fontSize:"inherit"})),o.createElement(Tt.Z,{orientation:"vertical",flexItem:!0,sx:{my:.5}}),o.createElement(Wt,{disabled:!1===c||n,onClick:h},!1===c?o.createElement($t.Z,{color:"primary",fontSize:"inherit"}):o.createElement(Bt.Z,{fontSize:"inherit"})))}const Ht=(0,S.ZP)("div")`
  display: inline-flex;
  height: 32px;
  width: 65px;
  min-width: 65px;
...
`,Kt=(0,S.ZP)("table")`
  ...
  display: table;
  min-width: 100%;
`;var Yt=n(66284);function Jt(e){return/date|time|year|month/.test(e)}function Xt(e){return"number"==typeof e?e>=1970&&e<2100:Xt(Number(e))}function jt(e,t){return e.map((e=>{let n=e[t];return Xt(n)&&(n=new Date(String(n))),{...e,[t]:n}}))}function en(e,t){return(0,d.YN)(t,(e=>!(0,d.Rw)(e)&&(e instanceof Array?e.length>0&&(0,d.YN)(e,d.GC):(0,d.GC)(e))))?e.filter((e=>(0,d.YN)(t,(e=>t=>"string"==typeof t?(0,d.nf)(e[t]):(0,d.YN)(t,(t=>(0,d.nf)(e[t]))))(e)))):[]}var tn=n(44731),nn=n(85214),an=n(81284),on=n(19594),rn=n(95309),ln=n(61702);var cn=n(49837),sn=n(91359),un=n(45344);var dn=n(74446),mn=n(75559),gn=n(40172);const hn=(0,S.ZP)("div")`
  height: 100%;
`;function pn(e){let{title:t}=e;const{question:n}=b(),a=(0,o.useMemo)((()=>()=>{var e,a,o,r;return Me("pingcap/ossinsight",{title:`${t} in question ${(null==n?void 0:n.id)??""}`,labels:"area/data-explorer,type/bug",assignee:"Mini256",body:`\nHi, ${t} in [question](https://ossinsight.io/explore/?id=${(null==n?void 0:n.id)??""})\n      \n## Chart info:\n\`\`\`json\n${JSON.stringify(null==n?void 0:n.chart,void 0,2)}\n\`\`\`\n\n## Result info:\n\`\`\`json\n// Fields\n${JSON.stringify(null==n||null==(e=n.result)?void 0:e.fields,void 0,2)}\n\n// First result (Totally ${(null==n||null==(a=n.result)?void 0:a.rows.length)??0} rows)\n${JSON.stringify(null==n||null==(o=n.result)||null==(r=o.rows)?void 0:r[0],void 0,2)}\n\`\`\`\n      `})}),[n]);return o.createElement(Ke,{severity:"warning",sx:{mb:2},createIssueUrl:a},t)}(0,n(6068).y)();const fn={LineChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const i=(0,o.useMemo)((()=>{const e=Jt(a);l=e?jt(l,a):l;const t=function(e){return"string"==typeof e?{type:"line",datasetId:"raw",name:e,encode:{x:a,y:e},itemStyle:{opacity:0}}:e.map(t)};return{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{trigger:"axis"},legend:{left:"center",top:28},series:t(r),title:{text:n},xAxis:{type:e?"time":"category"},yAxis:{type:"value"},animationDuration:2e3}}),[t,n,a,r,l]);return o.createElement(Yt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["x","y"]},BarChart:{Chart:function(e){let{chartName:t,title:n,x:a,y:r,data:l}=e;const{options:i,height:c}=(0,o.useMemo)((()=>{const e=Jt(a);l=e?jt(l,a):l;const t=!e,o=function(e){return"string"==typeof e?{type:"bar",name:e,datasetId:"raw",encode:{x:t?e:a,y:t?a:e}}:e.map(o)};return{options:{dataset:{id:"raw",source:l},backgroundColor:"rgb(36, 35, 43)",grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:"center",top:28},series:o(r),title:{text:n},[t?"yAxis":"xAxis"]:{type:e?"time":"category"},[t?"xAxis":"yAxis"]:{type:"value"},animationDuration:2e3},height:Math.max(t?40*l.length:400,400)}}),[t,n,a,r,l]);return o.createElement(Yt.Z,{theme:"dark",style:{height:c},opts:{height:c},option:i})},requiredFields:["x","y"]},PieChart:{Chart:function(e){let{chartName:t,title:n,value:a,label:r,data:l}=e;const i=(0,o.useMemo)((()=>({backgroundColor:"rgb(36, 35, 43)",dataset:{id:"raw",source:l},grid:{top:64,left:8,right:8,bottom:8},tooltip:{},legend:{left:8,top:8,height:"90%",type:"scroll",orient:"vertical"},series:{type:"pie",name:r,datasetId:"raw",encode:{itemName:r,value:a}},title:{text:n}})),[t,n,a,r,l]);return o.createElement(Yt.Z,{theme:"dark",style:{height:400},opts:{height:400},option:i})},requiredFields:["value","label"]},PersonalCard:{Chart:function(e){let{chartName:t,title:n,user_login:a,data:r}=e;return o.createElement(nn.Z,null,r.map(((e,t)=>o.createElement(an.ZP,{key:t},o.createElement(rn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(on.Z,null,o.createElement(tn.Z,{src:`https://github.com/${e[a]}.png`})),o.createElement(ln.Z,null,e[a]))))))},requiredFields:["user_login"]},RepoCard:{Chart:function(e){let{chartName:t,title:n,repo_name:a,data:r}=e;return o.createElement(nn.Z,null,r.map(((e,t)=>o.createElement(an.ZP,{key:t},o.createElement(rn.Z,{component:"a",href:`https://github.com/${e[a]}`,target:"_blank"},o.createElement(on.Z,null,o.createElement(tn.Z,{src:`https://github.com/${e[a].split("/")[0]}.png`})),o.createElement(ln.Z,null,e[a]))))))},requiredFields:["repo_name"]},Table:{Chart:Qt,requiredFields:[]},NumberCard:{Chart:function(e){let{chartName:t,title:n,label:a,value:r,data:l}=e;if((0,d.N6)(a)){if(1===l.length&&(0,d.Rw)(l[0][a])){const e=l[0][r];return o.createElement(cn.Z,null,o.createElement(sn.Z,{sx:{textAlign:"center",fontSize:36}},o.createElement(Ne.Z,{sx:{opacity:.4},fontSize:22,mt:2,mb:0,color:"text.secondary",gutterBottom:!0,align:"center"},n),(0,d.z0)(e)?o.createElement(un.Z,{value:l[0][r],hasComma:!0,duration:800,size:36}):String(e)))}return o.createElement(o.Fragment,null,o.createElement(Ne.Z,{variant:"h4"},n),o.createElement(Re.ZP,{container:!0,spacing:1,mt:1},l.map(((e,t)=>o.createElement(Re.ZP,{key:t,item:!0,xs:12,sm:4,md:3,lg:2},o.createElement(cn.Z,{sx:{p:2}},o.createElement(Ne.Z,{variant:"subtitle1"},e[a]),o.createElement(Ne.Z,{variant:"body2",color:"#7c7c7c"},e[r])))))))}return o.createElement(nn.Z,null,l.map(((e,t)=>o.createElement(an.ZP,{key:t},o.createElement(cn.Z,{sx:{p:4}},o.createElement(ln.Z,{primary:n,secondary:`${e[r]}`}))))))},requiredFields:["value"],optionalFields:["label"]},MapChart:{Chart:function(e){let{chartName:t,title:n,country_code:a,value:r,data:l}=e;const[i,c]=(0,o.useState)(null),s=(0,o.useRef)(null),u=(0,o.useMemo)((()=>function(e,t,n){return e.map((e=>{const a=(0,dn.$)(e[t]),{long:o,lat:r}=(0,dn.b)(e[t])??{};return[a,o,r,e[n]]})).filter((e=>{let[t]=e;return(0,d.GC)(t)})).sort(((e,t)=>Math.sign(t[3]-e[3])))}(l,a,r)),[l,a,r]),m=(0,o.useMemo)((()=>{var e,t;const a=(null==(e=u[0])?void 0:e[3])??0;return{backgroundColor:"rgb(36, 35, 43)",geo:(0,mn.Mm)(),dataset:[{id:"top1",source:u.slice(0,1)},{id:"rest",source:u.slice(1)}],title:{text:n},legend:{show:!0,left:8,top:24,orient:"vertical"},series:[{type:"effectScatter",datasetId:"top1",coordinateSystem:"geo",name:`Top 1 (${null==(t=u[0])?void 0:t[0]})`,encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)},{type:"scatter",datasetId:"rest",coordinateSystem:"geo",name:"Rest",encode:{lng:1,lat:2,value:3,itemId:0},symbolSize:e=>1+64*Math.sqrt(e[3]/a)}],tooltip:{formatter:e=>`<b>${r}</b><br/>${e.marker} <b>${e.value[0]}</b> ${e.value[3]}`},animationDuration:2e3}}),[t,n,r,u]);return(0,o.useEffect)((()=>{if((0,d.Rw)(i))return;const e=new ResizeObserver((e=>{var t,n;let[a]=e;null==(t=s.current)||null==(n=t.getEchartsInstance())||n.resize({height:a.contentRect.height})}));return e.observe(i),()=>{e.disconnect()}}),[i]),o.createElement(gn.ZP,{ratio:4/3,style:{maxWidth:600,margin:"auto"}},o.createElement(hn,{ref:c},o.createElement(Yt.Z,{theme:"dark",opts:{height:(null==i?void 0:i.clientHeight)??"auto"},option:m,ref:s})))},requiredFields:["country_code","value"]}};function En(e){const{config:t,fields:n}=(0,o.useMemo)((()=>{const t=fn[e.chartName];return{config:t,fields:((null==t?void 0:t.requiredFields)??[]).map((t=>e[t]))}}),[(0,qe.wE)(e)]),a=en(e.data,n);let r,l;return(0,d.Rw)(t)&&(r=o.createElement(pn,{title:`AI has generated an unknown chart type '${e.chartName}'`})),0===e.data.length?r=o.createElement(tt,null):a.length>0?(0,d.nf)(t)&&(l=(0,o.createElement)(t.Chart,{...e,data:a})):r=o.createElement(pn,{title:"AI has generated invalid chart info"}),o.createElement(o.Fragment,null,r,l)}var yn=n(91693),bn=n(96942),vn=n(45670),xn=n(55050),wn=n(89747),Sn=n(76743);function Zn(e){let{loading:t=!1,children:n}=e;return o.createElement(In,{elevation:0},o.createElement(sn.Z,null,o.createElement(Ne.Z,{variant:"h4",display:"flex",alignItems:"center",fontSize:16,fontFamily:"monospace"},o.createElement(Cn,null),o.createElement(An,null,"Instant insights")),o.createElement(Ne.Z,{variant:"body1",fontSize:14,fontFamily:"monospace",mt:2},t?o.createElement(o.Fragment,null,o.createElement(Te.Z,{variant:"text",width:"61%"}),o.createElement(Te.Z,{variant:"text",width:"31%"})):n)))}const In=(0,S.ZP)(cn.Z)`
...
`,An=(0,S.ZP)("span")`
  margin-left: 12px;
`;function Nn(){var e,t,n;const{question:a,error:r,phase:l}=b(),{search:i}=C(),[s,u]=(0,o.useState)(null),m=null==a||null==(e=a.result)?void 0:e.rows,g=(0,o.useMemo)((()=>{switch(l){case h.CREATED:case h.QUEUEING:case h.EXECUTING:return"loading";case h.EXECUTE_FAILED:case h.VISUALIZE_FAILED:case h.UNKNOWN_ERROR:return"error";case h.READY:case h.SUMMARIZING:return"success";default:return"pending"}}),[l]),p=(0,o.useMemo)((()=>{var e;switch(l){case h.CREATED:return"Pending...";case h.QUEUEING:return`${(null==a?void 0:a.queuePreceding)??NaN} requests ahead`;case h.EXECUTING:return"Running SQL...";case h.EXECUTE_FAILED:return"Failed to execute SQL";case h.UNKNOWN_ERROR:return"Unknown error";case h.VISUALIZE_FAILED:case h.READY:case h.SUMMARIZING:return o.createElement(o.Fragment,null,`${(null==a||null==(e=a.result)?void 0:e.rows.length)??"NaN"} rows in ${(null==a?void 0:a.spent)??"NaN"} seconds`,function(e){if((0,d.nf)(e)&&!(0,d.yD)(e.engines))return o.createElement(o.Fragment,null,", Running on",o.createElement(kn,null,e.engines.map(Mn).join(", ")),o.createElement(Rt,null,o.createElement(Ne.Z,{variant:"body1"},o.createElement("b",null,"tikv"),": row storage engine",o.createElement("br",null),o.createElement("b",null,"tiflash"),": columnar storage engine"),o.createElement(Tt.Z,{orientation:"horizontal",sx:{my:1.5},light:!0}),o.createElement(Ne.Z,{variant:"body2"},"Intelligent query processing in ",o.createElement("a",null,"TiDB optimizer"),".")));return null}(a));default:return"pending"}}),[a,l]),f=(0,o.useMemo)((()=>{var e,t;if((0,d.Rw)(a))return(0,kt.PE)(location.href,{title:"OSSInsight Data Explorer",hashtags:["OpenSource","OpenAI","TiDBCloud"]});let n;const o=(null==(e=a.answerSummary)?void 0:e.content)??i,r=function(){const e=new Set,t=[];for(var n=arguments.length,a=new Array(n),o=0;o<n;o++)a[o]=arguments[o];return a.forEach((n=>{for(const a of n)e.has(a)||(e.add(a),t.push(a))})),t}((null==(t=a.answerSummary)?void 0:t.hashtags)??[],["OpenSource","OpenAI","TiDBCloud"]);return n="undefined"==typeof location?(0,d.GC)(a.id)?`https://ossinsight.io/explore?id=${a.id}`:"https://ossinsight.io/explore":(0,kt.PE)(location.href,{title:`${o} | OSSInsight Data Explorer\n`,hashtags:r}),n}),[a,i]),E=(0,o.useMemo)((()=>{if("error"===g)return r}),[g,r]),y=(0,o.useMemo)((()=>{if(l===h.VISUALIZE_FAILED)return r}),[l,r]);return o.createElement(mt,{status:g,title:p,extra:o.createElement(Bn,null,o.createElement("span",{ref:u}),o.createElement(At,{href:f})),error:E,defaultExpanded:!0,errorTitle:"Failed to execute question",errorPrompt:"Hi, it's failed to execute"},((0,d.nf)(null==a?void 0:a.answerSummary)||(null==a?void 0:a.status)===c.Summarizing)&&o.createElement(Zn,{loading:(null==a?void 0:a.status)===c.Summarizing},null==a||null==(t=a.answerSummary)?void 0:t.content),l===h.QUEUEING&&o.createElement(Gn,{source:0===(null==a?void 0:a.queuePreceding)?Rn:Ln,interval:3e3}),l===h.EXECUTING&&o.createElement(Gn,{source:Tn,interval:2e3}),o.createElement(Pn,{chartData:(null==a?void 0:a.chart)??void 0,chartError:y,result:m,fields:null==a||null==(n=a.result)?void 0:n.fields,controlsContainer:s}))}function Mn(e){switch(e){case"tiflash":return"columnar storage";case"tikv":return"row storage";default:return e}}const kn=(0,S.ZP)("span")`
  color: #5667FF;
  border: 1px solid #5667FF80;
  border-radius: 2px;
  padding: 4px 8px;
  margin: 0 4px;
`;function Pn(e){let{chartData:t,chartError:n,fields:a,result:r,controlsContainer:l}=e;const[i,c]=(0,o.useState)("visualization");(0,o.useEffect)((()=>{c("visualization")}),[t]);const s=(e,t)=>{(0,d.GC)(t)&&c(t)};return(0,o.useMemo)((()=>{const e=(0,Ce.e$)(n),c=function(t,n){return void 0===t&&(t=!1),void 0===n&&(n=!1),o.createElement(nt,{title:"Unable to generate chart",prompt:"Hi, it's failed to generate chart for",error:e,severity:"warning",sx:t?{mb:2}:void 0,showSuggestions:n})};if((0,d.Rw)(r))return(0,d.nf)(n)?c(!1,!0):null;const u=()=>o.createElement(oe.Z,{direction:"row",justifyContent:"space-between",spacing:"2",alignItems:"center"},o.createElement(Ne.Z,{variant:"body2",color:"#D1D1D1",mt:2},"\ud83e\udd14 Confused with this answer? Try to tiny your words and help the AI identify your question, for example, you can try to use \u2018@repo_name/user_name\u2019 to narrow down your query. If you have more questions about the accuracy of the answers, see FAQ here."),o.createElement(_t,null)),m=()=>o.createElement(o.Fragment,null,o.createElement(Qt,{chartName:"Table",title:"",data:r,fields:a}),u());if((0,d.Rw)(t))return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):null;const g=()=>o.createElement(o.Fragment,null,o.createElement(En,(0,It.Z)({},t,{data:r,fields:a})),u());return(0,d.nf)(n)?o.createElement(o.Fragment,null,c(!0),m()):"Table"===t.chartName?g():o.createElement(o.Fragment,null,o.createElement(Gt.Z,{container:l},o.createElement($n,{className:"chart-controls"},o.createElement(Dt.Z,{size:"small",value:i,onChange:s,exclusive:!0,color:"primary"},o.createElement(Ft.Z,{value:"visualization",size:"small",sx:{padding:"5px"}},o.createElement(yn.Z,{fontSize:"small"})),o.createElement(Ft.Z,{value:"raw",size:"small",sx:{padding:"5px"}},o.createElement(bn.Z,{fontSize:"small"}))))),o.createElement(vn.ZP,{value:i},o.createElement(zn,{value:"visualization"},g()),o.createElement(zn,{value:"raw"},m())))}),[i,t,n,r,a])}const Ln=["So many people are just as curious as you are.","Do you know how many types of events on GitHub? 17.","GitHub accumulates over 4 million new events each day. We synchronize these data in real time.","In 2022, 95% of the top 20 most active developers on GitHub are bots.","Python has been the most used back-end programming language for years on GitHub."],Rn=["Almost there! Can't wait to see your result!"],Tn=["GitHub has an incredible 5+ billion rows of event data waiting for you to explore.","Perhaps AI generates a complex SQL.","Are you curious about the complex SQL generated by AI?"],Gn=e=>{let{source:t,interval:n}=e;const[a,r]=(0,o.useState)(0);return(0,vt.Z)((()=>{r((e=>(e+1)%t.length))}),n),o.createElement(wn.Z,{component:Fn},o.createElement(Sn.Z,{key:a,timeout:400,classNames:"item"},o.createElement(Dn,null,t[a])))},Fn=(0,S.ZP)("span")`
  position: relative;
  display: block;
  min-height: 42px;
  min-width: 1px;
...
`,zn=(0,S.ZP)(xn.Z)`
  padding: 0;
`;function On(e){let{search:t}=e;const{phase:n}=b();return o.createElement(o.Fragment,null,o.createElement(xt,null),o.createElement(Nn,null),n===h.READY&&o.createElement(pe,{sx:{mt:2}}))}function Un(e){let{title:t="\ud83d\udd25 Popular queries"}=e;return o.createElement(o.Fragment,null,o.createElement(Ve,{title:()=>o.createElement(x.Z,{height:"40px"},t),n:6}))}var qn=n(41796),_n=n(44044),Hn=n(60641),Wn=n(64421),Qn=n(98948),Vn=n(61225);function Kn(e){let{startColor:t="#794BC5",stopColor:n="#3D44FF",steps:a,sx:r}=e;const l=(0,Vn.Z)((e=>e.breakpoints.down("md"))),i=(0,o.useMemo)((()=>{const e=(0,qn.tB)(t).values,o=(0,qn.tB)(n).values;return _e(a.length+1).map((t=>function(e,t,n){let[a,o,r]=e,[l,i,c]=t;const s=1-n;return(0,qn.wy)({type:"rgb",values:[a*s+l*n,o*s+i*n,r*s+c*n]})}(e,o,t/a.length)))}),[t,n,a.length]);return o.createElement(o.Fragment,null,o.createElement("svg",{width:"0",height:"0"},o.createElement("defs",null,a.map(((e,t)=>o.createElement("linearGradient",{id:`explore-step-gradient-${t}`,key:t,x1:"0%",y1:"0%",x2:"100%",y2:"0%"},o.createElement("stop",{offset:"0%",style:{stopColor:i[t],stopOpacity:1}}),o.createElement("stop",{offset:"100%",style:{stopColor:i[t+1],stopOpacity:1}})))))),o.createElement(Qn.Z,{sx:r,orientation:l?"vertical":"horizontal"},a.map(((e,t)=>o.createElement(_n.Z,{key:e,completed:!1,active:!0},o.createElement(Yn,{fill:`explore-step-gradient-${t}`},e))))))}const Yn=(0,S.ZP)(Wn.Z,{shouldForwardProp:e=>"fill"!==e})`
  .${Hn.Z.root}.${Hn.Z.active} {
    fill: url(#${e=>{let{fill:t}=e;return t}}); // ${e=>{let{color:t}=e;return t}};
  }
`;function Jn(){return o.createElement(x.Z,{component:"section",id:"data-explorer-faq",pt:8},o.createElement(Ne.Z,{variant:"h2",textAlign:"center"},"FAQ"),Xn.map(((e,t)=>{let{q:n,a:a}=e;return o.createElement(jn,{key:t},o.createElement(ea,null,n),o.createElement(ta,null,a))})),o.createElement(Ne.Z,{variant:"body1",textAlign:"center",color:"#929292",fontSize:16,mt:8},"Still have problems? please feel free to contact us ",ra," ",la))}const Xn=[{q:"How it works?",a:o.createElement(Kn,{steps:["Input your question","Translate your question to SQL with OpenAI","Visualize and output your results"]})},{q:"How do I use this tool?",a:"You can start with selecting a popular query from the query wall or directly input a short text query statement to the search box. OpenAI will translate your question into Structured Query Language (SQL), and we will use the generated SQL to query in the database and return the results."},{q:"Why the answer do not turn out to my intended?",a:"We use the text completion provided by OpenAI to translate the text into Structured Query Language (SQL), and the final output depends on the accuracy of the generated SQL. If the final query result does not meet your expectation, please shorten your input statement and using more concise and clear short words for AI recognition."},{q:"Why is the output report an error or show 0 results?",a:o.createElement(o.Fragment,null,"Unfortunately, we do not have useful GitHub insights for you. Usually, there are two situations that cause the answer not to be found:",o.createElement("ol",null,o.createElement("li",null,"AI unrecognized/misunderstand your text and generated wrong/bad SQLs, the query mission failed."),o.createElement("li",null,"Data restrictions. All the data we use here on this website sources from\xa0",o.createElement("a",{href:"http://www.gharchive.org/",target:"_blank",rel:"noreferrer"},"GH Archive"),", a non-profit project that records and archives all GitHub events data since 2011. We can not offer you more insights if you are looking for answers about other topics.")),o.createElement("br",null),"The potential solution is phrase your question which is related GitHub with short, specific words , then try again. And we strongly recommend you use our query templates near the search box to start your exploring.")}],jn=(0,S.ZP)("div")`
  &:not(:first-of-type) {
    margin-top: 48px;
  }
`,ea=(0,S.ZP)("h3")`
...
`,ra=o.createElement(aa,{href:"https://github.com/pingcap/ossinsight/issues",target:"_blank"},o.createElement(Le.Z,null)),la=o.createElement(oa,{href:"https://twitter.com/OSSInsight",target:"_blank"},o.createElement(Ct.Z,{fontSize:"inherit"}));var ia=n(27952),ca=n(5299);function sa(){return o.createElement(da,null,o.createElement(Ve,{variant:"text",n:4,title:(e,t)=>o.createElement(Ne.Z,{variant:"h3",mb:0,fontSize:16},o.createElement(ua,null),"Get inspired",o.createElement(ne.Z,{onClick:e,disabled:t},o.createElement(ke.Z,{fontSize:"inherit"})))}),o.createElement(Tt.Z,{orientation:"horizontal",sx:{my:2}}),o.createElement(x.Z,null,o.createElement(ga,{to:"/blog/chat2query-tutorials"},"Get hands-on with your data ",o.createElement(ca.Z,{color:"inherit"})),o.createElement(ha,null,"Get hands-on with your data Get hands-on with your data")))}function ua(){return o.createElement(o.Fragment,null,_e(3).map((e=>o.createElement(ma,{key:e,color:"primary",fontSize:"inherit",sx:{verticalAlign:"text-bottom"}}))))}const da=(0,S.ZP)("div")`
  position: sticky;
  top: 92px;
`,ma=(0,S.ZP)(ia.Z)`
  vertical-align: text-bottom;
...
`,ha=(0,S.ZP)("p")`
  margin-top: 8px;
  font-size: 12px;
`;var pa=n(63675),fa=n(30120),Ea=n(25425),ya=n(7449);const ba=(0,o.forwardRef)((function(e,t){const[n,a]=(0,o.useState)(!1),[r,l]=(0,pa.Z)("ossinsight.explore.tips-history",{serializer:e=>JSON.stringify(e.map((e=>e.toJSON()))),deserializer:e=>{try{const t=JSON.parse(e);return t instanceof Array?t.map((e=>fa.ou.fromISO(e))).filter((e=>e.diffNow("days").days<30)):[]}catch{return[]}},defaultValue:[]}),i=(0,u.Z)((()=>{r.length<2&&(a(!0),l((e=>(null==e?void 0:e.concat(fa.ou.now()))??[fa.ou.now()])))})),c=(0,Z.Z)((()=>{a(!1)}));return(0,ya.h)(t,{show:i}),o.createElement(Gt.Z,null,o.createElement(Ea.Z,{direction:"left",in:n},o.createElement(va,null,o.createElement(xa,null),o.createElement(wa,null),o.createElement(Sa,null,o.createElement(sn.Z,null,"\ud83d\udc97 Thank you for enjoying our answers. How about continue to ",o.createElement(Fe.Z,{to:"/blog/chat2query-tutorials",target:"_blank"},"explore with your own dataset?")),o.createElement(Za,{size:"small",onClick:c},o.createElement(re.Z,null))))))})),va=(0,S.ZP)("div")`
  position: fixed;
  top: 50vh;
  right: 16px;
  display: flex;
...
`,Za=(0,S.ZP)(ne.Z)`
  ...
  right: 8px;
  top: 8px;
`;function Ia(){var e;const{question:t,loading:n,load:a,error:r,phase:l,reset:i,create:c}=E({pollInterval:2e3}),[s,u]=(0,v.ZP)("id",(0,v.Rc)(),!0),[m,g]=(0,o.useState)(""),f=(0,o.useRef)(null),b=!p.has(l),S=b||(0,d.oM)(m),C=(0,d.Rw)(null==t?void 0:t.id)&&!n,N=((null==t||null==(e=t.result)?void 0:e.rows.length)??0)>0;(0,o.useEffect)((()=>{(0,d.nf)(t)&&g(t.title)}),[null==t?void 0:t.title]),(0,o.useEffect)((()=>{(0,d.nf)(s)?a(s):k()}),[s]),(0,o.useEffect)((()=>{(0,d.nf)(null==t?void 0:t.id)&&u(null==t?void 0:t.id)}),[n,null==t?void 0:t.id]);const M=(0,Z.Z)((()=>{b||c(m)})),k=(0,Z.Z)((()=>{i(),g(""),u(void 0)})),P=(0,Z.Z)((e=>{g(e),c(e)})),L=(0,Z.Z)((()=>{var e;null==(e=f.current)||e.show()})),R=!C&&(l===h.READY||l===h.SUMMARIZING)&&N;return o.createElement(y.Provider,{value:{phase:l,question:t,loading:n,error:r,create:c,load:a,reset:i}},o.createElement(I.Provider,{value:{search:m,handleSelect:P,showTips:L}},o.createElement(A,null),o.createElement(G,{showSide:R,showHeader:C,showFooter:C,header:o.createElement(Y,null),side:o.createElement(sa,null),footer:o.createElement(x.Z,{mt:2},o.createElement(pe,{align:"center"}),o.createElement(Ca,{to:"/blog/chat2query-tutorials",target:"_blank"},"\ud83e\uddd0 GitHub data is just the beginning. Uncover hidden insights in your OWN data!",o.createElement(ca.Z,{fontSize:"inherit",sx:{verticalAlign:"text-bottom",ml:.5}})))},o.createElement(ce,{value:m,onChange:g,onAction:M,disableInput:b,disableClear:""===m,disableAction:S,onClear:k,clearState:b?"stop":void 0}),o.createElement(me,{state:C?"recommend":"execution",direction:C?"down":"up"},o.createElement(x.Z,{key:"execution",sx:{mt:1.5}},o.createElement(On,{search:m})),o.createElement(x.Z,{key:"recommend",sx:{mt:4}},o.createElement(Un,null)))),o.createElement(w.Z,{maxWidth:"lg",sx:{pb:8}},o.createElement(Jn,null)),o.createElement(ba,{ref:f})))}const Ca=(0,S.ZP)(Fe.Z)`
  display: block;
  text-align: center;
  color: white !important;
  text-decoration: none !important;
