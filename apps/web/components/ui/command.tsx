...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-[1.4rem]! bg-[#2f2f3a] p-1 text-[#e9eaee]",
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          "top-[12vh] translate-y-0 overflow-hidden rounded-[1.6rem]! p-0",
          className
        )}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-10! rounded-xl! border-white/10 bg-[rgba(41,40,53,0.96)] shadow-none! *:data-[slot=input-group-addon]:pl-3!">
