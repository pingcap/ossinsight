...
|-----------|---------|------|-------|---------|-----------|
| [garrytan/gstack](https://ossinsight.io/analyze/garrytan/gstack) | Garry Tan | President & CEO, Y Combinator | 50,074 | Mar 11, 2026 | 3,130 |
| [mattpocock/skills](https://ossinsight.io/analyze/mattpocock/skills) | Matt Pocock | Creator of TypeScript tutorial series, author of *Total TypeScript* | 10,350 | Feb 3, 2026 | 199 |
| [slavingia/skills](https://ossinsight.io/analyze/slavingia/skills) | Sahil Lavingia | Founder & CEO, Gumroad | 3,650 | Mar 23, 2026 | 912 |
...
|-----------|-------|-------|-------|
| garrytan/gstack | 50,074 | 6,396 | **7.8x** |
| mattpocock/skills | 10,350 | 845 | **12.2x** |
| slavingia/skills | 3,650 | 242 | **15.1x** |
| karpathy/autoresearch | 57,421 | 7,998 | 7.2x |
| karpathy/nanoGPT | 55,641 | 9,200 | 6.0x |
| facebook/react | 230,000 | 47,000 | 4.9x |

*Data as of March 27, 2026.*

The ratio isn't proof of a category. But it's a signal. Stars here don't mean "I'm using this" — they mean "I want to know this person thought about this."
...
**More notable practitioners will publish personal stacks.** The ROI is obvious: one repo generates more attention than a year of blog posts, and the content is reusable. Once you've codified your process for your own AI agents, you've already done the work to share it.

**The fork ratio will close as adoption matures.** Right now, most stargazers are watching. As agent skill ecosystems mature and installation becomes more frictionless, the gap between "starred" and "running locally" will narrow. Watch for this ratio to drop toward 8–10x within 6 months.

**Authenticity becomes the moat.** You can clone a skill file. You can't clone judgment, taste, or the 20 years of context that informs it. The repos that will maintain their star velocity are the ones where the process is genuinely inseparable from the person. Copies won't have the same gravitational pull.
...
What surprised us: `slavingia/skills` has a **15.1x ratio** with *zero code*. It's 10 Markdown files. The complexity barrier is essentially nonexistent — anyone can fork it in 10 seconds. The ratio is entirely about observation behavior, not deployment friction.
...
This is a new use of GitHub as a platform. And given the velocity of garrytan/gstack (3,130 stars/day at launch) vs. established libraries (react: ~49 stars/day lifetime average), the market seems to agree that *process transparency from credible practitioners* is information-dense in a way that other formats aren't.

Whether this becomes a lasting category or a transitional moment — we're watching the data.
