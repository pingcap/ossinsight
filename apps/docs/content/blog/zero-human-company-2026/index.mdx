...
Even more striking: `auto-company` has a **34.4% fork ratio** (44 forks / 128 stars). With only 128 stars, virtually everyone who liked it enough to star it also forked it. That's the signature of a small but intensely engaged developer community that plans to actually build on top of the code.
