...
Skills are the visible layer. But they sit on top of:
- **Memory** — persistent state across sessions
- **Tools** — external capabilities the agent can invoke
- **Data** — context the skill assumes but doesn't contain
- **Permissions** — what the agent is allowed to do

Strip away any one of those, and the skill stops working. It's like distributing a recipe without mentioning you need a kitchen.
