...
This is why skills are unlikely to be the final layer of agent systems. The data doesn't just show growth. It shows the *shape* of growth — and that shape looks more like a noisy, early-stage ecosystem than a mature platform layer.
