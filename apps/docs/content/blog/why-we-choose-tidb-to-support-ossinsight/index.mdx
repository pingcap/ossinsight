...
tags: [tidb]
image: /blog-assets/why-we-choose-tidb-to-support-ossinsight/how-different-db-handle-github-data.png
...
![GitHub event updates](/blog-assets/why-we-choose-tidb-to-support-ossinsight/github-events-updates.gif)
...
![The data volume of GitHub events occurred after 2011](/blog-assets/why-we-choose-tidb-to-support-ossinsight/github-events.png)
...
<center>
  <img width="50%" src="/blog-assets/why-we-choose-tidb-to-support-ossinsight/scalability-SQL.jpg" alt='Scalability vs SQL' />
</center>
...
<center>
  <img width="50%" src="/blog-assets/why-we-choose-tidb-to-support-ossinsight/olap-onlineserving.jpg" alt='OLAP vs Online Serving' />
</center>
...
![How a RDBMS handles the GitHub data](/blog-assets/why-we-choose-tidb-to-support-ossinsight/sharded-architecture.png)
...
![By using the secondary index, TiDB scanned 29,639 rows (instead of 4.6 billion rows) GitHub events in 4.9 ms](/blog-assets/why-we-choose-tidb-to-support-ossinsight/tidb-scanned-kennytm.png)
...
![Simplified architecture after we use TiDB](/blog-assets/why-we-choose-tidb-to-support-ossinsight/how-different-db-handle-github-data.png)
...
![TiDB execution plan](/blog-assets/why-we-choose-tidb-to-support-ossinsight/tidb-execution-plan-2.png)
...
![JavaScript frameworks with the most issue creators](/blog-assets/why-we-choose-tidb-to-support-ossinsight/javascript-framework-rankings.png)
...
![Applause given by developers and organizations on Twitter-1](/blog-assets/why-we-choose-tidb-to-support-ossinsight/twitter-1.png)

![Applause given by developers and organizations on Twitter-1](/blog-assets/why-we-choose-tidb-to-support-ossinsight/twitter-2.jpg)
