...
|------|-------------|-----------------|----------------|
| `DESIGN.md` | Design agents | How the project should look | 35,082 |
| `AGENTS.md` | Coding agents | How to build the project | 14,434 |
| `CLAUDE.md` | Claude Code | Agent behavior & preferences | 3,617 |
| `SKILL.md` | Agent runtimes | Reusable agent capabilities | 1,987 |
| `SOUL.md` | Agent persona | Personality & communication style | 886 |
