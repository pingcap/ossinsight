...
### Which databases experienced a popularity boom in 2021? {#popularity-boom-2021}

The chart below displays top 10 open source databases with the highest year-on-year growth rate of stars in 2021 alone.
...
<CommonChart
  ...
  repo='db_repos'
  shareInfo={{
    title: 'Which databases experienced a popularity boom in 2021?',
    description: 'The chart below displays top 10 open source databases with the highest year-on-year growth rate of stars in 2021 alone.',
    message: 'This is a funny chart!',
    keywords: ['OSSInsight', 'OSSDatabase'],
    hash: 'popularity-boom-2021'
  }}
/>

### Which databases barely gained influence in 2021?

The chart below displays top 10 open source databases with the lowest year-on-year growth rate of stars in 2021 alone. 
...
The chart below displays the accumulated number of issues received by leading open source databases respectively each year and their growth trend during the past ten years. 
