...
class TweetRepo
  ...
  def generate_img 
    ...
    img = img_client.create_image('', url: url, selector: "#__docusaurus > div.main-wrapper > div:nth-child(2) > main > div > section:nth-child(1) > div:nth-child(2) > div.MuiGrid-root.MuiGrid-container.css-13nwvtd")
