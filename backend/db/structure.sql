...
CREATE TABLE `github_events` (
  ...
  `repo_name` varchar(140) DEFAULT NULL,
  `actor_id` bigint(20) DEFAULT NULL,
  `actor_login` varchar(40) DEFAULT NULL,
  ...
  KEY `index_github_events_on_repo_id_type_number` (`repo_id`,`type`,`number`),
  KEY `index_github_events_on_repo_id_type_push_distinct_size` (`repo_id`,`type`,`push_distinct_size`),
  KEY `index_github_events_on_repo_id_type_actor_login` (`repo_id`,`type`,`actor_login`),
  KEY `index_github_events_on_repo_id_type_event_month` (`repo_id`,`type`,`event_month`),
  KEY `index_github_events_on_repo_id_type_action_month_actor_login` (`repo_id`,`type`,`action`,`event_month`,`actor_login`),
  KEY `index_github_events_on_actor_id_type_action_event_month` (`actor_id`,`type`,`action`,`event_month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin
