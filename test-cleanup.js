/**
 * Manual test for cleanGitHubUrl function
...
console.log('Running tests for cleanGitHubUrl...\n');
...
const tests = [
  ...
  { input: 'http://github.com/pingcap/ossinsight/', expected: 'pingcap/ossinsight' },
  { input: 'pingcap/ossinsight', expected: 'pingcap/ossinsight' },
  { input: '', expected: '' },
  { input: 'https://github.com/', expected: '' },
];
