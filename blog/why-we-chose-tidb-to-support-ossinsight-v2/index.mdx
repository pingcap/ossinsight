...
<center>
  <img width="50%" src={require('@site/blog/why-we-chose-tidb-to-support-ossinsight-v2/scalability-SQL.jpg').default} alt='Scalability vs SQL' />
</center>
...
<center>
  <img width="50%" src={require('@site/blog/why-we-chose-tidb-to-support-ossinsight-v2/olap-onlineserving.jpg').default} alt='OLAP vs Online Serving' />
</center>
