...
![How different types of databases handle the GitHub data](./how-different-db-handle-github-data.jpg)

<center><em>How different types of databases handle the GitHub data</em></center>
