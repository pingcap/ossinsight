---
title: GitHub Data Is Booming! Why?
date: 2022-08-01
...
<img width="50%" src={require('@site/blog/github-data-is-booming/github-event-prediction.jpg').default} alt='github-event-prediction' />
...
<img width="50%" src={require('@site/blog/github-data-is-booming/gitub-events-exceed-10-billion.jpg').default} alt='gitub-events-exceed-10-billion' />
...
All the analysis data in this article comes from [OSS Insight](https://ossinsight.io/), a tool based on [TiDB](https://en.pingcap.com/) to analyze and gain insights into GitHub events data.
