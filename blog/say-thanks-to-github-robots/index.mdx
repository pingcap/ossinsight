...
- In September 18th, 2019, [GitHub announced acquired Semmle](https://github.blog/2019-09-18-github-welcomes-semmle/) (Aka, the team build `lgtm-com[bot]`).
...
For now, rough statistics found that there are more than 97,607 bots on GitHub, the number doesn't seem like so much, but wait...
...
**👀 These 97 thousand bot accounts generated 603 million events, these events account for 12.82% of all public events on GitHub.**
...
<!-- TODO: Wait for importing title field -->
