...
<center>
  <img width="50%" src={require('@site/blog/why-we-choose-tidb-to-support-oss-insight/scalability-SQL.jpg').default} alt='Scalability vs SQL' />
</center>
...
<center>
  <img width="50%" src={require('@site/blog/why-we-choose-tidb-to-support-oss-insight/olap-onlineserving.jpg').default} alt='OLAP vs Online Serving' />
</center>
